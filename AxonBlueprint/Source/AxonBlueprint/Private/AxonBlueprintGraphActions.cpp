...
void FAxonBlueprintGraphActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_function"),
		TEXT("Add a new function graph to a Blueprint"),
		FAxonActionHandler::CreateStatic(&HandleAddFunction),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_function_thread_safe"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetFunctionThreadSafe),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("override_parent_function"),
		...
		FAxonActionHandler::CreateStatic(&HandleOverrideParentFunction),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_function"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveFunction),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("rename_function"),
		...
		FAxonActionHandler::CreateStatic(&HandleRenameFunction),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_macro"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddMacro),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_macro"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveMacro),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("rename_macro"),
		...
		FAxonActionHandler::CreateStatic(&HandleRenameMacro),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_event_dispatcher"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddEventDispatcher),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_function_params"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetFunctionParams),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("implement_interface"),
		...
		FAxonActionHandler::CreateStatic(&HandleImplementInterface),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_interface"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveInterface),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("reparent_blueprint"),
		...
		FAxonActionHandler::CreateStatic(&HandleReparentBlueprint),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_event_dispatcher"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveEventDispatcher),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),      TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_event_dispatcher_params"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetEventDispatcherParams),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),      TEXT("Blueprint asset path"))
			.Required(TEXT("dispatcher_name"), TEXT("string"), TEXT("Event dispatcher name (without _Signature suffix)"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("scaffold_interface_implementation"),
		...
		FAxonActionHandler::CreateStatic(&HandleScaffoldInterfaceImplementation),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),       TEXT("Blueprint asset path"))
...
FAxonActionResult FAxonBlueprintGraphActions::HandleAddFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	...
	if (FuncName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: name"));
	}
	...
	for (const UEdGraph* Existing : BP->FunctionGraphs)
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Function already exists: %s"), *FuncName));
		}
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleOverrideParentFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: parent_function_name"));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleRemoveFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!Graph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Function not found: %s"), *FuncName));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleSetFunctionThreadSafe(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (FuncName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: function_name"));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleRenameFunction(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (OldName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: old_name"));
	}
	if (NewName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: new_name"));
	}

	UEdGraph* Graph = AxonBlueprintInternal::FindGraphByName(BP, OldName);
	if (!Graph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Function not found: %s"), *OldName));
	}

	// Ensure we're only renaming function graphs, not event graphs or macros
	if (!BP->FunctionGraphs.Contains(Graph))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Graph '%s' is not a function graph (cannot rename event graphs or macros this way)"), *OldName));
	}
	...
	for (const UEdGraph* Existing : BP->FunctionGraphs)
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("A function named '%s' already exists"), *NewName));
		}
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleAddMacro(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	for (const UEdGraph* Existing : BP->MacroGraphs)
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Macro already exists: %s"), *MacroName));
		}
	}
	...
	if (!NewGraph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create macro graph: %s"), *MacroName));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleRemoveMacro(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (MacroName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: macro_name"));
	}
	...
	if (!Graph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Macro not found: %s"), *MacroName));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleRenameMacro(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!Graph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Macro not found: %s"), *OldName));
	}
	...
	for (const UEdGraph* Existing : BP->MacroGraphs)
	{
		if (Existing && Existing != Graph && Existing->GetName() == NewName)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("A macro named '%s' already exists"), *NewName));
		}
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleAddEventDispatcher(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	for (const UEdGraph* Existing : BP->DelegateSignatureGraphs)
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Event dispatcher already exists: %s"), *DispatcherName));
		}
	}
	...
	if (!NewGraph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create delegate signature graph: %s"), *DispatcherName));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleSetFunctionParams(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!EntryNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("No FunctionEntry node found in: %s"), *FuncName));
	}
	...
	if (Params->TryGetArrayField(TEXT("inputs"), InputsArray) && InputsArray)
	{
		for (const TSharedPtr<FJsonValue>& InputVal : *InputsArray)
		{
			...
			FEdGraphPinType PinType = AxonBlueprintInternal::ParsePinTypeFromString(TypeStr);
	...
	{
		return FAxonActionResult::Error(TEXT("No valid inputs or outputs provided"));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleImplementInterface(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: interface_class"));
	}
	...
	if (!InterfaceClass)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Interface class not found: %s"), *InterfaceClassName));
	}

	if (!InterfaceClass->HasAnyClassFlags(CLASS_Interface))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Class '%s' is not an interface"), *InterfaceClassName));
	}
	...
	for (const FBPInterfaceDescription& Existing : BP->ImplementedInterfaces)
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Interface already implemented: %s"), *InterfaceClassName));
		}
	}
	...
	if (!bAdded)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to implement interface: %s"), *InterfaceClassName));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleRemoveInterface(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!InterfaceClass)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Interface not implemented by this Blueprint: %s"), *InterfaceClassName));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleScaffoldInterfaceImplementation(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!bAlreadyImplemented)
	{
		...
		if (!bAdded)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("ImplementNewInterface failed for: %s"), *InterfaceClassName));
		}
		FBlueprintEditorUtils::MarkBlueprintAsStructurallyModified(BP);
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleReparentBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: new_parent_class"));
	}

	UClass* NewParent = FindFirstObject<UClass>(*ClassName, EFindFirstObjectOptions::NativeFirst);
	if (!NewParent)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Parent class not found: %s"), *ClassName));
	}

	if (NewParent->HasAnyClassFlags(CLASS_Interface))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Cannot reparent to an interface class: %s"), *ClassName));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleRemoveEventDispatcher(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (DispatcherName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: dispatcher_name"));
	}
...
FAxonActionResult FAxonBlueprintGraphActions::HandleSetEventDispatcherParams(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: params (array of {name, type})"));
	}

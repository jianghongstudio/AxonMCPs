...
void FAxonBlueprintActions::RegisterActions()
{
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("list_graphs"),
		...
		FAxonActionHandler::CreateStatic(&HandleListGraphs),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_graph_data"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetGraphData),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_graph_summary"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetGraphSummary),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_variables"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_execution_flow"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetExecutionFlow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("search_nodes"),
		...
		FAxonActionHandler::CreateStatic(&HandleSearchNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_components"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetComponents),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_component_details"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetComponentDetails),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_functions"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetFunctions),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_event_dispatchers"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetEventDispatchers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_parent_class"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetParentClass),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_interfaces"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetInterfaces),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_construction_script"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetConstructionScript),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("search_functions"),
		...
		FAxonActionHandler::CreateStatic(&HandleSearchFunctions),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_node_details"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetNodeDetails),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_interface_functions"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetInterfaceFunctions),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_function_signature"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetFunctionSignature),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),         TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_event_dispatcher_details"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetEventDispatcherDetails),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),       TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_blueprint_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetBlueprintInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("find_variable_references"),
		...
		FAxonActionHandler::CreateStatic(&HandleFindVariableReferences),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),     TEXT("Blueprint asset path"))
...
UBlueprint* FAxonBlueprintActions::LoadBlueprint(const TSharedPtr<FJsonObject>& Params, FString& OutAssetPath)
{
	return AxonBlueprintInternal::LoadBlueprintFromParams(Params, OutAssetPath);
}

// --- list_graphs ---

FAxonActionResult FAxonBlueprintActions::HandleListGraphs(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	...
	AxonBlueprintInternal::AddGraphArray(GraphsArr, BP->UbergraphPages, TEXT("event_graph"));
	AxonBlueprintInternal::AddGraphArray(GraphsArr, BP->FunctionGraphs, TEXT("function"));
	AxonBlueprintInternal::AddGraphArray(GraphsArr, BP->MacroGraphs, TEXT("macro"));
	AxonBlueprintInternal::AddGraphArray(GraphsArr, BP->DelegateSignatureGraphs, TEXT("delegate_signature"));
	...
	for (const FBPInterfaceDescription& Iface : BP->ImplementedInterfaces)
	{
		...
		AxonBlueprintInternal::AddGraphArray(GraphsArr, Iface.Graphs, TEXT("interface"), IfaceName);
	}
...
FAxonActionResult FAxonBlueprintActions::HandleGetGraphData(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	if (!Graph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Graph not found: %s"), *GraphName));
	}
	...
	for (UEdGraphNode* Node : Graph->Nodes)
	{
		...
		NodesArr.Add(MakeShared<FJsonValueObject>(AxonBlueprintInternal::SerializeNode(Node)));
	}
...
FAxonActionResult FAxonBlueprintActions::HandleGetGraphSummary(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetVariables(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	for (const FBPVariableDescription& Var : BP->NewVariables)
	{
		...
		VObj->SetStringField(TEXT("type"),
			AxonBlueprintInternal::ContainerPrefix(Var.VarType) +
			AxonBlueprintInternal::PinTypeToString(Var.VarType));
...
FAxonActionResult FAxonBlueprintActions::HandleGetExecutionFlow(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: entry_point"));
	}
	...
	auto SearchGraphs = [&](const TArray<TObjectPtr<UEdGraph>>& Graphs)
	{
		...
		{
			if (!Graph) continue;
			UEdGraphNode* Node = AxonBlueprintInternal::FindEntryNode(Graph, EntryPoint);
			if (Node)
			{
				EntryNode = Node;
				FoundGraph = Graph;
	...
	if (!EntryNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Entry point not found: %s"), *EntryPoint));
	}

	TSet<UEdGraphNode*> Visited;
	TSharedPtr<FJsonObject> Flow = AxonBlueprintInternal::TraceExecFlow(EntryNode, Visited);
...
FAxonActionResult FAxonBlueprintActions::HandleSearchNodes(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetComponents(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetComponentDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: component_name"));
	}
	...
	if (!Template)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Component not found: %s"), *ComponentName));
	}
...
FAxonActionResult FAxonBlueprintActions::HandleGetFunctions(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetEventDispatchers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetParentClass(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetInterfaces(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetConstructionScript(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	if (!CSGraph)
	{
		return FAxonActionResult::Error(TEXT("No Construction Script found (Blueprint may not have one)"));
	}
...
FAxonActionResult FAxonBlueprintActions::HandleSearchFunctions(const TSharedPtr<FJsonObject>& Params)
{
	FString Query       = Params->GetStringField(TEXT("query"));
	...
	{
		return FAxonActionResult::Error(TEXT("At least one of 'query' or 'class_filter' is required to avoid a full scan"));
	}
...
FAxonActionResult FAxonBlueprintActions::HandleGetNodeDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	TSharedPtr<FJsonObject> NodeObj = AxonBlueprintInternal::SerializeNode(Node);
	...
	return FAxonActionResult::Success(NodeObj);
}
...
FAxonActionResult FAxonBlueprintActions::HandleGetInterfaceFunctions(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonBlueprintActions::HandleGetFunctionSignature(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
		...
		if (EntryNode)
		{
			...
			for (const FBPVariableDescription& LVar : EntryNode->LocalVariables)
			{
				...
				LObj->SetStringField(TEXT("type"),
					AxonBlueprintInternal::ContainerPrefix(PT) +
					AxonBlueprintInternal::PinTypeToString(PT));
...
FAxonActionResult FAxonBlueprintActions::HandleGetEventDispatcherDetails(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleGetBlueprintInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintActions::HandleFindVariableReferences(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = LoadBlueprint(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: variable_name"));
	}
	...
	for (UEdGraph* Graph : AllGraphs)
	{
		...
		for (UEdGraphNode* Node : Graph->Nodes)
		{
			...
			// it by class-name string (mirrors AxonPropertyAccessReader).
			FString Access;
			...
			AxonPropertyAccessReader::SerializePropertyAccessBlock(K2Node, MObj);

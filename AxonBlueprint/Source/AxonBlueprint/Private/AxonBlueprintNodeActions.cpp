...
// ============================================================
//  AxonBlueprintInternal helpers
// ============================================================

bool AxonBlueprintInternal::HasCustomEventNamed(UBlueprint* BP, FName EventName)
{
...
void FAxonBlueprintNodeActions::RegisterActions(FAxonToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_node"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),  TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("connect_pins"),
		...
		FAxonActionHandler::CreateStatic(&HandleConnectPins),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),   TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("disconnect_pins"),
		...
		FAxonActionHandler::CreateStatic(&HandleDisconnectPins),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),   TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_pin_default"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetPinDefault),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),  TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_node_position"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetNodePosition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),  TEXT("Blueprint asset path"))
			.Required(TEXT("node_id"),     TEXT("string"), TEXT("Node ID"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("resolve_node"),
		...
		FAxonActionHandler::CreateStatic(&HandleResolveNode),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("connect_pins_bulk"),
		...
		FAxonActionHandler::CreateStatic(&HandleConnectPinsBulk),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),   TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_pin_defaults_bulk"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetPinDefaultsBulk),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_timeline"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddTimeline),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),    TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_event_node"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddEventNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),  TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_comment_node"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddCommentNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),  TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_timeline_data"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetTimelineData),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),     TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_timeline_track"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddTimelineTrack),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),     TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_timeline_keys"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetTimelineKeys),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),     TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("promote_pin_to_variable"),
		...
		FAxonActionHandler::CreateStatic(&HandlePromotePinToVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),     TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_property_access"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddPropertyAccess),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),  TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_property_access_node"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddPropertyAccessNode),
		FParamSchemaBuilder()
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	...
	UEdGraph* Graph = AxonBlueprintInternal::FindGraphByName(BP, GraphName);
	if (!Graph)
	{
	...
	if (NodeType == TEXT("CallFunction"))
	{
		...
		if (FuncName.IsEmpty())
		{
			return FAxonActionResult::Error(TEXT("CallFunction node requires 'function_name'"));
		}
	...
	else if (NodeType == TEXT("VariableGet"))
	{
		...
		if (VarName.IsEmpty())
		{
			return FAxonActionResult::Error(TEXT("VariableGet node requires 'variable_name'"));
		}
	...
	else if (NodeType == TEXT("VariableSet"))
	{
		...
		if (VarName.IsEmpty())
		{
			return FAxonActionResult::Error(TEXT("VariableSet node requires 'variable_name'"));
		}
	...
	else if (NodeType == TEXT("CustomEvent"))
	{
		...
		{
			return FAxonActionResult::Error(TEXT("CustomEvent node requires 'event_name'"));
		}

		if (AxonBlueprintInternal::HasCustomEventNamed(BP, FName(*EventName)))
		{
			return FAxonActionResult::Error(FString::Printf(
	...
	else if (NodeType == TEXT("MacroInstance"))
	{
		...
		{
			return FAxonActionResult::Error(TEXT("MacroInstance node requires 'macro_name'"));
		}
		...
		{
			UBlueprint* MacroBP = FAxonAssetUtils::LoadAssetByPath<UBlueprint>(MacroBPPath);
			if (MacroBP)
			{
	...
	else if (NodeType == TEXT("SpawnActorFromClass"))
	{
		...
		{
			return FAxonActionResult::Error(TEXT("SpawnActorFromClass node requires 'actor_class'"));
		}
	...
	else if (NodeType == TEXT("DynamicCast"))
	{
		...
		if (CastClassName.IsEmpty())
		{
			return FAxonActionResult::Error(TEXT("DynamicCast node requires 'cast_class' (e.g. cast_class=MyPawn)"));
		}
	...
	else if (NodeType == TEXT("MakeStruct"))
	{
		...
		{
			return FAxonActionResult::Error(TEXT("MakeStruct node requires 'struct_type' (e.g. struct_type=Vector)"));
		}
	...
	else if (NodeType == TEXT("BreakStruct"))
	{
		...
		if (StructType.IsEmpty())
		{
			return FAxonActionResult::Error(TEXT("BreakStruct node requires 'struct_type' (e.g. struct_type=Vector)"));
		}
	...
	else if (NodeType == TEXT("SwitchOnEnum"))
	{
		...
		if (EnumType.IsEmpty())
		{
			return FAxonActionResult::Error(TEXT("SwitchOnEnum node requires 'enum_type' (e.g. enum_type=ECollisionChannel)"));
		}
	...
	else if (NodeType == TEXT("Return"))
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Return nodes can only be added to function graphs, not event graphs"));
		}
	...
	else if (NodeType == TEXT("ComponentBoundEvent"))
	{
		...
		FObjectProperty* CompProp = AxonBlueprintInternal::FindComponentProperty(BP, FName(*CompNameStr));
		if (!CompProp)
		{
			return FAxonActionResult::Error(FString::Printf(
		...
		FMulticastDelegateProperty* DelegateProp = AxonBlueprintInternal::FindMulticastDelegateProperty(
	...
	else if (NodeType == TEXT("AddDelegate"))
	{
		...
		FAxonActionResult Resolved = AxonBlueprintInternal::ResolveDelegateOwnerAndProperty(
	...
	if (!NewNode)
	{
		return FAxonActionResult::Error(TEXT("Failed to create node — NewObject returned null"));
	}
	...
	TSharedPtr<FJsonObject> Root = AxonBlueprintInternal::SerializeNode(NewNode);
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddPropertyAccess(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("add_property_access requires 'member_class'"));
	}

	const FString MemberName = Params->GetStringField(TEXT("member_name"));
	if (MemberName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("add_property_access requires 'member_name'"));
	}
	...
	if (!NewNode)
	{
		return FAxonActionResult::Error(TEXT("Failed to create property-access node — NewObject returned null"));
	}
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddPropertyAccessNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("add_property_access_node requires a non-empty 'path' array of strings"));
	}
	for (const TSharedPtr<FJsonValue>& Elem : *PathArr)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Each 'path' element must be a non-empty string"));
		}
		Path.Add(S);
	}
	...
	if (!Node)
	{
		return FAxonActionResult::Error(TEXT("Failed to create UK2Node_PropertyAccess — NewObject returned null"));
	}
	...
	TSharedPtr<FJsonObject> Root = AxonBlueprintInternal::SerializeNode(Node);
	Root->SetStringField(TEXT("asset_path"), AssetPath);
	Root->SetStringField(TEXT("graph"), Graph->GetName());
...
FAxonActionResult FAxonBlueprintNodeActions::HandleRemoveNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (NodeId.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: node_id"));
	}

	FString GraphName = Params->GetStringField(TEXT("graph_name"));
	UEdGraphNode* Node = AxonBlueprintInternal::FindNodeById(BP, GraphName, NodeId);
	if (!Node)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Node not found: %s"), *NodeId));
	}
...
FAxonActionResult FAxonBlueprintNodeActions::HandleConnectPins(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (SourceNodeId.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: source_node"));
	if (SourcePinName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: source_pin"));
	if (TargetNodeId.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: target_node"));
	if (TargetPinName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: target_pin"));

	FString GraphName = Params->GetStringField(TEXT("graph_name"));

	UEdGraphNode* SrcNode = AxonBlueprintInternal::FindNodeById(BP, GraphName, SourceNodeId);
	if (!SrcNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Source node not found: %s"), *SourceNodeId));
	}

	UEdGraphNode* TgtNode = AxonBlueprintInternal::FindNodeById(BP, GraphName, TargetNodeId);
	if (!TgtNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Target node not found: %s"), *TargetNodeId));
	}

	FString SrcAvailPins;
	UEdGraphPin* SrcPin = AxonBlueprintInternal::FindPinOnNode(SrcNode, SourcePinName, EGPD_MAX, &SrcAvailPins);
	if (!SrcPin)
	{
		return FAxonActionResult::Error(FString::Printf(
	...
	UEdGraphPin* TgtPin = AxonBlueprintInternal::FindPinOnNode(TgtNode, TargetPinName, EGPD_MAX, &TgtAvailPins);
	if (!TgtPin)
	{
		return FAxonActionResult::Error(FString::Printf(
...
FAxonActionResult FAxonBlueprintNodeActions::HandleDisconnectPins(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (PinName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: pin_name"));
	}
	...
	FString AvailPins;
	UEdGraphPin* Pin = AxonBlueprintInternal::FindPinOnNode(Node, PinName, EGPD_MAX, &AvailPins);
	if (!Pin)
	{
		return FAxonActionResult::Error(FString::Printf(
	...
	else
	{
		...
		{
			return FAxonActionResult::Error(TEXT("'target_pin' is required when 'target_node' is specified"));
		}

		UEdGraphNode* TargetNode = AxonBlueprintInternal::FindNodeById(BP, GraphName, TargetNodeId);
		if (!TargetNode)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Target node not found: %s"), *TargetNodeId));
		}
		...
		UEdGraphPin* TargetPin = AxonBlueprintInternal::FindPinOnNode(TargetNode, TargetPinName, EGPD_MAX, &TgtAvailPins2);
		if (!TargetPin)
		{
			return FAxonActionResult::Error(FString::Printf(
...
FAxonActionResult FAxonBlueprintNodeActions::HandleSetPinDefault(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (Value.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: value"));
	}
	...
	UEdGraphPin* Pin = AxonBlueprintInternal::FindPinOnNode(Node, PinName, EGPD_MAX, &SetPinAvailPins);
	if (!Pin)
	{
		return FAxonActionResult::Error(FString::Printf(
	...
	if (bIsRefPin)
	{
		...
		UObject* Resolved = AxonBlueprintInternal::ResolveDefaultObjectForPin(Pin, Value, ResolveError);
		if (!Resolved)
		{
...
FAxonActionResult FAxonBlueprintNodeActions::HandleSetNodePosition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!Params->TryGetArrayField(TEXT("position"), PosArray) || !PosArray || PosArray->Num() < 2)
	{
		return FAxonActionResult::Error(TEXT("'position' must be an array of [x, y]"));
	}
...
FAxonActionResult FAxonBlueprintNodeActions::HandleBatchExecute(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	GEditor->BeginTransaction(NSLOCTEXT("Axon", "BPBatchExec", "BP Batch Execute"));
	...
	for (int32 i = 0; i < Ops.Num(); ++i)
	{
		...
		// Variable ops
		else if (OpName == TEXT("add_variable"))           SubResult = FAxonBlueprintVariableActions::HandleAddVariable(SubParams);
		else if (OpName == TEXT("remove_variable"))        SubResult = FAxonBlueprintVariableActions::HandleRemoveVariable(SubParams);
		else if (OpName == TEXT("rename_variable"))        SubResult = FAxonBlueprintVariableActions::HandleRenameVariable(SubParams);
		else if (OpName == TEXT("set_variable_type"))      SubResult = FAxonBlueprintVariableActions::HandleSetVariableType(SubParams);
		else if (OpName == TEXT("set_variable_defaults"))  SubResult = FAxonBlueprintVariableActions::HandleSetVariableDefaults(SubParams);
		else if (OpName == TEXT("add_local_variable"))     SubResult = FAxonBlueprintVariableActions::HandleAddLocalVariable(SubParams);
		else if (OpName == TEXT("remove_local_variable"))  SubResult = FAxonBlueprintVariableActions::HandleRemoveLocalVariable(SubParams);
		// Component ops
		else if (OpName == TEXT("add_component"))          SubResult = FAxonBlueprintComponentActions::HandleAddComponent(SubParams);
		else if (OpName == TEXT("remove_component"))       SubResult = FAxonBlueprintComponentActions::HandleRemoveComponent(SubParams);
		else if (OpName == TEXT("rename_component"))       SubResult = FAxonBlueprintComponentActions::HandleRenameComponent(SubParams);
		else if (OpName == TEXT("reparent_component"))     SubResult = FAxonBlueprintComponentActions::HandleReparentComponent(SubParams);
		else if (OpName == TEXT("set_component_property")) SubResult = FAxonBlueprintComponentActions::HandleSetComponentProperty(SubParams);
		else if (OpName == TEXT("duplicate_component"))    SubResult = FAxonBlueprintComponentActions::HandleDuplicateComponent(SubParams);
		// Graph/interface ops
		else if (OpName == TEXT("add_function"))           SubResult = FAxonBlueprintGraphActions::HandleAddFunction(SubParams);
		else if (OpName == TEXT("remove_function"))        SubResult = FAxonBlueprintGraphActions::HandleRemoveFunction(SubParams);
		else if (OpName == TEXT("rename_function"))        SubResult = FAxonBlueprintGraphActions::HandleRenameFunction(SubParams);
		else if (OpName == TEXT("add_macro"))              SubResult = FAxonBlueprintGraphActions::HandleAddMacro(SubParams);
		else if (OpName == TEXT("add_event_dispatcher"))   SubResult = FAxonBlueprintGraphActions::HandleAddEventDispatcher(SubParams);
		else if (OpName == TEXT("set_function_params"))    SubResult = FAxonBlueprintGraphActions::HandleSetFunctionParams(SubParams);
		else if (OpName == TEXT("implement_interface"))        SubResult = FAxonBlueprintGraphActions::HandleImplementInterface(SubParams);
		else if (OpName == TEXT("remove_interface"))           SubResult = FAxonBlueprintGraphActions::HandleRemoveInterface(SubParams);
		// Wave 5 scaffolding ops
		else if (OpName == TEXT("scaffold_interface_implementation")) SubResult = FAxonBlueprintGraphActions::HandleScaffoldInterfaceImplementation(SubParams);
		...
		else if (OpName == TEXT("add_replicated_variable"))    SubResult = FAxonBlueprintVariableActions::HandleAddReplicatedVariable(SubParams);
		// Phase 1 expansion (1E/1F — handlers added by parallel agent)
		else if (OpName == TEXT("save_asset"))                 SubResult = FAxonBlueprintCompileActions::HandleSaveAsset(SubParams);
		else if (OpName == TEXT("remove_macro"))               SubResult = FAxonBlueprintGraphActions::HandleRemoveMacro(SubParams);
		else if (OpName == TEXT("rename_macro"))               SubResult = FAxonBlueprintGraphActions::HandleRenameMacro(SubParams);
		// CDO ops
		else if (OpName == TEXT("set_cdo_property"))           SubResult = FAxonBlueprintCDOActions::HandleSetCDOProperty(SubParams);
		// Phase 3A timeline read/edit
		...
		else if (OpName == TEXT("export_graph"))                SubResult = FAxonBlueprintGraphExportActions::HandleExportGraph(SubParams);
		else if (OpName == TEXT("copy_nodes"))                  SubResult = FAxonBlueprintGraphExportActions::HandleCopyNodes(SubParams);
		else if (OpName == TEXT("duplicate_graph"))             SubResult = FAxonBlueprintGraphExportActions::HandleDuplicateGraph(SubParams);
		// Phase 6 layout
		else if (OpName == TEXT("auto_layout"))                 SubResult = FAxonBlueprintLayoutActions::HandleAutoLayout(SubParams);
	...
	if (bCompileOnComplete)
	{
		...
		FAxonActionResult CompileResult = FAxonBlueprintCompileActions::HandleCompileBlueprint(CompileParams);
...
FAxonActionResult FAxonBlueprintNodeActions::HandleResolveNode(const TSharedPtr<FJsonObject>& Params)
{
	FString NodeType = Params->GetStringField(TEXT("node_type"));
	if (NodeType.IsEmpty())
	{
	...
	if (NodeType == TEXT("CallFunction"))
	{
		...
		if (FuncName.IsEmpty())
		{
			return FAxonActionResult::Error(TEXT("CallFunction requires 'function_name'"));
		}
		...
		else
		{
			...
			if (!Params->GetStringField(TEXT("asset_path")).IsEmpty())
			{
				...
				UBlueprint* ContextBP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, ResolveAssetPath);
	...
	else if (NodeType == TEXT("MacroInstance"))
	{
		...
		if (!MacroBlueprint)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Macro blueprint not found: %s"), *MacroBP));
		}
		...
		if (!MacroGraph)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Macro '%s' not found in '%s'"), *MacroName, *MacroBP));
		}
	         ...
	         NodeType == TEXT("CallDelegate"))
	{
		...
		{
			FString AssetPath;
			if (UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath))
			{
	...
	if (!Node)
	{
		return FAxonActionResult::Error(TEXT("Failed to create transient node"));
	}
	...
	for (const UEdGraphPin* Pin : Node->Pins)
	{
		...
		PinObj->SetStringField(TEXT("type"),
			AxonBlueprintInternal::ContainerPrefix(Pin->PinType) +
			AxonBlueprintInternal::PinTypeToString(Pin->PinType));
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddNodesBulk(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required field: nodes"));
	}
	...
	else if (NodesField->Type == EJson::String)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Failed to parse nodes string as JSON array"));
		}
	}
	else
	{
		return FAxonActionResult::Error(TEXT("'nodes' must be an array"));
	}
	...
	GEditor->BeginTransaction(NSLOCTEXT("Axon", "BPAddNodesBulk", "BP Add Nodes Bulk"));
	...
	for (int32 i = 0; i < NodesArr.Num(); ++i)
	{
		...
		FAxonActionResult Result = HandleAddNode(SubParams);
...
FAxonActionResult FAxonBlueprintNodeActions::HandleConnectPinsBulk(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required field: connections"));
	}
	...
	else if (ConnField->Type == EJson::String)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Failed to parse connections string as JSON array"));
		}
	}
	else
	{
		return FAxonActionResult::Error(TEXT("'connections' must be an array"));
	}

	FString SharedGraphName = Params->GetStringField(TEXT("graph_name"));

	GEditor->BeginTransaction(NSLOCTEXT("Axon", "BPConnectPinsBulk", "BP Connect Pins Bulk"));
	...
	for (int32 i = 0; i < ConnArr.Num(); ++i)
	{
		...
		FAxonActionResult Result = HandleConnectPins(SubParams);
...
FAxonActionResult FAxonBlueprintNodeActions::HandleSetPinDefaultsBulk(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required field: defaults"));
	}
	...
	else if (DefaultsField->Type == EJson::String)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Failed to parse defaults string as JSON array"));
		}
	}
	else
	{
		return FAxonActionResult::Error(TEXT("'defaults' must be an array"));
	}

	FString SharedGraphName = Params->GetStringField(TEXT("graph_name"));

	GEditor->BeginTransaction(NSLOCTEXT("Axon", "BPSetPinDefaultsBulk", "BP Set Pin Defaults Bulk"));
	...
	for (int32 i = 0; i < DefaultsArr.Num(); ++i)
	{
		...
		FAxonActionResult Result = HandleSetPinDefault(SubParams);
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddTimeline(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("This Blueprint type does not support timelines (must be Actor-based)"));
	}
	...
	{
		return FAxonActionResult::Error(TEXT("Timeline template was created but not found in BP->Timelines — aborting"));
	}
	...
	if (!TimelineNode)
	{
		return FAxonActionResult::Error(TEXT("Failed to create UK2Node_Timeline node object"));
	}
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddEventNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (EventName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: event_name"));
	}
	...
	if (DeclaringClass && EventFunc)
	{
		...
		TSharedPtr<FJsonObject> Root = AxonBlueprintInternal::SerializeNode(EventNode);
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddCommentNode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: text"));
	}
...
FAxonActionResult FAxonBlueprintNodeActions::HandlePromotePinToVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	// Find the node
	UEdGraphNode* SourceNode = AxonBlueprintInternal::FindNodeById(BP, GraphName, NodeId);
	if (!SourceNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Node not found: %s"), *NodeId));
	}
	...
	UEdGraphPin* Pin = AxonBlueprintInternal::FindPinOnNode(SourceNode, PinName, EGPD_MAX, &PromoteAvailPins);
	if (!Pin)
	{
		return FAxonActionResult::Error(FString::Printf(
	...
	{
		return FAxonActionResult::Error(TEXT("Cannot promote execution (exec) pins to variables"));
	}

	// Validate: not wildcard
	if (Pin->PinType.PinCategory == UEdGraphSchema_K2::PC_Wildcard)
	{
		return FAxonActionResult::Error(TEXT("Cannot promote wildcard pins to variables — resolve the type first"));
	}
	...
	if (!GraphName.IsEmpty())
	{
		Graph = AxonBlueprintInternal::FindGraphByName(BP, GraphName);
	}
	else
	{
	...
	if (!Graph)
	{
		return FAxonActionResult::Error(TEXT("Could not locate graph containing the node"));
	}

	// Build pin type string for the response before modifying anything
	FString TypeStr = AxonBlueprintInternal::ContainerPrefix(Pin->PinType) +
	                  AxonBlueprintInternal::PinTypeToString(Pin->PinType);
...
FAxonActionResult FAxonBlueprintNodeActions::HandleGetTimelineData(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintNodeActions::HandleAddTimelineTrack(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: timeline_name"));
	}

	FString TrackNameStr = Params->GetStringField(TEXT("track_name"));
	if (TrackNameStr.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: track_name"));
	}
	...
	if (!Template)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Timeline '%s' not found in Blueprint"), *TimelineName));
	}
	...
	if (!OwnerClass)
	{
		return FAxonActionResult::Error(TEXT("Blueprint has no GeneratedClass — compile the Blueprint first"));
	}
...
FAxonActionResult FAxonBlueprintNodeActions::HandleSetTimelineKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: keys"));
	}
	...
	else if (KeysField->Type == EJson::String)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Failed to parse keys string as JSON array"));
		}
	}
	else
	{
		return FAxonActionResult::Error(TEXT("'keys' must be an array"));
	}

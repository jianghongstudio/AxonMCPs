...
void FAxonBlueprintCompileActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("blueprint"), TEXT("compile_blueprint"),
		...
		FAxonActionHandler::CreateStatic(&HandleCompileBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("validate_blueprint"),
		...
		FAxonActionHandler::CreateStatic(&HandleValidateBlueprint),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("create_blueprint"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("duplicate_blueprint"),
		...
		FAxonActionHandler::CreateStatic(&HandleDuplicateBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("get_dependencies"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetDependencies),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("save_asset"),
		...
		FAxonActionHandler::CreateStatic(&HandleSaveAsset),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("save_dirty_assets"),
		...
		FAxonActionHandler::CreateStatic(&HandleSaveDirtyAssets),
		FParamSchemaBuilder()
...
FAxonActionResult FAxonBlueprintCompileActions::HandleCompileBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
...
FAxonActionResult FAxonBlueprintCompileActions::HandleValidateBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintCompileActions::HandleCreateBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: parent_class"));
	}
	...
	if (!ParentClass)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Parent class not found: %s"), *ParentClassName));
	}
	...
	if (!NewBP)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create Blueprint at: %s"), *SavePath));
	}
	...
	if (CDO)
	{
		...
		FScopedTransaction Transaction(NSLOCTEXT("AxonBlueprintCompileActions",
			"CreateBlueprint", "Axon Create Blueprint"));
		CDO->Modify();
		for (TFieldIterator<FProperty> It(CDO->GetClass()); It; ++It)
		{
			...
			if (Prop->HasAnyPropertyFlags(CPF_Transient | CPF_Deprecated))
				continue;
			AxonEditCradle::FireFullCradle(CDO, Prop);
		}
	}
...
FAxonActionResult FAxonBlueprintCompileActions::HandleDuplicateBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (NewPath.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: new_path"));
	}
...
FAxonActionResult FAxonBlueprintCompileActions::HandleGetDependencies(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintCompileActions::HandleSaveAsset(const TSharedPtr<FJsonObject>& Params)
{
	...
	UObject* Asset = FAxonAssetUtils::LoadAssetByPath(AssetPath);
	if (!Asset)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Asset not found: %s"), *AssetPath));
	}
	...
	if (!bSaved)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to save asset: %s"), *AssetPath));
	}
	return FAxonActionResult::Success(Root);
}
...
FAxonActionResult FAxonBlueprintCompileActions::HandleSaveDirtyAssets(const TSharedPtr<FJsonObject>& Params)
{

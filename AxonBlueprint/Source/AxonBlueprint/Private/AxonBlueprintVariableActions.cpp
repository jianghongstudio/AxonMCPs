...
void FAxonBlueprintVariableActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_variable"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddVariable),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_variable"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("rename_variable"),
		...
		FAxonActionHandler::CreateStatic(&HandleRenameVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_variable_type"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetVariableType),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Blueprint asset path"))
			.Required(TEXT("name"),       TEXT("string"), TEXT("Variable name"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("set_variable_defaults"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetVariableDefaults),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),        TEXT("Blueprint asset path"))
			.Required(TEXT("name"),               TEXT("string"),  TEXT("Variable name"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_local_variable"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddLocalVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),    TEXT("Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("remove_local_variable"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveLocalVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),    TEXT("Blueprint asset path"))
			.Required(TEXT("function_name"), TEXT("string"), TEXT("Function graph name"))
	...
	Registry.RegisterAction(TEXT("blueprint"), TEXT("add_replicated_variable"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddReplicatedVariable),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"),            TEXT("Blueprint asset path"))
...
FAxonActionResult FAxonBlueprintVariableActions::HandleAddVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	...
	if (TypeStr.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: type"));
	}
...
FAxonActionResult FAxonBlueprintVariableActions::HandleRemoveVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!bFound)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Variable not found: %s"), *Name));
	}
...
FAxonActionResult FAxonBlueprintVariableActions::HandleRenameVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	if (!bFound)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Variable not found: %s"), *OldName));
	}
...
FAxonActionResult FAxonBlueprintVariableActions::HandleSetVariableType(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	FEdGraphPinType NewType = AxonBlueprintInternal::ParsePinTypeFromString(TypeStr);
...
FAxonActionResult FAxonBlueprintVariableActions::HandleSetVariableDefaults(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintVariableActions::HandleAddLocalVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
	...
	UEdGraph* FuncGraph = AxonBlueprintInternal::FindGraphByName(BP, FunctionName);
	if (!FuncGraph)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Function graph not found: %s"), *FunctionName));
	}
...
FAxonActionResult FAxonBlueprintVariableActions::HandleRemoveLocalVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)
...
FAxonActionResult FAxonBlueprintVariableActions::HandleAddReplicatedVariable(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	UBlueprint* BP = AxonBlueprintInternal::LoadBlueprintFromParams(Params, AssetPath);
	if (!BP)

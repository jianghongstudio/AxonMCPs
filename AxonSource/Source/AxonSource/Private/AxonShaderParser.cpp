...
FParsedFileResult FAxonShaderParser::ParseFile(const FString& FilePath)
{
	...
	{
		UE_LOG(LogAxonSource, Warning, TEXT("ShaderParser: Failed to read file: %s"), *FilePath);
		return Result;
	}
...
void FAxonShaderParser::ExtractIncludes(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
void FAxonShaderParser::ExtractDefines(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
void FAxonShaderParser::ExtractStructs(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
void FAxonShaderParser::ExtractFunctions(const FString& Text, const TArray<FString>& Lines, FParsedFileResult& Result)
{
...
int32 FAxonShaderParser::FindClosingBrace(const TArray<FString>& Lines, int32 OpenLineIdx)
{
	int32 Depth = 0;
...
FString FAxonShaderParser::FindDocstring(const TArray<FString>& Lines, int32 FuncLineIdx)
{

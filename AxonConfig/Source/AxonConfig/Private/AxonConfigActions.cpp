...
void FAxonConfigActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("config"), TEXT("resolve_setting"),
		...
		FAxonActionHandler::CreateStatic(&FAxonConfigActions::ResolveSetting),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("config"), TEXT("explain_setting"),
		...
		FAxonActionHandler::CreateStatic(&FAxonConfigActions::ExplainSetting),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("config"), TEXT("diff_from_default"),
		...
		FAxonActionHandler::CreateStatic(&FAxonConfigActions::DiffFromDefault),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("config"), TEXT("search_config"),
		...
		FAxonActionHandler::CreateStatic(&FAxonConfigActions::SearchConfig),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("config"), TEXT("get_section"),
		...
		FAxonActionHandler::CreateStatic(&FAxonConfigActions::GetSection),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("config"), TEXT("get_config_files"),
		...
		FAxonActionHandler::CreateStatic(&FAxonConfigActions::GetConfigFiles),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("config"), TEXT("set_developer_setting"),
		...
		FAxonActionHandler::CreateStatic(&FAxonConfigActions::SetDeveloperSetting),
		FParamSchemaBuilder()
...
FString FAxonConfigActions::ResolveConfigFilePath(const FString& ShortName)
{
...
TArray<TPair<FString, FString>> FAxonConfigActions::GetConfigHierarchy(const FString& Category)
{
...
FAxonActionResult FAxonConfigActions::ResolveSetting(const TSharedPtr<FJsonObject>& Params)
{
	...
	return FAxonActionResult::Success(ResultJson);
}
...
FAxonActionResult FAxonConfigActions::ExplainSetting(const TSharedPtr<FJsonObject>& Params)
{
	FString Category = Params->GetStringField(TEXT("file"));
	FString Section = Params->GetStringField(TEXT("section"));
	FString Key = Params->GetStringField(TEXT("key"));
...
FAxonActionResult FAxonConfigActions::DiffFromDefault(const TSharedPtr<FJsonObject>& Params)
{
	FString Category = Params->GetStringField(TEXT("file"));
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("No config found for category '%s'"), *Category));
	}
...
FAxonActionResult FAxonConfigActions::SearchConfig(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonConfigActions::GetSection(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Config file not found: '%s' (resolved to '%s')"), *FileShortName, *FilePath));
	}

	FString FileContents;
	if (!FFileHelper::LoadFileToString(FileContents, *FilePath))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to read config file: '%s'"), *FilePath));
	}
	...
	if (!bInSection)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Section '%s' not found in '%s'"), *Section, *FileShortName));
	}
...
FAxonActionResult FAxonConfigActions::GetConfigFiles(const TSharedPtr<FJsonObject>& Params)
{
	FString FilterCategory = Params->HasField(TEXT("category")) ? Params->GetStringField(TEXT("category")) : TEXT("");
...
//     Module is `DeveloperSettings` (NOT `Engine`) — added to AxonConfig.Build.cs.
//
...
FAxonActionResult FAxonConfigActions::SetDeveloperSetting(const TSharedPtr<FJsonObject>& Params)
{
	if (!Params.IsValid())
	{
		return FAxonActionResult::Error(TEXT("set_developer_setting: missing params object"));
	}

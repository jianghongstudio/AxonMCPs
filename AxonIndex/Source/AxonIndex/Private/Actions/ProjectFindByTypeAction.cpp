...
FAxonActionResult FProjectFindByTypeAction::Execute(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (AssetClass.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("'asset_type' (or 'asset_class') parameter is required"), -32602);
	}

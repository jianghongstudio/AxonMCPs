...
bool FBlueprintIndexer::IndexAsset(const FAssetData& AssetData, UObject* LoadedAsset, FAxonIndexDatabase& DB, int64 AssetId)
{
...
void FBlueprintIndexer::IndexGraph(UEdGraph* Graph, FAxonIndexDatabase& DB, int64 AssetId)
{
	if (!Graph) return;
...
void FBlueprintIndexer::IndexVariables(UBlueprint* Blueprint, FAxonIndexDatabase& DB, int64 AssetId)
{
	if (!Blueprint) return;

...
bool FDataTableIndexer::IndexAsset(const FAssetData& AssetData, UObject* LoadedAsset, FAxonIndexDatabase& DB, int64 AssetId)
{
	...
	UE_LOG(LogAxonIndex, Log, TEXT("DataTableIndexer: inserted %d rows from %d DataTable assets"),

...
bool FMaterialIndexer::IndexAsset(const FAssetData& AssetData, UObject* LoadedAsset, FAxonIndexDatabase& DB, int64 AssetId)
{
...
void FMaterialIndexer::IndexMaterialExpressions(UMaterial* Material, FAxonIndexDatabase& DB, int64 AssetId)
{
	if (!Material) return;
...
void FMaterialIndexer::IndexMaterialInstance(UMaterialInstanceConstant* MIC, FAxonIndexDatabase& DB, int64 AssetId)
{
	if (!MIC) return;

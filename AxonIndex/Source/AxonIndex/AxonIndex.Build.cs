...
public class AxonIndex : ModuleRules
{
	...
	// Keep BYTE-IDENTICAL with the copies in AxonMesh/AxonIndex/AxonAudio/AxonAnimation.
	...
	public AxonIndex(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// EnabledByDefault:false (and Optional:true in Axon.uplugin), so a source builder
		// who hasn't enabled it would otherwise hard-link MetasoundEngine/MetasoundFrontend → 126.
		// Release builds: AXON_RELEASE_BUILD=1 still forces this OFF (Issue #30 defense).

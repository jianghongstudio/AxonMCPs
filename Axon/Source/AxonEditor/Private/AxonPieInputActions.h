...
public:
	...
	static FAxonActionResult HandleSetControlRotation(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleInjectInputAction(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandlePossessSpectatorFree(const TSharedPtr<FJsonObject>& Params);
};

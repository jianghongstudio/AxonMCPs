...
public:
	...
	void SetLogCapture(FAxonLogCapture* InCapture) { LogCapture = InCapture; }
	FAxonLogCapture* GetLogCapture() const { return LogCapture; }
...
private:
	...
	FAxonLogCapture* LogCapture = nullptr;

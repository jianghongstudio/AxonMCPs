...
class FAxonLogCapture : public FOutputDevice
{
public:
	...
	TArray<FAxonLogEntry> GetRecentEntries(int32 Count) const;
	TArray<FAxonLogEntry> SearchEntries(const FString& Pattern, const FString& CategoryFilter, ELogVerbosity::Type MaxVerbosity, int32 Limit) const;
	TArray<FAxonLogEntry> GetEntriesSince(double SinceTimestamp, const TArray<FName>& CategoryFilter, ELogVerbosity::Type MaxVerbosity, int32 Limit) const;
...
private:
	...
	TArray<FAxonLogEntry> RingBuffer;
	int32 WriteIndex = 0;
	bool bWrapped = false;
...
class FAxonEditorActions
{
public:
	static void RegisterActions(FAxonLogCapture* LogCapture);
	static void InitLiveCodingDelegate();

	static FAxonActionResult HandleTriggerBuild(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetBuildErrors(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleGetBuildStatus(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetBuildSummary(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleSearchBuildOutput(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetCompileOutput(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetRecentLogs(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleSearchLogs(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleTailLog(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetLogCategories(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetLogStats(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetCrashContext(const TSharedPtr<FJsonObject>& Params);

	// --- Capture actions ---
	static FAxonActionResult HandleCaptureScenePreview(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleCaptureSequenceFrames(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleCaptureAnimFrames(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleCaptureSystemGif(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleImportTexture(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetViewportInfo(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleStitchFlipbook(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleDeleteAssets(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleInspectMaterialPBR(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleInspectTextureChannels(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleCaptureMaterialGrid(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleCaptureWithOverlay(const TSharedPtr<FJsonObject>& Params);

	// --- Automation tests ---
	static FAxonActionResult HandleRunAutomationTests(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleListAutomationTests(const TSharedPtr<FJsonObject>& Params);

	// --- Scripting actions (HOFF 7) ---
	static FAxonActionResult HandleRunPython(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleLoadLevel(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleRunConsoleCommand(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleListDirtyPackages(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleSavePackages(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleRunPieSmoke(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleCapturePieMovementClip(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult StartTimeseriesSession(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleListErroredBlueprints(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleCreateNavHarnessMap(const TSharedPtr<FJsonObject>& Params);
	...
	static FAxonActionResult HandleAuthorMapSettings(const TSharedPtr<FJsonObject>& Params);

	static void OnLiveCodingPatchComplete();

private:
	static FAxonLogCapture* CachedLogCapture;

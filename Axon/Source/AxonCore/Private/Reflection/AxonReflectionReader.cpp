...
TSharedPtr<FJsonValue> FAxonReflectionReader::PropertyToJsonValue(FProperty* Prop, const void* ValuePtr, const UObject* Owner)
{
...
TSharedPtr<FJsonObject> FAxonReflectionReader::PropertiesToJsonObject(UObject* Object)
{

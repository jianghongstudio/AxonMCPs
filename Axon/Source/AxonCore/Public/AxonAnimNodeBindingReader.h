...
// ============================================================
//  AxonAnimNodeBindingReader  (Gap 2 + Gap 12 — anim-node bindings)
//
...
//
//  Header-only inline (the Gap-1 AxonPropertyAccessReader pattern): AxonCore
//  deps Engine but NOT AnimGraph, so the bodies must compile at the include site
//  (AxonAnimation, which already deps AnimGraph + includes AnimGraphNode_Base.h).
//  No AxonCore Build.cs dependency is added.
//
...
namespace AxonAnimNodeBindingReader
{

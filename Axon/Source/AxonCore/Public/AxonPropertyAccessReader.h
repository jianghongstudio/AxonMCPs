...
// ============================================================
//  AxonPropertyAccessReader  (Gap 1 — resolved PropertyAccess path)
//
...
//  AxonBlueprintNodeActions.cpp) already spawns the node and sets its private
...
//
//  Lives here in AxonCore/Public so the K2 node serializer
//  (AxonBlueprintInternal.h) and the anim node serializer
//  (AxonAnimationActions.cpp) share ONE implementation — no duplication.
...
//  AxonCore Build.cs dependency is required.
//
...
namespace AxonPropertyAccessReader
{
	// Flat pin-type string, matching AxonBlueprintInternal::PinTypeToString /

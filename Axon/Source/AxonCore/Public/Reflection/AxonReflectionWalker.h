...
// FAxonReflectionWalker — JSON-tree -> FProperty schema walker.
 ...
 * (mirrors the cradle pattern at AxonBlueprintCDOActions.cpp:417-424).
 */
class AXONCORE_API FAxonReflectionWalker
{
public:
	/**
	 ...
	 * Mirrors existing AxonBlueprintCDOActions.cpp:385-396 pattern so behaviour

...
// FAxonReflectionReader — FProperty -> JSON-value reader.
// Read counterpart to the write-side FAxonReflectionWalker; deliberately a
 ...
 *
 * This is the canonical FProperty->JSON reader for Axon. It is the read
 * counterpart to FAxonReflectionWalker (which writes JSON->FProperty). It is
 ...
 */
class AXONCORE_API FAxonReflectionReader
{
public:
	/**

...
// Axon MCP Ergonomics framework primitives — Phase 0.
// Adapters in subsequent phases (1-5) consume these types via FAxonBulkFillRegistry.

#pragma once

#include "CoreMinimal.h"
#include "Dom/JsonObject.h"
#include "AxonBulkFillTypes.generated.h"
...
struct AXONCORE_API FSchemaDescriptor
{
	...
	UPROPERTY(BlueprintReadOnly, Category="Axon|Describe")
	FString FieldPath;
	 ...
	 * FAxonBulkFillActions::DescriptorToJson (AxonBulkFillActions.cpp), NOT via
	 ...
	 */
	UPROPERTY(BlueprintReadWrite, Category="Axon|Describe")
	float RangeMin = 0.f;

 ...
 */
enum class EAxonParamKind : uint8
{
	Other = 0,
	AssetPath,
	DiskPath,
...
namespace AxonParamKind
{
	inline const TCHAR* ToString(EAxonParamKind Kind)
	{
		switch (Kind)
		{
			case EAxonParamKind::AssetPath:   return TEXT("AssetPath");
			case EAxonParamKind::DiskPath:    return TEXT("DiskPath");
			case EAxonParamKind::GameplayTag: return TEXT("GameplayTag");
			default:                              return TEXT("Other");
		}
	}

	inline EAxonParamKind FromString(const FString& S)
	{
		if (S == TEXT("AssetPath"))   return EAxonParamKind::AssetPath;
		if (S == TEXT("DiskPath"))    return EAxonParamKind::DiskPath;
		if (S == TEXT("GameplayTag")) return EAxonParamKind::GameplayTag;
		return EAxonParamKind::Other;
	}
}
...
public:
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/true, /*Default=*/TEXT(""), /*bHasDefault=*/false, {}, EAxonParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/true, /*Default=*/TEXT(""), /*bHasDefault=*/false, Aliases, EAxonParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/false, Default, /*bHasDefault=*/!Default.IsEmpty(), {}, EAxonParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, Type, Desc, /*bRequired=*/false, Default, /*bHasDefault=*/!Default.IsEmpty(), Aliases, EAxonParamKind::Other);
		return *this;
	}
	...
	FParamSchemaBuilder& Optional(const FString& Name, const FString& Type, const FString& Desc,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, Type, Desc, /*bRequired=*/false, /*Default=*/TEXT(""), /*bHasDefault=*/false, Aliases, EAxonParamKind::Other);
		return *this;
	}
	...
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, {}, EAxonParamKind::AssetPath);
		return *this;
	}

	FParamSchemaBuilder& OptionalAssetPath(const TCHAR* Name, const TCHAR* Description)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, {}, EAxonParamKind::AssetPath);
		return *this;
	}

	FParamSchemaBuilder& RequiredDiskPath(const TCHAR* Name, const TCHAR* Description)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, {}, EAxonParamKind::DiskPath);
		return *this;
	}

	FParamSchemaBuilder& OptionalDiskPath(const TCHAR* Name, const TCHAR* Description)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, {}, EAxonParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& RequiredAssetPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, Aliases, EAxonParamKind::AssetPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalAssetPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, Aliases, EAxonParamKind::AssetPath);
		return *this;
	}
	...
	FParamSchemaBuilder& RequiredDiskPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/true, TEXT(""), /*bHasDefault=*/false, Aliases, EAxonParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalDiskPath(const TCHAR* Name, const TCHAR* Description,
		std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, TEXT(""), /*bHasDefault=*/false, Aliases, EAxonParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalAssetPathWithDefault(const TCHAR* Name, const TCHAR* Description,
		const TCHAR* Default)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, {}, EAxonParamKind::AssetPath);
		return *this;
	}
	...
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, Aliases, EAxonParamKind::AssetPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalDiskPathWithDefault(const TCHAR* Name, const TCHAR* Description,
		const TCHAR* Default)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, {}, EAxonParamKind::DiskPath);
		return *this;
	}
	...
	FParamSchemaBuilder& OptionalDiskPathWithDefault(const TCHAR* Name, const TCHAR* Description,
		const TCHAR* Default, std::initializer_list<const TCHAR*> Aliases)
	{
		AddParam(Name, TEXT("string"), Description, /*bRequired=*/false, Default, /*bHasDefault=*/true, Aliases, EAxonParamKind::DiskPath);
		return *this;
	}
...
private:
		...
		EAxonParamKind Kind)
	{
		...
		if (Kind != EAxonParamKind::Other)
		{
			Param->SetStringField(TEXT("kind"), AxonParamKind::ToString(Kind));
		}
 ...
 */
class AXONCORE_API FAxonParamSchema
{
public:

...
**蒸馏**：对 Agent 说「蒸馏本项目」→ 脚手架独立 KB 插件 → extract → Agent 蒸馏 Markdown。详见 [`Axon/.Knowledges/31-knowledge-distill.md`](Axon/.Knowledges/31-knowledge-distill.md) 与 [`Axon/Docs/USER_GUIDE.md`](Axon/Docs/USER_GUIDE.md) §项目蒸馏。

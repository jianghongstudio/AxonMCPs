...
void FAxonAbpWriteActions::RegisterActions(FAxonToolRegistry& Registry)
{
	// --- add_anim_graph_node ---
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("connect_anim_graph_pins"),
		...
		FAxonActionHandler::CreateStatic(&HandleConnectAnimGraphPins),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_state_animation"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetStateAnimation),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_variable_get"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddVariableGet),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_graph_node_property"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAnimGraphNodeProperty),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("configure_pose_history_node"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleConfigurePoseHistoryNode),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("configure_motion_matching_node"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleConfigureMotionMatchingNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_motion_matching_node"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleBuildMotionMatchingNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_graph_output_connection"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleGetAnimGraphOutputConnection),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_foot_ik_pass"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleBuildFootIkPass),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("abp_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("assign_post_process_anim_rig"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAssignPostProcessAnimRig),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_apply_additive"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddApplyAdditive),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_apply_mesh_space_additive"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddApplyMeshSpaceAdditive),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Optional(TEXT("base_node"), TEXT("string"), TEXT("Node whose pose output drives the Base input (must be in the same graph)"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_slot_node"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddSlotNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_save_cached_pose"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddSaveCachedPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_use_cached_pose"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddUseCachedPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_output_pose_source"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleSetOutputPoseSource),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_state_result_source"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleSetStateResultSource),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_blend_by_int"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddBlendByInt),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_blend_by_enum"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddBlendByEnum),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_sync_group"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleSetSyncGroup),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_layered_blend_bones"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleSetLayeredBlendBones),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_anim_control_rig_node"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddAnimControlRigNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_linked_anim_layer"),
		...
		FAxonActionHandler::CreateStatic(&FAxonAbpWriteActions::HandleAddLinkedAnimLayer),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
...
FAxonActionResult FAxonAbpWriteActions::HandleAddAnimGraphNode(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!NodeClass)
	{
		return FAxonActionResult::Error(ClassError);
	}
	...
	if (!Template)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create node template for class '%s'"), *NodeClass->GetPathName()));
	}
	...
	if (!AnimAsset.IsEmpty())
	{
		...
		if (AssetPlayer)
		{
			UAnimationAsset* Asset = FAxonAssetUtils::LoadAssetByPath<UAnimationAsset>(AnimAsset);
			if (!Asset)
			{
				return FAxonActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AnimAsset));
			}
		...
		else
		{
			...
			UE_LOG(LogTemp, Warning, TEXT("Axon: Node type '%s' does not support anim_asset parameter — ignored"), *NodeType);
		}
	}
	...
	if (!SpawnedNode)
	{
		return FAxonActionResult::Error(TEXT("PerformAction failed — node was not spawned. Check that the target graph supports this node type."));
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleConnectAnimGraphPins(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	...
	if (SourceNode.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: source_node"));
	if (SourcePin.IsEmpty())  return FAxonActionResult::Error(TEXT("Missing required parameter: source_pin"));
	if (TargetNode.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: target_node"));
	if (TargetPin.IsEmpty())  return FAxonActionResult::Error(TEXT("Missing required parameter: target_pin"));
	...
	if (!SrcNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Source node '%s' not found in ABP"), *SourceNode));
	}

	UEdGraphNode* DstNode = FindNodeByName(ABP, TargetNode, ScopeGraph);
	if (!DstNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Target node '%s' not found in ABP"), *TargetNode));
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleSetStateAnimation(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	...
	if (AnimAssetPath.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: anim_asset_path"));
	...
	UAnimationStateGraph* StateGraph = Cast<UAnimationStateGraph>(StateNode->BoundGraph);
	if (!StateGraph) return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' has no inner animation graph"), *StateName));

	UAnimGraphNode_StateResult* ResultNode = StateGraph->MyResultNode;
	if (!ResultNode) return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' has no result node — state graph may be corrupt"), *StateName));

	// Load the animation asset
	UAnimationAsset* AnimAsset = FAxonAssetUtils::LoadAssetByPath<UAnimationAsset>(AnimAssetPath);
	if (!AnimAsset) return FAxonActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AnimAssetPath));
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Could not find 'Result' input pin on state result node"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Failed to create animation player node template"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("PerformAction failed — animation player node was not spawned"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Spawned node has no 'Pose' output pin — cannot wire to state result"));
	}
	...
	if (!bWired)
	{
		return FAxonActionResult::Error(TEXT("TryCreateConnection failed wiring Pose -> Result. The node was spawned but not connected."));
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleAddVariableGet(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (VarName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: variable_name"));
	...
	if (!SpawnedNode)
	{
		return FAxonActionResult::Error(TEXT("PerformAction failed for K2Node_VariableGet."));
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleSetAnimGraphNodeProperty(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	...
	if (NodeId.IsEmpty())       return FAxonActionResult::Error(TEXT("Missing required parameter: node_id"));
	if (PropertyPath.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: property_path"));
	...
	if (!FoundNode)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Node '%s' not found"), *NodeId));
	}
	...
	{
		return FAxonActionResult::Error(ResolveError);
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleConfigurePoseHistoryNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath = Params->GetStringField(TEXT("abp_path"));
	const FString NodeId  = Params->GetStringField(TEXT("node_id"));
	if (NodeId.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: node_id"));

	UAnimBlueprint* ABP = FAxonAssetUtils::LoadAssetByPath<UAnimBlueprint>(AbpPath);
	if (!ABP) return FAxonActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AbpPath));

	UEdGraphNode* FoundNode = FindNodeByName(ABP, NodeId, nullptr);
	if (!FoundNode) return FAxonActionResult::Error(FString::Printf(TEXT("Node '%s' not found"), *NodeId));

	UAnimGraphNode_Base* AnimNode = Cast<UAnimGraphNode_Base>(FoundNode);
	if (!AnimNode) return FAxonActionResult::Error(FString::Printf(
	...
	if (Params->TryGetBoolField(TEXT("generate_trajectory"), bGenTraj))
	{
		...
		{ GEditor->EndTransaction(); return FAxonActionResult::Error(WriteError); }
...
FAxonActionResult FAxonAbpWriteActions::HandleConfigureMotionMatchingNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath = Params->GetStringField(TEXT("abp_path"));
	const FString NodeId  = Params->GetStringField(TEXT("node_id"));
	if (NodeId.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: node_id"));
	...
	if (bHasMin || bHasMax)
	{
		...
		{ GEditor->EndTransaction(); return FAxonActionResult::Error(TEXT("PoseJumpThresholdTime is not a struct property")); }
...
FAxonActionResult FAxonAbpWriteActions::HandleBuildMotionMatchingNode(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath      = Params->GetStringField(TEXT("abp_path"));
	...
	if (DatabasePath.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: database_path"));

	UAnimBlueprint* ABP = FAxonAssetUtils::LoadAssetByPath<UAnimBlueprint>(AbpPath);
	if (!ABP) return FAxonActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AbpPath));

	UPoseSearchDatabase* Database = FAxonAssetUtils::LoadAssetByPath<UPoseSearchDatabase>(DatabasePath);
	if (!Database) return FAxonActionResult::Error(FString::Printf(TEXT("UPoseSearchDatabase not found: %s"), *DatabasePath));
	...
	FAxonActionResult HistResult = HandleAddAnimGraphNode(HistParams);
	...
	FAxonActionResult MMResult = HandleAddAnimGraphNode(MMParams);
	...
	FAxonActionResult ConnResult = HandleConnectAnimGraphPins(ConnParams);
	...
	UAnimBlueprint* ABP2 = FAxonAssetUtils::LoadAssetByPath<UAnimBlueprint>(AbpPath);
	UEdGraphNode* MMNode = FindNodeByName(ABP2, MMNodeName, nullptr);
	UAnimGraphNode_Base* MMAnim = Cast<UAnimGraphNode_Base>(MMNode);
	if (!MMAnim) return FAxonActionResult::Error(TEXT("Spawned MotionMatching node could not be re-resolved"));
	...
	if (!DbObjProp)
	{ GEditor->EndTransaction(); return FAxonActionResult::Error(TEXT("MM node has no FObjectProperty 'Database'")); }
	...
	FString OutputWireNote;
	{
		...
		else
		{
			...
			FAxonActionResult RootConnResult = HandleConnectAnimGraphPins(RootConn);
...
FAxonActionResult FAxonAbpWriteActions::HandleGetAnimGraphOutputConnection(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath = Params->GetStringField(TEXT("abp_path"));
	FString GraphName = Params->HasField(TEXT("graph_name")) ? Params->GetStringField(TEXT("graph_name")) : TEXT("AnimGraph");
	if (GraphName.IsEmpty()) GraphName = TEXT("AnimGraph");

	if (AbpPath.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: abp_path"));
	...
	if (!Graph) return FAxonActionResult::Error(GraphError);
 ...
 */
FAxonActionResult ApplyAdditiveImpl(const TSharedPtr<FJsonObject>& Params, bool bMeshSpace)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (!NewNode) return FAxonActionResult::Error(SpawnError);
	...
	FString WireError;
	if (!WireInput(BaseNode, TEXT("Base"), WireError))         return FAxonActionResult::Error(WireError);
	if (!WireInput(AdditiveNode, TEXT("Additive"), WireError)) return FAxonActionResult::Error(WireError);
...
FAxonActionResult FAxonAbpWriteActions::HandleAddApplyAdditive(const TSharedPtr<FJsonObject>& Params)
{
	return ApplyAdditiveImpl(Params, /*bMeshSpace=*/false);
}

FAxonActionResult FAxonAbpWriteActions::HandleAddApplyMeshSpaceAdditive(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonAbpWriteActions::HandleAddSlotNode(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (SlotName.IsEmpty())
	{
		...
		return FAxonActionResult::Error(TEXT("Missing required parameter: slot_name (an unnamed slot node is a no-op pass-through)"));
	}
	...
	if (!SourceNode.IsEmpty())
	{
		...
		if (!Src) return FAxonActionResult::Error(FString::Printf(TEXT("Source node '%s' not found in target graph"), *SourceNode));
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleAddSaveCachedPose(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (CacheName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: cache_name"));
	...
	if (!StateName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Save Cached Pose nodes live only in the main AnimGraph, not inside a state's inner graph (they are sink nodes). Omit state_name."));
	}
	...
	if (!SaveNode) return FAxonActionResult::Error(TEXT("Spawned node is not a SaveCachedPose node"));
...
FAxonActionResult FAxonAbpWriteActions::HandleAddUseCachedPose(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	// pointer re-resolves by name at compile.
	{
		...
		if (!StrProp)
		{
			return FAxonActionResult::Error(TEXT("Could not resolve 'NameOfCache' FStrProperty on UseCachedPose node"));
		}
...
FAxonActionResult FAxonAbpWriteActions::HandleSetOutputPoseSource(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (!ResultPin)
	{
		return FAxonActionResult::Error(TEXT("Output Pose node has no 'Result' input pin (corrupt graph)"));
	}

	UEdGraphNode* Src = FindNodeByName(ABP, SourceNode, TargetGraph);
	if (!Src) return FAxonActionResult::Error(FString::Printf(TEXT("Source node '%s' not found in graph '%s'"), *SourceNode, *GraphName));
	...
	for (UEdGraphPin* Linked : ResultPin->LinkedTo)
	{
		if (Linked == OutPin)
		{
			...
			return FAxonActionResult::Success(NoOp);
		}
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleSetStateResultSource(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	UAnimationStateMachineGraph* SMGraph = FindSMGraphByName(ABP, MachineName);
	if (!SMGraph) return FAxonActionResult::Error(FString::Printf(TEXT("State machine '%s' not found"), *MachineName));

	UAnimStateNode* StateNode = FindStateByName(SMGraph, StateName);
	if (!StateNode) return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' not found in state machine '%s'"), *StateName, *MachineName));
...
FAxonActionResult FAxonAbpWriteActions::HandleAddBlendByInt(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: num_poses"));
	}
	const int32 NumPoses = static_cast<int32>(NumVal);
	if (NumPoses < 2)  return FAxonActionResult::Error(TEXT("num_poses must be >= 2 (a blend list needs at least two poses)"));
	if (NumPoses > 32) return FAxonActionResult::Error(TEXT("num_poses is capped at 32"));
	...
	if (!BlendNode) return FAxonActionResult::Error(TEXT("Spawned node is not a BlendListByInt node"));
...
// Local duplicate of AxonReflectionWalker.cpp's IsAutoMaxSentinel (lives in an anonymous
// namespace in AxonCore; duplicated here to avoid a cross-module surface change for one
...
FAxonActionResult FAxonAbpWriteActions::HandleAddBlendByEnum(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (EnumPath.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: enum_path"));
	}
	...
	if (Params->HasField(TEXT("enumerators")))
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Parameter 'enumerators' must be an array of enumerator name strings"));
		}
		...
		{
			return FAxonActionResult::Error(TEXT("Parameter 'enumerators' resolved to no usable enumerator names"));
		}
	}
	else
	{
	...
	if (!EnumNode) return FAxonActionResult::Error(TEXT("Spawned node is not a BlendListByEnum node"));
	...
	if (!BoundEnumObjProp)
	{
		return FAxonActionResult::Error(TEXT("BlendListByEnum node has no FObjectProperty 'BoundEnum' (engine layout changed?)"));
	}
	...
	if (!VisibleProp)
	{
		return FAxonActionResult::Error(TEXT("BlendListByEnum node has no array property 'VisibleEnumEntries' (engine layout changed?)"));
	}
	FNameProperty* VisibleInnerName = CastField<FNameProperty>(VisibleProp->Inner);
	if (!VisibleInnerName)
	{
		return FAxonActionResult::Error(TEXT("'VisibleEnumEntries' inner is not an FNameProperty (engine layout changed?)"));
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleSetSyncGroup(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (NodeId.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: node_id"));
	if (!Params->HasField(TEXT("group_name"))) return FAxonActionResult::Error(TEXT("Missing required parameter: group_name"));
...
FAxonActionResult FAxonAbpWriteActions::HandleSetLayeredBlendBones(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: layers (array of { bones: [{ bone, depth }] })"));
	}
	const int32 NumLayers = LayersArray->Num();
	if (NumLayers < 1) return FAxonActionResult::Error(TEXT("layers must contain at least one layer"));
	if (NumLayers > 32) return FAxonActionResult::Error(TEXT("layers is capped at 32"));
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Could not resolve 'LayerSetup' array property on the inner node"));
	}
	FStructProperty* LayerElemProp = CastField<FStructProperty>(LayerSetupProp->Inner);
	if (!LayerElemProp || !LayerElemProp->Struct)
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("LayerSetup inner is not a struct (FInputBlendPose expected)"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("FInputBlendPose has no 'BranchFilters' array property"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("BranchFilters inner is not a struct (FBranchFilter expected)"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("FBranchFilter is missing the expected BoneName (FName) / BlendDepth (int32) fields"));
	}
	...
	for (int32 LayerIdx = 0; LayerIdx < NumLayers; ++LayerIdx)
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("layers[%d] is not an object"), LayerIdx));
		}
...
FAxonActionResult FAxonAbpWriteActions::HandleBuildFootIkPass(const TSharedPtr<FJsonObject>& Params)
{
	const FString AbpPath       = Params->GetStringField(TEXT("abp_path"));
	...
	if (LeftFootBone.IsEmpty() || RightFootBone.IsEmpty() || PelvisBone.IsEmpty())
		return FAxonActionResult::Error(TEXT("left_foot_bone, right_foot_bone and pelvis_bone are all required"));
	...
	Graph->GetNodesOfClass<UAnimGraphNode_Root>(Roots);
	if (Roots.Num() == 0)
		return FAxonActionResult::Error(FString::Printf(TEXT("No Output Pose (UAnimGraphNode_Root) in graph '%s'"), *GraphName));
	UAnimGraphNode_Root* RootNode = Roots[0];
	UEdGraphPin* RootResultPin = RootNode->FindPin(FName(TEXT("Result")), EGPD_Input);
	if (!RootResultPin)
		return FAxonActionResult::Error(TEXT("Output Pose node has no 'Result' input pin"));
	...
	auto SpawnNode = [&](const TSharedPtr<FJsonObject>& P) -> FString
	{
		...
		FAxonActionResult R = HandleAddAnimGraphNode(P);
	...
	if (L2CNode.IsEmpty() || PelvisNode.IsEmpty() || IkLNode.IsEmpty() || IkRNode.IsEmpty() || C2LNode.IsEmpty())
		return FAxonActionResult::Error(TEXT("One or more foot-IK pass nodes failed to spawn"));
...
FAxonActionResult FAxonAbpWriteActions::HandleAssignPostProcessAnimRig(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (MeshPath.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: mesh_path"));

	USkeletalMesh* Mesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(MeshPath);
	if (!Mesh) return FAxonActionResult::Error(FString::Printf(TEXT("SkeletalMesh not found: %s"), *MeshPath));
	...
	if (!bClearing)
	{
		...
		UAnimBlueprint* PostAbp = FAxonAssetUtils::LoadAssetByPath<UAnimBlueprint>(PostAbpPath);
		if (PostAbp)
		{
			UClass* GenClass = PostAbp->GeneratedClass;
			if (!GenClass || !GenClass->IsChildOf(UAnimInstance::StaticClass()))
				return FAxonActionResult::Error(FString::Printf(TEXT("AnimBlueprint '%s' has no UAnimInstance generated class (recompile it first)"), *PostAbpPath));
			PostClass = GenClass;
		}
		else
		{
			...
			if (!AsClass)
				return FAxonActionResult::Error(FString::Printf(TEXT("Could not resolve post-process AnimBlueprint or AnimInstance class: %s"), *PostAbpPath));
			PostClass = AsClass;
		}
	}
...
FAxonActionResult FAxonAbpWriteActions::HandleAddAnimControlRigNode(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (ControlRigClassSpec.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: control_rig_class"));
	...
	if (!RigClass) return FAxonActionResult::Error(ClassError);
	...
	{
		Src = FindNodeByName(ABP, SourceNode, TargetGraph);
		if (!Src) return FAxonActionResult::Error(FString::Printf(TEXT("source_node '%s' not found in target graph"), *SourceNode));
	}
	...
	if (!CRNode) return FAxonActionResult::Error(TEXT("Spawned node is not a Control Rig anim node"));
...
FAxonActionResult FAxonAbpWriteActions::HandleAddLinkedAnimLayer(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("Editor is not available"));
	...
	if (LayerName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: layer_name"));
	...
	if (!InterfaceClassSpec.IsEmpty())
	{
		...
		if (!RequestedInterface) return FAxonActionResult::Error(IfaceErr);
	}
	...
	if (!InstanceClassSpec.IsEmpty())
	{
		...
		if (!InstanceClass) return FAxonActionResult::Error(InstErr);
	}
	...
	UAnimGraphNode_LinkedAnimLayer* LayerNode = nullptr;
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(TEXT("FGraphNodeCreator failed to create the Linked Anim Layer node"));
		}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(FString::Printf(TEXT("Could not write Layer name: %s"), *WriteErr));
	}
	...
	if (ResolvedInterfaceClass)
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Could not write Interface class: %s"), *WriteErr));
		}
	}
	...
	if (InstanceClass)
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Could not write InstanceClass: %s"), *WriteErr));
		}
	}
	...
	// GetTargetClass() (non-null = external interface, null = self).
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(TEXT("Could not locate the FunctionReference UPROPERTY on the Linked Anim Layer node"));
		}
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Could not locate the InterfaceGuid UPROPERTY on the Linked Anim Layer node"));
	}

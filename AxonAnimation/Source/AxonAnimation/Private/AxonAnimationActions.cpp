...
#include "AxonPropertyAccessReader.h"
#include "AxonAnimNodeBindingReader.h" // Gap 2 (function bindings) + Gap 12 (pin bindings) read helpers
...
#if WITH_CHOOSER
// Phase-2 read-only recursive chooser-tree collector (same module, AxonAnimation).
// Used to expand a referenced chooser's nested tree when recursive:true is requested.
#include "AxonChooserTreeCollector.h"
...
// deliberate.
namespace AxonAnimGraphChooser
{
...
void FAxonAnimationActions::RegisterActions(FAxonToolRegistry& Registry)
{
	// Montage Sections
	Registry.RegisterAction(TEXT("animation"), TEXT("add_montage_section"),
		TEXT("Add a section to an animation montage"),
		FAxonActionHandler::CreateStatic(&HandleAddMontageSection),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("delete_montage_section"),
		...
		FAxonActionHandler::CreateStatic(&HandleDeleteMontageSection),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_section_next"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetSectionNext),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_section_time"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetSectionTime),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
			.Required(TEXT("section_name"), TEXT("string"), TEXT("Name of the section"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_blendspace_sample"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddBlendSpaceSample),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("edit_blendspace_sample"),
		...
		FAxonActionHandler::CreateStatic(&HandleEditBlendSpaceSample),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("delete_blendspace_sample"),
		...
		FAxonActionHandler::CreateStatic(&HandleDeleteBlendSpaceSample),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("bake_blend_space"),
		...
		FAxonActionHandler::CreateStatic(&HandleBakeBlendSpace),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_blend_space_interpolation"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetBlendSpaceInterpolation),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_state_machines"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetStateMachines),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_state_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetStateInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_transitions"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetTransitions),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_blend_nodes"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetBlendNodes),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_graph_choosers"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAnimGraphChoosers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_node_function_bindings"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAnimNodeFunctionBindings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_node_function_binding"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAnimNodeFunctionBinding),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_anim_node_pin_bindings"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAnimNodePinBindings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_node_pin_binding"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAnimNodePinBinding),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("node_id"), TEXT("string"), TEXT("Node name or NodeGuid"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_time"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetNotifyTime),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_duration"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetNotifyDuration),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
			.Required(TEXT("notify_index"), TEXT("integer"), TEXT("Index of the notify"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_bone_track_keys"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetBoneTrackKeys),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_bone_track"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddBoneTrack),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation sequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_bone_track"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveBoneTrack),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation sequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("copy_bone_pose_between_sequences"),
		...
		FAxonActionHandler::CreateStatic(&HandleCopyBonePoseBetweenSequences),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_virtual_bone"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddVirtualBone),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_virtual_bones"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveVirtualBones),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeleton_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetSkeletonInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeletal_mesh_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetSkeletalMeshInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_sequence_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetSequenceInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_sequence_notifies"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetSequenceNotifies),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_bone_track_keys"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetBoneTrackKeys),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("list_bone_tracks"),
		...
		FAxonActionHandler::CreateStatic(&HandleListBoneTracks),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_sequence_curves"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetSequenceCurves),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeleton_preview_attached_assets"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetSkeletonPreviewAttachedAssets),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_bone_ref_pose"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetBoneRefPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton or SkeletalMesh asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_animated_bone_transform"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAnimatedBoneTransform),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_abp_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbpInfo),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_notify"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddNotify),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_notify_state"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddNotifyState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_notify"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveNotify),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_track"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetNotifyTrack),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("list_curves"),
		...
		FAxonActionHandler::CreateStatic(&HandleListCurves),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_curve"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddCurve),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_curve"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveCurve),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_curve_keys"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetCurveKeys),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_curve_keys"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetCurveKeys),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
			.Required(TEXT("curve_name"), TEXT("string"), TEXT("Curve name"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_socket"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddSocket),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_socket"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveSocket),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_socket_transform"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetSocketTransform),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_skeleton_curves"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetSkeletonCurves),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("set_blend_space_axis"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetBlendSpaceAxis),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("BlendSpace asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_root_motion_settings"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetRootMotionSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_sequence"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateSequence),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("duplicate_sequence"),
		...
		FAxonActionHandler::CreateStatic(&HandleDuplicateSequence),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_montage"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateMontage),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_montage_blend"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetMontageBlend),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_montage_slot"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddMontageSlot),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_montage_slot"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetMontageSlot),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("apply_anim_modifier"),
		...
		FAxonActionHandler::CreateStatic(&HandleApplyAnimModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_composite_segment"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddCompositeSegment),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimComposite asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_composite_segment"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveCompositeSegment),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimComposite asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_ikrig_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetIKRigInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_ik_solver"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddIKSolver),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IKRig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_ik_solver"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveIKSolver),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IKRig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_retargeter_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetRetargeterInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_chain_mapping"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetRetargetChainMapping),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IKRetargeter asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_control_rig_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetControlRigInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_control_rig_variables"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetControlRigVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("ControlRigBlueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_control_rig_element"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddControlRigElement),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("ControlRigBlueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_state_to_machine"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddStateToMachine),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_conduit"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddConduit),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name (exact, as shown in get_state_machines)"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_transition"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddTransition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_transition_rule"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetTransitionRule),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
			.Required(TEXT("from_state"), TEXT("string"), TEXT("Source state name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_transition_rule"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetTransitionRule),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
			.Required(TEXT("from_state"), TEXT("string"), TEXT("Source state name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_anim_state"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveAnimState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_anim_entry_state"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAnimEntryState),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_anim_transition"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveAnimTransition),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Required(TEXT("machine_name"), TEXT("string"), TEXT("State machine name"))
			.Required(TEXT("from_state"), TEXT("string"), TEXT("Source state name"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_state_machine"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateStateMachine),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_state_machine"),
		...
		FAxonActionHandler::CreateStatic(&HandleBuildStateMachine),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_abp_variables"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbpVariables),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("get_abp_linked_assets"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbpLinkedAssets),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_compatible_skeletons"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetCompatibleSkeletons),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
			.Build());
	Registry.RegisterAction(TEXT("animation"), TEXT("add_compatible_skeleton"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddCompatibleSkeleton),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_compatible_skeleton"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveCompatibleSkeleton),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_blend_space"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateBlendSpace),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_blend_space_1d"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateBlendSpace1D),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_aim_offset"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateAimOffset),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_aim_offset_1d"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateAimOffset1D),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_composite"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateComposite),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_anim_blueprint"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateAnimBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("compare_skeletons"),
		...
		FAxonActionHandler::CreateStatic(&HandleCompareSkeletons),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_sequence_properties"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetSequenceProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_additive_settings"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAdditiveSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_compression_settings"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetCompressionSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_sync_marker"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveSyncMarker),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("rename_sync_marker"),
		...
		FAxonActionHandler::CreateStatic(&HandleRenameSyncMarker),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("derive_foot_sync_markers"),
		...
		FAxonActionHandler::CreateStatic(&HandleDeriveFootSyncMarkers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("AnimSequence asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("batch_execute"),
		...
		FAxonActionHandler::CreateStatic(&HandleBatchExecute),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_montage_anim_segment"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddMontageAnimSegment),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Montage asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("clone_notify_setup"),
		...
		FAxonActionHandler::CreateStatic(&HandleCloneNotifySetup),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("source_path"), TEXT("Source animation asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("bulk_add_notify"),
		...
		FAxonActionHandler::CreateStatic(&HandleBulkAddNotify),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_montage_from_sections"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateMontageFromSections),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Asset path for the new montage"))
			.RequiredAssetPath(TEXT("skeleton_path"), TEXT("Skeleton asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("build_sequence_from_poses"),
		...
		FAxonActionHandler::CreateStatic(&HandleBuildSequenceFromPoses),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_notify_properties"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetNotifyProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Animation asset path (sequence, montage, composite)"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_physics_asset_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetPhysicsAssetInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_body_properties"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetBodyProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Physics asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_constraint_properties"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetConstraintProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("Physics asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_retarget_chain"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddRetargetChain),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_retarget_chain"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveRetargetChain),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IK Rig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_chain_bones"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetRetargetChainBones),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("IK Rig asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_ik_rig"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateIKRig),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_ik_retargeter"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateIKRetargeter),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retargeter_rigs"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetRetargeterRigs),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("batch_retarget_animations"),
		...
		FAxonActionHandler::CreateStatic(&HandleBatchRetargetAnimations),
		FParamSchemaBuilder()
...
FAxonActionResult FAxonAnimationActions::HandleAddMontageSection(const TSharedPtr<FJsonObject>& Params)
{
	...
	UAnimMontage* Montage = FAxonAssetUtils::LoadAssetByPath<UAnimMontage>(AssetPath);
	if (!Montage) return FAxonActionResult::Error(FString::Printf(TEXT("Montage not found: %s"), *AssetPath));
	...
	if (Index == INDEX_NONE)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to add section '%s' (name may already exist)"), *SectionName));
...
FAxonActionResult FAxonAnimationActions::HandleDeleteMontageSection(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Montage->IsValidSectionIndex(SectionIndex))
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid section index: %d"), SectionIndex));

	if (Montage->CompositeSections.Num() <= 1)
		return FAxonActionResult::Error(TEXT("Cannot delete the last remaining montage section"));
	...
	if (!bSuccess)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to delete section at index %d"), SectionIndex));
...
FAxonActionResult FAxonAnimationActions::HandleSetSectionNext(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SectionName = Params->GetStringField(TEXT("section_name"));
	...
	if (SectionIndex == INDEX_NONE)
		return FAxonActionResult::Error(FString::Printf(TEXT("Section not found: %s"), *SectionName));
...
FAxonActionResult FAxonAnimationActions::HandleSetSectionTime(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SectionName = Params->GetStringField(TEXT("section_name"));
...
FAxonActionResult FAxonAnimationActions::HandleAddBlendSpaceSample(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	UBlendSpace* BS = FAxonAssetUtils::LoadAssetByPath<UBlendSpace>(AssetPath);
	if (!BS) return FAxonActionResult::Error(FString::Printf(TEXT("BlendSpace not found: %s"), *AssetPath));

	UAnimSequence* Anim = FAxonAssetUtils::LoadAssetByPath<UAnimSequence>(AnimPath);
	if (!Anim) return FAxonActionResult::Error(FString::Printf(TEXT("AnimSequence not found: %s"), *AnimPath));
	...
	if (Index == INDEX_NONE)
		return FAxonActionResult::Error(TEXT("Failed to add sample"));
...
FAxonActionResult FAxonAnimationActions::HandleEditBlendSpaceSample(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!BS->IsValidBlendSampleIndex(SampleIndex))
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid sample index: %d"), SampleIndex));
...
FAxonActionResult FAxonAnimationActions::HandleDeleteBlendSpaceSample(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 SampleIndex = static_cast<int32>(Params->GetNumberField(TEXT("sample_index")));
	...
	if (!bSuccess)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to delete sample at index %d"), SampleIndex));
...
FAxonActionResult FAxonAnimationActions::HandleBakeBlendSpace(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleSetBlendSpaceInterpolation(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleSetNotifyTime(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	float NewTime = static_cast<float>(Params->GetNumberField(TEXT("new_time")));

	UAnimSequenceBase* Seq = FAxonAssetUtils::LoadAssetByPath<UAnimSequenceBase>(AssetPath);
	if (!Seq) return FAxonActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AssetPath));

	if (!Seq->Notifies.IsValidIndex(NotifyIndex))
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid notify index: %d (total: %d)"), NotifyIndex, Seq->Notifies.Num()));
...
FAxonActionResult FAxonAnimationActions::HandleSetNotifyDuration(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	...
	if (!Seq->Notifies[NotifyIndex].NotifyStateClass)
		return FAxonActionResult::Error(TEXT("Notify is not a state notify (no duration)"));
...
FAxonActionResult FAxonAnimationActions::HandleAddBoneTrack(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));

	UAnimSequence* Seq = FAxonAssetUtils::LoadAssetByPath<UAnimSequence>(AssetPath);
	if (!Seq) return FAxonActionResult::Error(FString::Printf(TEXT("AnimSequence not found: %s"), *AssetPath));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveBoneTrack(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	...
	if (bIncludeChildren && !Seq->GetSkeleton())
		return FAxonActionResult::Error(TEXT("Skeleton is null — cannot resolve children"));
...
FAxonActionResult FAxonAnimationActions::HandleSetBoneTrackKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
...
FAxonActionResult FAxonAnimationActions::HandleAddVirtualBone(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SourceBone = Params->GetStringField(TEXT("source_bone"));
	FString TargetBone = Params->GetStringField(TEXT("target_bone"));

	USkeleton* Skeleton = FAxonAssetUtils::LoadAssetByPath<USkeleton>(AssetPath);
	if (!Skeleton) return FAxonActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *AssetPath));

	const FReferenceSkeleton& RefSkel = Skeleton->GetReferenceSkeleton();
	if (RefSkel.FindBoneIndex(FName(*SourceBone)) == INDEX_NONE)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Source bone not found in skeleton: %s"), *SourceBone));
	}
	if (RefSkel.FindBoneIndex(FName(*TargetBone)) == INDEX_NONE)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Target bone not found in skeleton: %s"), *TargetBone));
	}
	...
	if (!bSuccess)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to add virtual bone from '%s' to '%s'"), *SourceBone, *TargetBone));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveVirtualBones(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	else
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(TEXT("No virtual bones found matching the given names"));
		}
	}
...
FAxonActionResult FAxonAnimationActions::HandleGetSkeletonInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetSkeletalMeshInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	USkeletalMesh* Mesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(AssetPath);
	if (!Mesh) return FAxonActionResult::Error(FString::Printf(TEXT("SkeletalMesh not found: %s"), *AssetPath));
...
FAxonActionResult FAxonAnimationActions::HandleGetStateMachines(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UAnimBlueprint* ABP = FAxonAssetUtils::LoadAssetByPath<UAnimBlueprint>(AssetPath);
	if (!ABP) return FAxonActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AssetPath));
...
FAxonActionResult FAxonAnimationActions::HandleGetStateInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: machine_name"));
	}
	if (StateName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: state_name"));
	}
	...
	return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *StateName, *MachineName));
}

FAxonActionResult FAxonAnimationActions::HandleGetTransitions(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
...
FAxonActionResult FAxonAnimationActions::HandleGetBlendNodes(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString GraphName;
	...
	return FAxonActionResult::Error(FString::Printf(TEXT("Graph '%s' not found"), *GraphName));
}

FAxonActionResult FAxonAnimationActions::HandleGetGraphs(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetNodes(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	for (UEdGraph* Graph : ABP->FunctionGraphs)
	{
		...
		for (UEdGraphNode* Node : Graph->Nodes)
		{
			...
			AxonAnimNodeBindingReader::SerializeCompactFunctionBindings(AnimNode, NodeObj);
			AxonAnimNodeBindingReader::SerializeCompactPinBindings(AnimNode, NodeObj);
	...
	if (bIncludeAnimGraph)
	{
		...
		for (UEdGraph* Graph : AllGraphs)
		{
			...
			for (UEdGraphNode* Node : Graph->Nodes)
			{
				...
				const bool bIsChooser = AxonAnimGraphChooser::IsEvaluateChooserNode(Node);
				...
				if (bIsChooser)
				{
					...
					AxonAnimGraphChooser::ResolveChooserAsset(Node, NodeObj);
				}
				if (bIsPropertyAccess)
				{
					// Reflectively resolve the private PropertyAccess path (shared helper, Gap 1).
					AxonPropertyAccessReader::SerializePropertyAccessBlock(Node, NodeObj);
				}
...
FAxonActionResult FAxonAnimationActions::HandleGetAnimGraphChoosers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	for (UEdGraph* Graph : AllGraphs)
	{
		...
		for (UEdGraphNode* Node : Graph->Nodes)
		{
			...
			// file-header comment on AxonAnimGraphChooser for the v1/v2 rationale.
			if (!AxonAnimGraphChooser::IsEvaluateChooserNode(Node)) continue;
			...
			UObject* ChooserAsset = AxonAnimGraphChooser::ResolveChooserAsset(Node, ChooserObj);
			...
			if (bRecursive && ChooserAsset)
			{
				...
				if (UChooserTable* Table = Cast<UChooserTable>(ChooserAsset))
				{
					...
					TSharedPtr<FJsonObject> Tree = AxonChooserTree::CollectTree(Table, VisitedTables);
					if (Tree.IsValid())
					{
...
FAxonActionResult FAxonAnimationActions::HandleGetLinkedLayers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetSequenceInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetSequenceNotifies(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetBoneTrackKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	int32 StartFrame = 0;
	...
	const IAnimationDataModel* DataModel = Seq->GetDataModel();
	if (!DataModel) return FAxonActionResult::Error(TEXT("No animation data model"));

	const FName BoneFName(*BoneName);
	if (!DataModel->IsValidBoneTrackName(BoneFName))
		return FAxonActionResult::Error(FString::Printf(TEXT("Bone track not found: %s"), *BoneName));
	...
	if (MaxKeys == 0)
		return FAxonActionResult::Error(FString::Printf(TEXT("Bone track has no keys: %s"), *BoneName));
	if (StartFrame > EndFrame)
		return FAxonActionResult::Error(FString::Printf(TEXT("start_frame (%d) > end_frame (%d)"), StartFrame, EndFrame));
...
FAxonActionResult FAxonAnimationActions::HandleListBoneTracks(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetSequenceCurves(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetMontageInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetBlendSpaceInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetSkeletonSockets(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	else
	{
		USkeletalMesh* Mesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(AssetPath);
		if (!Mesh)
			return FAxonActionResult::Error(FString::Printf(TEXT("Skeleton or SkeletalMesh not found: %s"), *AssetPath));
...
FAxonActionResult FAxonAnimationActions::HandleGetSkeletonPreviewAttachedAssets(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	USkeleton* Skeleton = FAxonAssetUtils::LoadAssetByPath<USkeleton>(AssetPath);
	if (!Skeleton)
		return FAxonActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *AssetPath));
...
FAxonActionResult FAxonAnimationActions::HandleGetBoneRefPose(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (USkeleton* Skeleton = FAxonAssetUtils::LoadAssetByPath<USkeleton>(AssetPath))
	{
		RefSkel = &Skeleton->GetReferenceSkeleton();
		SourceType = TEXT("Skeleton");
	}
	else if (USkeletalMesh* Mesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(AssetPath))
	{
...
FAxonActionResult FAxonAnimationActions::HandleGetAnimatedBoneTransform(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (BoneName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("bone_name is required"));
	}
	...
	{
		return FAxonActionResult::Error(TEXT("Provide one of: frame (integer) or time (seconds)"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleGetAbpInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleAddNotify(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Time < 0.f || Time > Seq->GetPlayLength())
		return FAxonActionResult::Error(FString::Printf(TEXT("Time %.3f out of range [0, %.3f]"), Time, Seq->GetPlayLength()));
	...
	if (!NotifyClass || !NotifyClass->IsChildOf(UAnimNotify::StaticClass()))
		return FAxonActionResult::Error(FString::Printf(TEXT("Notify class not found or not a UAnimNotify subclass: %s"), *NotifyClassName));

	UAnimNotify* NewNotify = NewObject<UAnimNotify>(Seq, NotifyClass);
	if (!NewNotify)
		return FAxonActionResult::Error(TEXT("Failed to create notify instance"));
...
FAxonActionResult FAxonAnimationActions::HandleAddNotifyState(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NotifyClassName = Params->GetStringField(TEXT("notify_class"));
	float Time = static_cast<float>(Params->GetNumberField(TEXT("time")));
	...
	if (Time < 0.f || Time > Seq->GetPlayLength())
		return FAxonActionResult::Error(FString::Printf(TEXT("Time %.3f out of range [0, %.3f]"), Time, Seq->GetPlayLength()));
	if (Duration <= 0.f)
		return FAxonActionResult::Error(TEXT("Duration must be > 0"));
	if (Time + Duration > Seq->GetPlayLength())
		return FAxonActionResult::Error(FString::Printf(TEXT("Time + Duration (%.3f) exceeds play length (%.3f)"), Time + Duration, Seq->GetPlayLength()));
	...
	if (!NotifyClass || !NotifyClass->IsChildOf(UAnimNotifyState::StaticClass()))
		return FAxonActionResult::Error(FString::Printf(TEXT("NotifyState class not found or not a UAnimNotifyState subclass: %s"), *NotifyClassName));

	UAnimNotifyState* NewNotifyState = NewObject<UAnimNotifyState>(Seq, NotifyClass);
	if (!NewNotifyState)
		return FAxonActionResult::Error(TEXT("Failed to create notify state instance"));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveNotify(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
...
FAxonActionResult FAxonAnimationActions::HandleSetNotifyTrack(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	...
	if (!Seq->AnimNotifyTracks.IsValidIndex(TrackIndex))
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid track index: %d (total: %d)"), TrackIndex, Seq->AnimNotifyTracks.Num()));
...
FAxonActionResult FAxonAnimationActions::HandleListCurves(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleAddCurve(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Seq->GetDataModel()->FindCurve(CurveId))
		return FAxonActionResult::Error(FString::Printf(TEXT("Curve '%s' already exists"), *CurveName));
	...
	if (!bSuccess)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to add curve '%s'"), *CurveName));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveCurve(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString CurveName = Params->GetStringField(TEXT("curve_name"));
	FString CurveTypeStr = Params->HasField(TEXT("curve_type")) ? Params->GetStringField(TEXT("curve_type")) : TEXT("Float");
	...
	if (!Seq->GetDataModel()->FindCurve(CurveId))
		return FAxonActionResult::Error(FString::Printf(TEXT("Curve '%s' not found"), *CurveName));
	...
	if (!bSuccess)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to remove curve '%s'"), *CurveName));
...
FAxonActionResult FAxonAnimationActions::HandleSetCurveKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString CurveName = Params->GetStringField(TEXT("curve_name"));
	...
	if (!Seq->GetDataModel()->FindCurve(CurveId))
		return FAxonActionResult::Error(FString::Printf(TEXT("Curve '%s' not found — add it first"), *CurveName));
	...
	if (!FJsonSerializer::Deserialize(Reader, JsonKeys))
		return FAxonActionResult::Error(TEXT("Failed to parse keys_json — expected JSON array"));
	...
	if (!bSuccess)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to set keys on curve '%s'"), *CurveName));
...
FAxonActionResult FAxonAnimationActions::HandleGetCurveKeys(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString CurveName = Params->GetStringField(TEXT("curve_name"));
...
FAxonActionResult FAxonAnimationActions::HandleAddSocket(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	...
	if (Skeleton->GetReferenceSkeleton().FindBoneIndex(FName(*BoneName)) == INDEX_NONE)
		return FAxonActionResult::Error(FString::Printf(TEXT("Bone '%s' not found in skeleton"), *BoneName));

	// Check socket doesn't already exist
	if (Skeleton->FindSocket(FName(*SocketName)))
		return FAxonActionResult::Error(FString::Printf(TEXT("Socket '%s' already exists"), *SocketName));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveSocket(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SocketName = Params->GetStringField(TEXT("socket_name"));
	...
	if (!FoundSocket)
		return FAxonActionResult::Error(FString::Printf(TEXT("Socket '%s' not found"), *SocketName));
...
FAxonActionResult FAxonAnimationActions::HandleSetSocketTransform(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SocketName = Params->GetStringField(TEXT("socket_name"));
	...
	if (!bAnySet)
		return FAxonActionResult::Error(TEXT("At least one of location, rotation, or scale must be provided"));
...
FAxonActionResult FAxonAnimationActions::HandleGetSkeletonCurves(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleSetBlendSpaceAxis(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (AxisStr.Equals(TEXT("X"), ESearchCase::IgnoreCase))
		...
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid axis '%s' — must be X or Y"), *AxisStr));
	...
	if (!BlendParam)
		return FAxonActionResult::Error(TEXT("Failed to access BlendParameters via reflection"));
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(FString::Printf(TEXT("min (%.2f) must be less than max (%.2f)"), BlendParam->Min, BlendParam->Max));
	}
...
FAxonActionResult FAxonAnimationActions::HandleSetRootMotionSettings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("root_motion_lock")))
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Invalid root_motion_lock: '%s' — use AnimFirstFrame, Zero, or RefPose"), *LockStr));
		}
		bAnySet = true;
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("At least one of enable_root_motion, root_motion_lock, or force_root_lock must be provided"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleCreateSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));

	USkeleton* Skeleton = FAxonAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPath);
	if (!Skeleton) return FAxonActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *SkeletonPath));
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid asset path: %s"), *AssetPath));
	}
	AssetName = AssetPath.Mid(LastSlash + 1);

	// Check if asset already exists
	if (FAxonAssetUtils::LoadAssetByPath<UObject>(AssetPath))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Asset already exists at '%s'"), *AssetPath));
	}

	UPackage* Pkg = CreatePackage(*AssetPath);
	if (!Pkg)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create package at '%s'"), *AssetPath));
	}

	UAnimSequence* Seq = NewObject<UAnimSequence>(Pkg, FName(*AssetName), RF_Public | RF_Standalone);
	if (!Seq)
	{
		return FAxonActionResult::Error(TEXT("Failed to create UAnimSequence object"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleDuplicateSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath = Params->GetStringField(TEXT("source_path"));
	FString DestPath = Params->GetStringField(TEXT("dest_path"));

	// Check source exists
	UObject* SourceObj = FAxonAssetUtils::LoadAssetByPath<UObject>(SourcePath);
	if (!SourceObj)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Source asset not found: %s"), *SourcePath));
	}

	// Check dest doesn't exist
	if (FAxonAssetUtils::LoadAssetByPath<UObject>(DestPath))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Asset already exists at '%s'"), *DestPath));
	}

	UObject* DuplicatedObj = UEditorAssetLibrary::DuplicateAsset(SourcePath, DestPath);
	if (!DuplicatedObj)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to duplicate '%s' to '%s'"), *SourcePath, *DestPath));
	}
...
FAxonActionResult FAxonAnimationActions::HandleCreateMontage(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!Montage)
	{
		return FAxonActionResult::Error(TEXT("Failed to create UAnimMontage object"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleSetMontageBlend(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("At least one of blend_in_time, blend_out_time, blend_out_trigger_time, or enable_auto_blend_out must be provided"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleAddMontageSlot(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	for (const FSlotAnimationTrack& Track : Montage->SlotAnimTracks)
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Slot '%s' already exists on montage"), *SlotName));
		}
	}
...
FAxonActionResult FAxonAnimationActions::HandleSetMontageSlot(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid slot index %d (montage has %d slots)"), SlotIndex, Montage->SlotAnimTracks.Num()));
	}
...
FAxonActionResult FAxonAnimationActions::HandleApplyAnimModifier(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!ModifierUClass)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Modifier class not found: %s"), *ModifierClass));
	}

	if (!ModifierUClass->IsChildOf(UAnimationModifier::StaticClass()))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Class '%s' is not a UAnimationModifier subclass"), *ModifierClass));
	}
	...
	if (bPersist)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Failed to register modifier in the AnimationModifiers stack"));
		}
		...
		if (!Registered)
		{
			return FAxonActionResult::Error(TEXT("Modifier registered but could not be recovered from the stack for apply"));
		}
	...
	else
	{
		...
		if (!Modifier)
		{
			return FAxonActionResult::Error(TEXT("Failed to create modifier instance"));
		}
		if (bHasProperties)
		{
...
FAxonActionResult FAxonAnimationActions::HandleListAnimModifiers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetCompositeInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UAnimComposite* Composite = FAxonAssetUtils::LoadAssetByPath<UAnimComposite>(AssetPath);
	if (!Composite) return FAxonActionResult::Error(FString::Printf(TEXT("AnimComposite not found: %s"), *AssetPath));
...
FAxonActionResult FAxonAnimationActions::HandleAddCompositeSegment(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString AnimPath = Params->GetStringField(TEXT("anim_path"));
	...
	UAnimSequenceBase* Anim = FAxonAssetUtils::LoadAssetByPath<UAnimSequenceBase>(AnimPath);
	if (!Anim) return FAxonActionResult::Error(FString::Printf(TEXT("Animation not found: %s"), *AnimPath));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveCompositeSegment(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid segment index %d (composite has %d segments)"), SegmentIndex, Segments.Num()));
	}
...
FAxonActionResult FAxonAnimationActions::HandleGetAbpVariables(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetAbpLinkedAssets(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleGetCompatibleSkeletons(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleAddCompatibleSkeleton(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	USkeleton* Compat = FAxonAssetUtils::LoadAssetByPath<USkeleton>(CompatPath);
	if (!Compat)
		return FAxonActionResult::Error(FString::Printf(TEXT("Compatible Skeleton not found: %s"), *CompatPath));

	if (Skeleton == Compat)
		return FAxonActionResult::Error(TEXT("Cannot mark a skeleton compatible with itself"));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveCompatibleSkeleton(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	const FString CompatPath = Params->GetStringField(TEXT("compatible_with"));
	bool bSave = true;
...
FAxonActionResult FAxonAnimationActions::HandleGetControlRigInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UControlRigBlueprint* CRB = FAxonAssetUtils::LoadAssetByPath<UControlRigBlueprint>(AssetPath);
	if (!CRB) return FAxonActionResult::Error(FString::Printf(TEXT("ControlRigBlueprint not found: %s"), *AssetPath));

	URigHierarchy* H = CRB->Hierarchy;
	if (!H) return FAxonActionResult::Error(TEXT("ControlRigBlueprint has no hierarchy"));
...
FAxonActionResult FAxonAnimationActions::HandleGetControlRigVariables(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleAddControlRigElement(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	...
	if (Name.IsEmpty())
		return FAxonActionResult::Error(TEXT("name must not be empty"));

	UControlRigBlueprint* CRB = FAxonAssetUtils::LoadAssetByPath<UControlRigBlueprint>(AssetPath);
	if (!CRB) return FAxonActionResult::Error(FString::Printf(TEXT("ControlRigBlueprint not found: %s"), *AssetPath));

	URigHierarchyController* HC = CRB->GetHierarchyController();
	if (!HC) return FAxonActionResult::Error(TEXT("Failed to get hierarchy controller"));

	// Parse element type
	ElementTypeStr.ToLowerInline();
	if (ElementTypeStr != TEXT("bone") && ElementTypeStr != TEXT("control") && ElementTypeStr != TEXT("null"))
		return FAxonActionResult::Error(TEXT("Invalid element_type — use bone, control, or null"));
	...
	if (Params->TryGetStringField(TEXT("parent"), ParentName) && !ParentName.IsEmpty())
	{
		...
		if (!H || !H->Find(ParentKey))
			return FAxonActionResult::Error(FString::Printf(TEXT("Parent element not found: %s"), *ParentName));
	}
	...
	if (!ResultKey.IsValid())
		return FAxonActionResult::Error(TEXT("Failed to create element — AddBone/AddNull/AddControl returned invalid key"));
...
FAxonActionResult FAxonAnimationActions::HandleGetIKRigInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UIKRigDefinition* Asset = FAxonAssetUtils::LoadAssetByPath<UIKRigDefinition>(AssetPath);
	if (!Asset) return FAxonActionResult::Error(FString::Printf(TEXT("IKRigDefinition not found: %s"), *AssetPath));

	UIKRigController* C = UIKRigController::GetController(Asset);
	if (!C) return FAxonActionResult::Error(TEXT("Failed to get IKRigController"));
...
FAxonActionResult FAxonAnimationActions::HandleAddIKSolver(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (SolverType.IsEmpty())
		return FAxonActionResult::Error(TEXT("solver_type is required"));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveIKSolver(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Params->HasField(TEXT("solver_index")))
		return FAxonActionResult::Error(TEXT("solver_index is required"));
...
namespace AxonRetargetOpReader
{
...
FAxonActionResult FAxonAnimationActions::HandleGetRetargeterInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UIKRetargeter* Asset = FAxonAssetUtils::LoadAssetByPath<UIKRetargeter>(AssetPath);
	if (!Asset) return FAxonActionResult::Error(FString::Printf(TEXT("IKRetargeter not found: %s"), *AssetPath));

	UIKRetargeterController* C = UIKRetargeterController::GetController(Asset);
	if (!C) return FAxonActionResult::Error(TEXT("Failed to get UIKRetargeterController"));
		...
		if (const FIKRetargetOpBase* Op = C->GetRetargetOpByIndex(OpIdx))
		{
			...
			if (SettingsStruct && OpSettings)
			{
				...
				OpObj->SetObjectField(TEXT("settings"),
					AxonRetargetOpReader::StructToJson(SettingsStruct,
...
FAxonActionResult FAxonAnimationActions::HandleSetRetargetChainMapping(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("Must provide either 'auto_map' or both 'source_chain' and 'target_chain'"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleAddStateToMachine(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	FString StateName   = Params->GetStringField(TEXT("state_name"));
	...
	if (MachineName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: machine_name"));
	if (StateName.IsEmpty())   return FAxonActionResult::Error(TEXT("Missing required parameter: state_name"));

	UAnimBlueprint* ABP = FAxonAssetUtils::LoadAssetByPath<UAnimBlueprint>(AssetPath);
	if (!ABP) return FAxonActionResult::Error(FString::Printf(TEXT("AnimBlueprint not found: %s"), *AssetPath));

	UAnimationStateMachineGraph* SMGraph = FindStateMachineGraphByName(ABP, MachineName);
	if (!SMGraph) return FAxonActionResult::Error(FString::Printf(TEXT("State machine '%s' not found in ABP"), *MachineName));

	// Reject duplicate state names up front
	if (FindStateNodeByName(SMGraph, StateName))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("A state named '%s' already exists in machine '%s'"), *StateName, *MachineName));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Failed to spawn state node"));
	}

	if (!NewNode->BoundGraph)
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("State node created but BoundGraph is null — state may be corrupt"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleAddConduit(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	...
	if (MachineName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: machine_name"));
	if (ConduitName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: conduit_name"));
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("A state named '%s' already exists in machine '%s'"), *ConduitName, *MachineName));
	}
	if (FindConduitNodeByName(SMGraph, ConduitName))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("A conduit named '%s' already exists in machine '%s'"), *ConduitName, *MachineName));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Failed to spawn conduit node"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Conduit node created but BoundGraph is null — conduit may be corrupt"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleAddTransition(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	...
	if (MachineName.IsEmpty()) return FAxonActionResult::Error(TEXT("Missing required parameter: machine_name"));
	if (FromState.IsEmpty())   return FAxonActionResult::Error(TEXT("Missing required parameter: from_state"));
	if (ToState.IsEmpty())     return FAxonActionResult::Error(TEXT("Missing required parameter: to_state"));
	...
	if (!FromNode) return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *FromState, *MachineName));

	UAnimStateNode* ToNode = FindStateNodeByName(SMGraph, ToState);
	if (!ToNode) return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *ToState, *MachineName));

	UEdGraphPin* OutputPin = FromNode->GetOutputPin();
	UEdGraphPin* InputPin  = ToNode->GetInputPin();

	if (!OutputPin) return FAxonActionResult::Error(FString::Printf(TEXT("Source state '%s' has no output pin"), *FromState));
	if (!InputPin)  return FAxonActionResult::Error(FString::Printf(TEXT("Target state '%s' has no input pin"), *ToState));
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("State machine graph has unexpected or null schema"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleRemoveAnimState(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("GEditor unavailable"));
	...
	if (!StateNode) return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *StateName, *MachineName));
...
FAxonActionResult FAxonAnimationActions::HandleSetAnimEntryState(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("GEditor unavailable"));
	...
	if (!EntryNode) return FAxonActionResult::Error(FString::Printf(TEXT("State machine '%s' has no entry node (corrupt)"), *MachineName));

	UAnimStateNode* TargetState = FindStateNodeByName(SMGraph, StateName);
	if (!TargetState) return FAxonActionResult::Error(FString::Printf(TEXT("State '%s' not found in machine '%s'"), *StateName, *MachineName));
	...
	UEdGraphPin* EntryOut = EntryNode->GetOutputPin();
	if (!EntryOut) return FAxonActionResult::Error(TEXT("Entry node has no output pin"));
	UEdGraphPin* StateIn = TargetState->GetInputPin();
	if (!StateIn) return FAxonActionResult::Error(FString::Printf(TEXT("Target state '%s' has no input pin"), *StateName));

	const UAnimationStateMachineSchema* Schema = Cast<UAnimationStateMachineSchema>(SMGraph->GetSchema());
	if (!Schema) return FAxonActionResult::Error(TEXT("State machine graph has unexpected or null schema"));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveAnimTransition(const TSharedPtr<FJsonObject>& Params)
{
	if (!GEditor) return FAxonActionResult::Error(TEXT("GEditor unavailable"));
...
// canonical capture in AxonCommonUITemplateActions.cpp.
...
FAxonActionResult FAxonAnimationActions::HandleSetTransitionRule(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	FString MachineName  = Params->GetStringField(TEXT("machine_name"));
	FString FromState    = Params->GetStringField(TEXT("from_state"));
	...
	{
		return FAxonActionResult::Error(ParsedRule.ParseError.IsEmpty()
	...
	else if (ParsedRule.Kind == FParsedTransitionRule::EKind::Expression)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("kind:expression requires at least one term in 'terms'."));
		}
	...
	if (!RuleGraph)
	{
		return FAxonActionResult::Error(TEXT("Transition has no bound rule graph"));
	}
	...
	if (!ResultNode)
	{
		return FAxonActionResult::Error(TEXT("Transition rule graph has no result node"));
	}

	UEdGraphPin* ResultPin = ResultNode->FindPin(TEXT("bCanEnterTransition"), EGPD_Input);
	if (!ResultPin)
	{
		return FAxonActionResult::Error(TEXT("Could not find bCanEnterTransition pin on transition result node"));
	}
	...
	if (!bAuthored)
	{
		...
		FKismetEditorUtilities::CompileBlueprint(ABP);
		ABP->GetOutermost()->SetDirtyFlag(bWasDirty);
		return FAxonActionResult::Error(FString::Printf(TEXT("Rule authoring failed (rolled back, no package change): %s"), *AuthorError));
	}
...
FAxonActionResult FAxonAnimationActions::HandleGetTransitionRule(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString MachineName = Params->GetStringField(TEXT("machine_name"));
	FString FromState   = Params->GetStringField(TEXT("from_state"));
...
FAxonActionResult FAxonAnimationActions::HandleCreateStateMachine(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!AnimGraph)
	{
		return FAxonActionResult::Error(GraphName.IsEmpty()
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Failed to spawn state machine node (SpawnNodeFromTemplate returned null or EditorStateMachineGraph was not created)"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleBuildStateMachine(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SMName    = Params->HasField(TEXT("state_machine_name")) ? Params->GetStringField(TEXT("state_machine_name")) : TEXT("New State Machine");
	FString GraphName = Params->HasField(TEXT("graph_name")) ? Params->GetStringField(TEXT("graph_name")) : FString();
	...
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required parameter: states (array of {name, animation?})"));
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("Failed to spawn state machine node"));
	}
	UAnimationStateMachineGraph* SMGraph = Cast<UAnimationStateMachineGraph>(SMNode->EditorStateMachineGraph);
	if (!SMGraph)
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("State machine graph has unexpected type"));
	}
	SMGraph->Modify();
	...
	for (const TSharedPtr<FJsonValue>& SV : *StatesJson)
	{
		...
		if ((*StateObj)->HasField(TEXT("animation")))
		{
			...
			if (!AnimPath.IsEmpty())
			{
				UAnimSequenceBase* Seq = FAxonAssetUtils::LoadAssetByPath<UAnimSequenceBase>(AnimPath);
				if (!Seq)
				{
...
FAxonActionResult FAxonAnimationActions::HandleCreateBlendSpace(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	UPackage* Pkg = CreatePackage(*AssetPath);
	if (!Pkg) return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create package at '%s'"), *AssetPath));

	UBlendSpace* BS = NewObject<UBlendSpace>(Pkg, FName(*AssetName), RF_Public | RF_Standalone);
	if (!BS) return FAxonActionResult::Error(TEXT("Failed to create UBlendSpace object"));
...
FAxonActionResult FAxonAnimationActions::HandleCreateBlendSpace1D(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!BS) return FAxonActionResult::Error(TEXT("Failed to create UBlendSpace1D object"));
...
FAxonActionResult FAxonAnimationActions::HandleCreateAimOffset(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!AO) return FAxonActionResult::Error(TEXT("Failed to create UAimOffsetBlendSpace object"));
...
FAxonActionResult FAxonAnimationActions::HandleCreateAimOffset1D(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!AO) return FAxonActionResult::Error(TEXT("Failed to create UAimOffsetBlendSpace1D object"));
...
FAxonActionResult FAxonAnimationActions::HandleCreateComposite(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!Composite) return FAxonActionResult::Error(TEXT("Failed to create UAnimComposite object"));
...
FAxonActionResult FAxonAnimationActions::HandleCreateAnimBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	else
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Parent class '%s' not found or not derived from UAnimInstance"), *ParentClassName));
		}
	}
	...
	if (!AnimBP)
		return FAxonActionResult::Error(TEXT("Failed to create Animation Blueprint via FKismetEditorUtilities::CreateBlueprint"));
...
FAxonActionResult FAxonAnimationActions::HandleCompareSkeletons(const TSharedPtr<FJsonObject>& Params)
{
	FString SkeletonPathA = Params->GetStringField(TEXT("skeleton_a"));
	FString SkeletonPathB = Params->GetStringField(TEXT("skeleton_b"));

	USkeleton* SkeletonA = FAxonAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPathA);
	if (!SkeletonA) return FAxonActionResult::Error(FString::Printf(TEXT("Skeleton A not found: %s"), *SkeletonPathA));

	USkeleton* SkeletonB = FAxonAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPathB);
	if (!SkeletonB) return FAxonActionResult::Error(FString::Printf(TEXT("Skeleton B not found: %s"), *SkeletonPathB));
...
FAxonActionResult FAxonAnimationActions::HandleSetSequenceProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("interpolation")))
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Invalid interpolation: '%s' — use Linear or Step"), *InterpStr));
		}
		bAnySet = true;
	}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("At least one of rate_scale, loop, or interpolation must be provided"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleSetAdditiveSettings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("additive_anim_type")))
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Invalid additive_anim_type: '%s' — use NoAdditive, LocalSpace, or MeshSpace"), *TypeStr));
		}
		bAnySet = true;
	}
	...
	if (Params->HasField(TEXT("ref_pose_type")))
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Invalid ref_pose_type: '%s' — use RefPose, AnimScaled, AnimFrame, or LocalAnimFrame"), *RefStr));
		}
		bAnySet = true;
	}
	...
	if (Params->HasField(TEXT("ref_pose_seq")))
	{
		...
		{
			UAnimSequence* RefSeq = FAxonAssetUtils::LoadAssetByPath<UAnimSequence>(RefSeqPath);
			if (!RefSeq)
			{
				GEditor->EndTransaction();
				return FAxonActionResult::Error(FString::Printf(TEXT("Reference pose sequence not found: %s"), *RefSeqPath));
			}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("At least one of additive_anim_type, ref_pose_type, ref_frame_index, or ref_pose_seq must be provided"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleSetCompressionSettings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("bone_compression")))
	{
		...
		{
			UAnimBoneCompressionSettings* BoneComp = FAxonAssetUtils::LoadAssetByPath<UAnimBoneCompressionSettings>(BoneCompPath);
			if (!BoneComp)
			{
				GEditor->EndTransaction();
				return FAxonActionResult::Error(FString::Printf(TEXT("Bone compression settings not found: %s"), *BoneCompPath));
			}
	...
	if (Params->HasField(TEXT("curve_compression")))
	{
		...
		{
			UAnimCurveCompressionSettings* CurveComp = FAxonAssetUtils::LoadAssetByPath<UAnimCurveCompressionSettings>(CurveCompPath);
			if (!CurveComp)
			{
				GEditor->EndTransaction();
				return FAxonActionResult::Error(FString::Printf(TEXT("Curve compression settings not found: %s"), *CurveCompPath));
			}
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(TEXT("At least one of bone_compression or curve_compression must be provided"));
	}
...
FAxonActionResult FAxonAnimationActions::HandleGetSyncMarkers(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleAddSyncMarker(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveSyncMarker(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!bHasName && !bHasIndex)
		return FAxonActionResult::Error(TEXT("Either marker_name or marker_index must be provided"));
	...
	if (bHasIndex)
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Invalid marker_index: %d (have %d markers)"), MarkerIndex, Seq->AuthoredSyncMarkers.Num()));
		}
...
FAxonActionResult FAxonAnimationActions::HandleRenameSyncMarker(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (RenamedCount == 0)
		return FAxonActionResult::Error(FString::Printf(TEXT("No sync markers found with name '%s'"), *OldName));
...
FAxonActionResult FAxonAnimationActions::HandleBatchExecute(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!OpsField.IsValid())
	{
		return FAxonActionResult::Error(TEXT("Missing required field: operations"));
	}
	...
	else if (OpsField->Type == EJson::String)
	{
		...
		{
			return FAxonActionResult::Error(TEXT("Failed to parse operations string as JSON array"));
		}
	}
	else
	{
		return FAxonActionResult::Error(TEXT("'operations' must be an array"));
	}

	if (Ops.Num() == 0)
	{
		return FAxonActionResult::Error(TEXT("operations array is empty"));
	}

	bool bStopOnError = false;
	Params->TryGetBoolField(TEXT("stop_on_error"), bStopOnError);

	GEditor->BeginTransaction(NSLOCTEXT("Axon", "AnimBatchExec", "Animation Batch Execute"));
	...
	for (int32 i = 0; i < Ops.Num(); ++i)
	{
		...
		{
			const FString OpFieldKey = AxonKeyToString(Pair.Key);
		...
		FAxonActionResult SubResult = FAxonActionResult::Error(FString::Printf(TEXT("Unknown op: %s"), *OpName));
	...
	return FAxonActionResult::Success(Final);
}

// ---------------------------------------------------------------------------

FAxonActionResult FAxonAnimationActions::HandleAddMontageAnimSegment(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString AnimPath = Params->GetStringField(TEXT("anim_path"));
	...
	if (SlotIndex < 0 || SlotIndex >= Montage->SlotAnimTracks.Num())
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid slot_index %d (montage has %d slots)"), SlotIndex, Montage->SlotAnimTracks.Num()));
	}
...
FAxonActionResult FAxonAnimationActions::HandleCloneNotifySetup(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath = Params->GetStringField(TEXT("source_path"));
	...
	UAnimSequenceBase* Source = FAxonAssetUtils::LoadAssetByPath<UAnimSequenceBase>(SourcePath);
	if (!Source) return FAxonActionResult::Error(FString::Printf(TEXT("Source animation not found: %s"), *SourcePath));

	UAnimSequenceBase* Target = FAxonAssetUtils::LoadAssetByPath<UAnimSequenceBase>(TargetPath);
	if (!Target) return FAxonActionResult::Error(FString::Printf(TEXT("Target animation not found: %s"), *TargetPath));

	if (Source == Target)
		return FAxonActionResult::Error(TEXT("Source and target cannot be the same asset"));

	if (Source->Notifies.Num() == 0)
		return FAxonActionResult::Error(TEXT("Source has no notifies to clone"));
...
FAxonActionResult FAxonAnimationActions::HandleBulkAddNotify(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!PathsField.IsValid())
		return FAxonActionResult::Error(TEXT("Missing required field: asset_paths"));
	...
	else if (PathsField->Type == EJson::String)
	{
		...
		if (!FJsonSerializer::Deserialize(Reader, PathValues))
			return FAxonActionResult::Error(TEXT("Failed to parse asset_paths string as JSON array"));
	}
	else
	{
		return FAxonActionResult::Error(TEXT("'asset_paths' must be an array"));
	}

	if (PathValues.Num() == 0)
		return FAxonActionResult::Error(TEXT("asset_paths array is empty"));
	...
	if (!NotifyClass)
		return FAxonActionResult::Error(FString::Printf(TEXT("Notify class not found: %s"), *NotifyClassName));

	if (NotifyClass->IsChildOf(UAnimNotifyState::StaticClass()))
	{
		bIsNotifyState = true;
		if (!bIsState)
			return FAxonActionResult::Error(TEXT("Notify class is a state notify — 'duration' parameter is required"));
	}
	else if (!NotifyClass->IsChildOf(UAnimNotify::StaticClass()))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Class '%s' is not a UAnimNotify or UAnimNotifyState subclass"), *NotifyClassName));
	}
...
FAxonActionResult FAxonAnimationActions::HandleCreateMontageFromSections(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	FAxonActionResult CreateResult = HandleCreateMontage(CreateParams);
	if (!CreateResult.bSuccess)
		return CreateResult;

	UAnimMontage* Montage = FAxonAssetUtils::LoadAssetByPath<UAnimMontage>(AssetPath);
	if (!Montage)
		return FAxonActionResult::Error(FString::Printf(TEXT("Created montage but failed to load: %s"), *AssetPath));
	...
	if (Params->TryGetArrayField(TEXT("sections"), SectionsArr) && SectionsArr)
	{
		...
		for (int32 i = 0; i < SectionsArr->Num(); ++i)
		{
			...
			{
				UAnimSequenceBase* Anim = FAxonAssetUtils::LoadAssetByPath<UAnimSequenceBase>(SectionAnimPath);
				if (Anim)
				{
					FAnimSegment NewSeg;
					NewSeg.SetAnimReference(Anim);
...
FAxonActionResult FAxonAnimationActions::HandleBuildSequenceFromPoses(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
	...
	if (!FramesField.IsValid())
		return FAxonActionResult::Error(TEXT("Missing required field: frames"));
	...
	else if (FramesField->Type == EJson::String)
	{
		...
		if (!FJsonSerializer::Deserialize(Reader, FramesArr))
			return FAxonActionResult::Error(TEXT("Failed to parse frames string as JSON array"));
	}
	else
	{
		return FAxonActionResult::Error(TEXT("'frames' must be an array"));
	}

	if (FramesArr.Num() == 0)
		return FAxonActionResult::Error(TEXT("frames array is empty"));
	...
	if (!Seq)
	{
		...
		if (!Seq) return FAxonActionResult::Error(TEXT("Failed to create UAnimSequence object"));
	...
	if (BoneNameSet.Num() == 0)
		return FAxonActionResult::Error(TEXT("No bone data found in frames"));
...
FAxonActionResult FAxonAnimationActions::HandleSetNotifyProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 NotifyIndex = static_cast<int32>(Params->GetNumberField(TEXT("notify_index")));
	...
	if (NotifyIndex < 0 || NotifyIndex >= Seq->Notifies.Num())
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid notify_index %d (asset has %d notifies)"), NotifyIndex, Seq->Notifies.Num()));
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Notify at index %d has no Notify or NotifyStateClass object"), NotifyIndex));
	}
	...
	if (!Params->TryGetObjectField(TEXT("properties"), PropsPtr) || !PropsPtr || !PropsPtr->IsValid())
	{
		...
		if (Params->TryGetStringField(TEXT("properties"), PropsString))
		{
			...
			{
				return FAxonActionResult::Error(TEXT("Failed to parse 'properties' as JSON object"));
			}
		}
		else
		{
			return FAxonActionResult::Error(TEXT("'properties' parameter is required and must be a JSON object"));
		}
	}

	if (!PropsPtr || !PropsPtr->IsValid() || (*PropsPtr)->Values.Num() == 0)
		return FAxonActionResult::Error(TEXT("'properties' object is empty"));
	...
	{
		const FString PropName = AxonKeyToString(Pair.Key);
...
FAxonActionResult FAxonAnimationActions::HandleGetPhysicsAssetInfo(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UPhysicsAsset* PhysAsset = FAxonAssetUtils::LoadAssetByPath<UPhysicsAsset>(AssetPath);
	if (!PhysAsset) return FAxonActionResult::Error(FString::Printf(TEXT("Physics asset not found: %s"), *AssetPath));
...
FAxonActionResult FAxonAnimationActions::HandleSetBodyProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString BoneName = Params->GetStringField(TEXT("bone_name"));
	...
	if (BodyIdx == INDEX_NONE)
		return FAxonActionResult::Error(FString::Printf(TEXT("Body not found for bone: %s"), *BoneName));

	USkeletalBodySetup* BodySetup = PhysAsset->SkeletalBodySetups[BodyIdx];
	if (!BodySetup) return FAxonActionResult::Error(TEXT("BodySetup is null"));
...
FAxonActionResult FAxonAnimationActions::HandleSetConstraintProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (ConstraintIdx == INDEX_NONE || !PhysAsset->ConstraintSetup.IsValidIndex(ConstraintIdx))
		return FAxonActionResult::Error(TEXT("Constraint not found. Provide constraint_index or bone_1+bone_2 pair."));

	UPhysicsConstraintTemplate* CT = PhysAsset->ConstraintSetup[ConstraintIdx];
	if (!CT) return FAxonActionResult::Error(TEXT("Constraint template is null"));
...
FAxonActionResult FAxonAnimationActions::HandleAddRetargetChain(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (ResultName.IsNone())
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to add retarget chain '%s'"), *ChainName));
...
FAxonActionResult FAxonAnimationActions::HandleRemoveRetargetChain(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ChainName = Params->GetStringField(TEXT("chain_name"));
	...
	if (!bSuccess)
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to remove retarget chain '%s' — chain may not exist"), *ChainName));
...
FAxonActionResult FAxonAnimationActions::HandleSetRetargetChainBones(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString ChainName = Params->GetStringField(TEXT("chain_name"));
	...
	if (!Chain)
		return FAxonActionResult::Error(FString::Printf(TEXT("Retarget chain not found: %s"), *ChainName));
	...
	if (Params->TryGetStringField(TEXT("start_bone"), StartBone) && !StartBone.IsEmpty())
	{
		...
		if (!bOk) return FAxonActionResult::Error(FString::Printf(TEXT("Failed to set start bone '%s' on chain '%s'"), *StartBone, *ChainName));
	...
	if (Params->TryGetStringField(TEXT("end_bone"), EndBone) && !EndBone.IsEmpty())
	{
		...
		if (!bOk) return FAxonActionResult::Error(FString::Printf(TEXT("Failed to set end bone '%s' on chain '%s'"), *EndBone, *ChainName));
	...
	if (Params->TryGetStringField(TEXT("goal_name"), GoalStr) && !GoalStr.IsEmpty())
	{
		...
		if (!bOk) return FAxonActionResult::Error(FString::Printf(TEXT("Failed to set goal '%s' on chain '%s'"), *GoalStr, *ChainName));
	...
	if (Params->TryGetStringField(TEXT("new_name"), NewName) && !NewName.IsEmpty())
	{
		...
		if (RenamedName.IsNone())
			return FAxonActionResult::Error(FString::Printf(TEXT("Failed to rename chain '%s' to '%s'"), *ChainName, *NewName));
...
FAxonActionResult FAxonAnimationActions::HandleCreateIKRig(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString MeshPath = Params->GetStringField(TEXT("skeletal_mesh_path"));

	USkeletalMesh* Mesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(MeshPath);
	if (!Mesh) return FAxonActionResult::Error(FString::Printf(TEXT("Skeletal mesh not found: %s"), *MeshPath));
	...
	if (!Rig) return FAxonActionResult::Error(TEXT("Failed to create UIKRigDefinition object"));

	UIKRigController* C = UIKRigController::GetController(Rig);
	if (!C) return FAxonActionResult::Error(TEXT("Failed to get IKRigController for new rig"));

	// Loads the mesh's skeleton into the rig's IKRigSkeleton.
	const bool bMeshSet = C->SetSkeletalMesh(Mesh);
	if (!bMeshSet)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("SetSkeletalMesh failed — mesh '%s' incompatible with IK Rig"), *MeshPath));
	}
...
FAxonActionResult FAxonAnimationActions::HandleCreateIKRetargeter(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Retargeter) return FAxonActionResult::Error(TEXT("Failed to create UIKRetargeter object"));

	UIKRetargeterController* C = UIKRetargeterController::GetController(Retargeter);
	if (!C) return FAxonActionResult::Error(TEXT("Failed to get UIKRetargeterController for new retargeter"));
	...
	{
		UIKRigDefinition* SourceRig = FAxonAssetUtils::LoadAssetByPath<UIKRigDefinition>(SourceRigPath);
		if (!SourceRig) return FAxonActionResult::Error(FString::Printf(TEXT("Source IK Rig not found: %s"), *SourceRigPath));
	...
	{
		UIKRigDefinition* TargetRig = FAxonAssetUtils::LoadAssetByPath<UIKRigDefinition>(TargetRigPath);
		if (!TargetRig) return FAxonActionResult::Error(FString::Printf(TEXT("Target IK Rig not found: %s"), *TargetRigPath));
...
FAxonActionResult FAxonAnimationActions::HandleSetRetargeterRigs(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	UIKRetargeter* Retargeter = FAxonAssetUtils::LoadAssetByPath<UIKRetargeter>(AssetPath);
	if (!Retargeter) return FAxonActionResult::Error(FString::Printf(TEXT("IKRetargeter not found: %s"), *AssetPath));
	...
	{
		USkeletalMesh* SourceMesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(SourceMeshPath);
		if (!SourceMesh)
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Source preview mesh not found: %s"), *SourceMeshPath));
		}
	...
	{
		USkeletalMesh* TargetMesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(TargetMeshPath);
		if (!TargetMesh)
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Target preview mesh not found: %s"), *TargetMeshPath));
		}
...
FAxonActionResult FAxonAnimationActions::HandleBatchRetargetAnimations(const TSharedPtr<FJsonObject>& Params)
{
	...
	UIKRetargeter* Retargeter = FAxonAssetUtils::LoadAssetByPath<UIKRetargeter>(RetargeterPath);
	if (!Retargeter) return FAxonActionResult::Error(FString::Printf(TEXT("IKRetargeter not found: %s"), *RetargeterPath));
	...
	{
		SourceMesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(SourceMeshPath);
		if (!SourceMesh) return FAxonActionResult::Error(FString::Printf(TEXT("Source mesh not found: %s"), *SourceMeshPath));
	}
	else
	{
	...
	{
		TargetMesh = FAxonAssetUtils::LoadAssetByPath<USkeletalMesh>(TargetMeshPath);
		if (!TargetMesh) return FAxonActionResult::Error(FString::Printf(TEXT("Target mesh not found: %s"), *TargetMeshPath));
	}
	else
	{
	...
	if (!SourceMesh) return FAxonActionResult::Error(TEXT("No source mesh — pass 'source_mesh' or set the retargeter's source preview mesh"));
	if (!TargetMesh) return FAxonActionResult::Error(TEXT("No target mesh — pass 'target_mesh' or set the retargeter's target preview mesh"));
	if (SourceMesh == TargetMesh) return FAxonActionResult::Error(TEXT("Source and target meshes must differ"));
	...
	{
		return FAxonActionResult::Error(TEXT("'source_anims' must be a non-empty array of animation asset paths"));
	}
	...
	for (const TSharedPtr<FJsonValue>& Val : *AnimsArray)
	{
		...
		UAnimationAsset* Anim = FAxonAssetUtils::LoadAssetByPath<UAnimationAsset>(AnimPath);
		if (!Anim)
		{
	...
	{
		return FAxonActionResult::Error(TEXT("No valid animation assets resolved from 'source_anims'"));
	}
	...
	if (!Context.IsValid())
	{
		return FAxonActionResult::Error(TEXT("Batch context invalid — check source/target meshes and retargeter"));
	}
	...
	for (const FString& Expected : ExpectedPaths)
	{
		...
		if (UObject* Created = FAxonAssetUtils::LoadAssetByPath<UObject>(PackagePath))
		{
...
// ---------------------------------------------------------------------------
FAxonActionResult FAxonAnimationActions::HandleCopyBonePoseBetweenSequences(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath = Params->GetStringField(TEXT("source_path"));
	FString DestPath = Params->GetStringField(TEXT("dest_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required field: bone_names"));
	}

	UAnimSequence* SourceSeq = FAxonAssetUtils::LoadAssetByPath<UAnimSequence>(SourcePath);
	if (!SourceSeq) return FAxonActionResult::Error(FString::Printf(TEXT("Source AnimSequence not found: %s"), *SourcePath));

	UAnimSequence* DestSeq = FAxonAssetUtils::LoadAssetByPath<UAnimSequence>(DestPath);
	if (!DestSeq) return FAxonActionResult::Error(FString::Printf(TEXT("Dest AnimSequence not found: %s"), *DestPath));
	...
	if (!SourceSkel || !DestSkel) return FAxonActionResult::Error(TEXT("Source or destination has no skeleton assigned"));

	const IAnimationDataModel* DestDataModel = DestSeq->GetDataModel();
	if (!DestDataModel) return FAxonActionResult::Error(TEXT("Destination has no animation data model"));
...
namespace AxonAnimNodeBindingHelpers
{
...
FAxonActionResult FAxonAnimationActions::HandleGetAnimNodeFunctionBindings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeId;
	...
	auto EmitNode = [OwnerClass](UAnimGraphNode_Base* AnimNode, UEdGraph* Graph) -> TSharedPtr<FJsonObject>
	{
		...
		NodeObj->SetObjectField(TEXT("initial_update"),
			AxonAnimNodeBindingReader::SerializeFunctionBinding(AnimNode->InitialUpdateFunction, OwnerClass));
		NodeObj->SetObjectField(TEXT("become_relevant"),
			AxonAnimNodeBindingReader::SerializeFunctionBinding(AnimNode->BecomeRelevantFunction, OwnerClass));
		NodeObj->SetObjectField(TEXT("update"),
			AxonAnimNodeBindingReader::SerializeFunctionBinding(AnimNode->UpdateFunction, OwnerClass));
		return NodeObj;
	};
	...
	if (!NodeId.IsEmpty())
	{
		...
		UAnimGraphNode_Base* AnimNode = AxonAnimNodeBindingHelpers::FindAnimNode(ABP, NodeId, GraphFilter);
		if (!AnimNode)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Anim node not found: %s"), *NodeId));
		}
	...
	else
	{
		...
		for (UEdGraph* Graph : AllGraphs)
		{
			...
			for (UEdGraphNode* Node : Graph->Nodes)
			{
				UAnimGraphNode_Base* AnimNode = Cast<UAnimGraphNode_Base>(Node);
				if (!AnimNode) continue;
				if (!AxonAnimNodeBindingReader::HasAnyFunctionBinding(AnimNode)) continue;
...
FAxonActionResult FAxonAnimationActions::HandleSetAnimNodeFunctionBinding(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("binding must be one of: initial_update, become_relevant, update"));
	}
	...
	UAnimGraphNode_Base* AnimNode = AxonAnimNodeBindingHelpers::FindAnimNode(ABP, NodeId, GraphFilter);
	if (!AnimNode) return FAxonActionResult::Error(FString::Printf(TEXT("Anim node not found: %s"), *NodeId));

	FName PropertyName = NAME_None;
	FMemberReference* Ref = AxonAnimNodeBindingHelpers::ResolveFunctionRef(AnimNode, Binding, PropertyName);
	if (!Ref) return FAxonActionResult::Error(TEXT("Could not resolve the function-binding member reference"));
	...
	else
	{
		...
		if (!FunctionClassPath.IsEmpty())
		{
			...
			if (!FunctionClass)
			{
				return FAxonActionResult::Error(FString::Printf(TEXT("function_class not found: %s"), *FunctionClassPath));
			}
		}
...
FAxonActionResult FAxonAnimationActions::HandleGetAnimNodePinBindings(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeId;
	Params->TryGetStringField(TEXT("node_id"), NodeId);
	...
	auto EmitNode = [](UAnimGraphNode_Base* AnimNode, UEdGraph* Graph) -> TSharedPtr<FJsonObject>
	{
		...
		FString Note;
		AxonAnimNodeBindingReader::ReadPinBindings(AnimNode, Entries, Note);
		...
		for (UEdGraph* Graph : AllGraphs)
		{
			...
			for (UEdGraphNode* Node : Graph->Nodes)
			{
				...
				const bool bHasPropertyBinding =
					AxonAnimNodeBindingReader::ReadPinBindings(AnimNode, Probe, ProbeNote) > 0;
...
FAxonActionResult FAxonAnimationActions::HandleSetAnimNodePinBinding(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString NodeId = Params->GetStringField(TEXT("node_id"));
	...
	if (Pin.IsEmpty()) return FAxonActionResult::Error(TEXT("pin (PropertyName) is required"));
	...
	bool bHasMap = AxonAnimNodeBindingReader::ResolvePropertyBindingsMap(AnimNode, MapProp, MapPtr, BindingObj);
	...
	else
	{
		...
		if (!bHasMap)
		{
			...
			//    same property the reader reads at AxonAnimNodeBindingReader.h:139-141.
			...
			bHasMap = AxonAnimNodeBindingReader::ResolvePropertyBindingsMap(AnimNode, MapProp, MapPtr, BindingObj);
			if (!bHasMap)
			{
				return FAxonActionResult::Error(
		...
		{
			return FAxonActionResult::Error(TEXT("PropertyBindings value type is not FAnimGraphNodePropertyBinding"));
		}
		FNameProperty* KeyProp = CastField<FNameProperty>(MapProp->KeyProp);
		if (!KeyProp)
		{
			return FAxonActionResult::Error(TEXT("PropertyBindings key type is not FName"));
		}
...
//
// File-local helpers below are deliberately namespace-scoped (Axon::FootSync)
// to avoid file-local-symbol collisions under full-unity release builds.
namespace Axon { namespace FootSync {
...
}} // namespace Axon::FootSync

FAxonActionResult FAxonAnimationActions::HandleDeriveFootSyncMarkers(const TSharedPtr<FJsonObject>& Params)
{
	using namespace Axon::FootSync;
	...
	{
		return FAxonActionResult::Error(TEXT("thresholds.sample_rate must be > 0"));
	}
	...
	if (!Seq)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("AnimSequence not found: %s"), *AssetPath));
	}
	...
	if (Source.IsEmpty() && Method == TEXT("from_bones"))
	{
		...
		if (!Skeleton)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("method=from_bones: no skeleton on %s"), *AssetPath));
		}
	...
	if (Source.IsEmpty() && WantSignal(TEXT("footspeed")))
	{
		...
		if (!Skeleton)
		{
			...
			{
				return FAxonActionResult::Error(FString::Printf(TEXT("method=footspeed: no skeleton on %s"), *AssetPath));
			}
		}
		else
		{

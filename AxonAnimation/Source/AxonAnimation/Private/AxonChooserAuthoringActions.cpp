...
// module taking the "Chooser" dependency (same as AxonChooserActions.cpp).
...
void FAxonChooserAuthoringActions::RegisterActions(FAxonToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("create_chooser_table"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateChooserTable),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("add_chooser_column"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddChooserColumn),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("add_chooser_row"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddChooserRow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("UChooserTable asset path"))
	...
	Registry.RegisterAction(TEXT("chooser"), TEXT("set_chooser_cell"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetChooserCell),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("UChooserTable asset path"))
...
// ===========================================================================
// WITH_CHOOSER == 0 : clean off-gate stubs (mirrors AxonChooserActions.cpp:99-105)
// ===========================================================================
#if !WITH_CHOOSER

namespace
{
	FAxonActionResult ChooserAuthoringUnavailable()
	{
		return FAxonActionResult::Error(TEXT("Chooser plugin not available"));
	}
}

FAxonActionResult FAxonChooserAuthoringActions::HandleCreateChooserTable(const TSharedPtr<FJsonObject>&) { return ChooserAuthoringUnavailable(); }
FAxonActionResult FAxonChooserAuthoringActions::HandleAddChooserColumn(const TSharedPtr<FJsonObject>&)  { return ChooserAuthoringUnavailable(); }
FAxonActionResult FAxonChooserAuthoringActions::HandleAddChooserRow(const TSharedPtr<FJsonObject>&)     { return ChooserAuthoringUnavailable(); }
FAxonActionResult FAxonChooserAuthoringActions::HandleSetChooserCell(const TSharedPtr<FJsonObject>&)   { return ChooserAuthoringUnavailable(); }
...
FAxonActionResult FAxonChooserAuthoringActions::HandleCreateChooserTable(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!Table)
	{
		return FAxonActionResult::Error(TEXT("Failed to create UChooserTable object"));
	}
...
FAxonActionResult FAxonChooserAuthoringActions::HandleAddChooserColumn(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("ColumnsStructs is editor-only data; not available in this build"));
#endif
}
...
FAxonActionResult FAxonChooserAuthoringActions::HandleAddChooserRow(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required array parameter: cells"));
	}
	...
	UObject* OutputAsset = FAxonAssetUtils::LoadAssetByPath(OutputPsd);
	if (!OutputAsset)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("output_psd asset not found: %s"), *OutputPsd));
	}
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("ResultsStructs/ColumnsStructs are editor-only data; not available in this build"));
#endif
}
...
FAxonActionResult FAxonChooserAuthoringActions::HandleSetChooserCell(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: column_index"));
	}
	if (!Params->TryGetNumberField(TEXT("row_index"), RowIdxD))
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: row_index"));
	}
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("ColumnsStructs are editor-only data; not available in this build"));
#endif
}

...
UIKRetargetOpControllerBase* FAxonRetargetSettingsActions::ResolveOpController(
...
FAxonActionResult FAxonRetargetSettingsActions::HandleAlignRetargetPose(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!Controller) { return FAxonActionResult::Error(Error); }
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Unknown side '%s' — use 'source', 'target', or 'both'"), *SideStr));
	}
	...
	else if (ModeStr.Equals(TEXT("align_chain"), ESearchCase::IgnoreCase))
	{
		...
		{
			return FAxonActionResult::Error(TEXT("mode 'align_chain' requires a non-empty 'chain_names' array of bone names"));
		}
	}
...
FAxonActionResult FAxonRetargetSettingsActions::HandleGetRetargetPose(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
...
FAxonActionResult FAxonRetargetSettingsActions::HandleSetRetargetPose(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
	...
	{
		return FAxonActionResult::Error(TEXT(
...
FAxonActionResult FAxonRetargetSettingsActions::HandleGetRetargetChainSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
...
FAxonActionResult FAxonRetargetSettingsActions::HandleSetRetargetChainSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("'chain_name' (target chain) is required"));
	}
	...
	if (!bAnyApplied)
	{
		...
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Target chain '%s' not found in the FK Chains op"), *ChainName));
		}
		if (bWantsIK && !bIKChainFound && !bWantsFK)
		{
			return FAxonActionResult::Error(FString::Printf(TEXT("Target chain '%s' not found in the IK Chains op"), *ChainName));
		}
		...
		return FAxonActionResult::Error(FString::Printf(TEXT("Target chain '%s' not found in the targeted op(s)"), *ChainName));
	}
...
FAxonActionResult FAxonRetargetSettingsActions::HandleSetRetargetRootSettings(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
...
FAxonActionResult FAxonRetargetSettingsActions::HandleEnableFootGroundLock(const TSharedPtr<FJsonObject>& Params)
{
	const FString AssetPath = Params->GetStringField(TEXT("retargeter_path"));
	...
	{
		return FAxonActionResult::Error(TEXT("No valid chain entries found in 'chains' (each needs a non-empty target_chain)"));
	}
...
void FAxonRetargetSettingsActions::RegisterActions(FAxonToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("align_retarget_pose"),
		...
		FAxonActionHandler::CreateStatic(&HandleAlignRetargetPose),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_retarget_pose"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetRetargetPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_pose"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetRetargetPose),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
			.Optional(TEXT("side"), TEXT("string"), TEXT("'source' or 'target' (default 'target')"), TEXT("target"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_retarget_chain_settings"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetRetargetChainSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_chain_settings"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetRetargetChainSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_retarget_root_settings"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetRetargetRootSettings),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("enable_foot_ground_lock"),
		...
		FAxonActionHandler::CreateStatic(&HandleEnableFootGroundLock),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("retargeter_path"), TEXT("IK Retargeter (UIKRetargeter) asset path"))

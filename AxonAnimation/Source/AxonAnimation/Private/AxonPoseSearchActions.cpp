...
static FAxonActionResult HandleSetDatabaseNormalizationSet(const TSharedPtr<FJsonObject>& Params);
// Task 1.4 — add_database_entry (file-local, no header edit)
static FAxonActionResult HandleAddDatabaseEntry(const TSharedPtr<FJsonObject>& Params);
// Task 2.3 — configure_schema_channel (file-local, no header edit)
static FAxonActionResult HandleConfigureSchemaChannel(const TSharedPtr<FJsonObject>& Params);
// Task 2.4 — add_pose_search_notify (file-local, no header edit)
static FAxonActionResult HandleAddPoseSearchNotify(const TSharedPtr<FJsonObject>& Params);
// Task 2.5 — derive_schema_channels_from_skeleton (file-local, no header edit)
static FAxonActionResult HandleDeriveSchemaChannelsFromSkeleton(const TSharedPtr<FJsonObject>& Params);
// Task 2.6 — validate_pose_search_database (file-local, no header edit)
static FAxonActionResult HandleValidatePoseSearchDatabase(const TSharedPtr<FJsonObject>& Params);

// ---------------------------------------------------------------------------
// Registration
// ---------------------------------------------------------------------------

void FAxonPoseSearchActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("animation"), TEXT("get_pose_search_schema"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetPoseSearchSchema),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_pose_search_database"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetPoseSearchDatabase),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_database_sequence"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddDatabaseSequence),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_database_sequence"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveDatabaseSequence),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("get_database_stats"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetDatabaseStats),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_pose_search_schema"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreatePoseSearchSchema),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_pose_search_database"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreatePoseSearchDatabase),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_sequence_properties"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDatabaseSequenceProperties),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_schema_channel"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddSchemaChannel),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchSchema asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("remove_schema_channel"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveSchemaChannel),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchSchema asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_channel_weight"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetChannelWeight),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchSchema asset path"))
			.Required(TEXT("channel_index"), TEXT("integer"), TEXT("Index into the authored Channels array"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("rebuild_pose_search_index"),
		...
		FAxonActionHandler::CreateStatic(&HandleRebuildPoseSearchIndex),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_search_mode"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDatabaseSearchMode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("create_normalization_set"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateNormalizationSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_database_to_normalization_set"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddDatabaseToNormalizationSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_normalization_set"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDatabaseNormalizationSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_database_entry"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddDatabaseEntry),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("database_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("set_database_entry_tags"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDatabaseEntryTags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("database_path"), TEXT("PoseSearchDatabase asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("configure_schema_channel"),
		...
		FAxonActionHandler::CreateStatic(&HandleConfigureSchemaChannel),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("add_pose_search_notify"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddPoseSearchNotify),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("derive_schema_channels_from_skeleton"),
		...
		FAxonActionHandler::CreateStatic(&HandleDeriveSchemaChannelsFromSkeleton),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("schema_path"), TEXT("PoseSearchSchema asset path"))
	...
	Registry.RegisterAction(TEXT("animation"), TEXT("validate_pose_search_database"),
		...
		FAxonActionHandler::CreateStatic(&HandleValidatePoseSearchDatabase),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("database_path"), TEXT("PoseSearchDatabase asset path"))
			.Build());
}
...
FAxonActionResult FAxonPoseSearchActions::HandleGetPoseSearchSchema(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UPoseSearchSchema* Schema = FAxonAssetUtils::LoadAssetByPath<UPoseSearchSchema>(AssetPath);
	if (!Schema)
		return FAxonActionResult::Error(FString::Printf(TEXT("PoseSearchSchema not found: %s"), *AssetPath));
...
FAxonActionResult FAxonPoseSearchActions::HandleGetPoseSearchDatabase(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));

	UPoseSearchDatabase* Database = FAxonAssetUtils::LoadAssetByPath<UPoseSearchDatabase>(AssetPath);
	if (!Database)
		return FAxonActionResult::Error(FString::Printf(TEXT("PoseSearchDatabase not found: %s"), *AssetPath));
...
FAxonActionResult FAxonPoseSearchActions::HandleAddDatabaseSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	UObject* AnimAsset = FAxonAssetUtils::LoadAssetByPath<UObject>(AnimPath);
	if (!AnimAsset)
		return FAxonActionResult::Error(FString::Printf(TEXT("Animation asset not found: %s"), *AnimPath));

	// Check if already in database
	if (Database->Contains(AnimAsset))
		return FAxonActionResult::Error(FString::Printf(TEXT("Animation already in database: %s"), *AnimPath));
...
FAxonActionResult FAxonPoseSearchActions::HandleRemoveDatabaseSequence(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (SequenceIndex < 0 || SequenceIndex >= NumAssets)
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid sequence index: %d (database has %d entries)"), SequenceIndex, NumAssets));
...
FAxonActionResult FAxonPoseSearchActions::HandleGetDatabaseStats(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonPoseSearchActions::HandleCreatePoseSearchSchema(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Schema) return FAxonActionResult::Error(TEXT("Failed to create UPoseSearchSchema object"));
...
FAxonActionResult FAxonPoseSearchActions::HandleCreatePoseSearchDatabase(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	FString SchemaPath = Params->GetStringField(TEXT("schema_path"));

	UPoseSearchSchema* Schema = FAxonAssetUtils::LoadAssetByPath<UPoseSearchSchema>(SchemaPath);
	if (!Schema) return FAxonActionResult::Error(FString::Printf(TEXT("PoseSearchSchema not found: %s"), *SchemaPath));
	...
	if (!Database) return FAxonActionResult::Error(TEXT("Failed to create UPoseSearchDatabase object"));
...
FAxonActionResult FAxonPoseSearchActions::HandleSetDatabaseSequenceProperties(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAxonActionResult FAxonPoseSearchActions::HandleAddSchemaChannel(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!ChannelClass)
		return FAxonActionResult::Error(FString::Printf(TEXT("Unknown channel type: '%s'. Supported: Position, Velocity, Heading, Pose, Trajectory, Phase, Distance, Curve, Group"), *ChannelType));
	...
	{
		GEditor->EndTransaction();
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create channel of type %s"), *ChannelType));
	}
...
FAxonActionResult FAxonPoseSearchActions::HandleRemoveSchemaChannel(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Channels)
		return FAxonActionResult::Error(TEXT("Failed to access Channels property on schema via reflection"));

	if (ChannelIndex < 0 || ChannelIndex >= Channels->Num())
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid channel_index %d (schema has %d authored channels)"), ChannelIndex, Channels->Num()));
...
FAxonActionResult FAxonPoseSearchActions::HandleSetChannelWeight(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	int32 ChannelIndex = static_cast<int32>(Params->GetNumberField(TEXT("channel_index")));
	...
	if (!Channel)
		return FAxonActionResult::Error(FString::Printf(TEXT("Channel at index %d is null"), ChannelIndex));

	// Weight is WITH_EDITORONLY_DATA — use reflection to set it on any channel type
#if WITH_EDITORONLY_DATA
	FProperty* WeightProp = Channel->GetClass()->FindPropertyByName(TEXT("Weight"));
	if (!WeightProp)
		return FAxonActionResult::Error(FString::Printf(TEXT("Channel class %s has no Weight property"), *Channel->GetClass()->GetName()));
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("Channel weights are only available in editor builds (WITH_EDITORONLY_DATA)"));
#endif
}
...
FAxonActionResult FAxonPoseSearchActions::HandleRebuildPoseSearchIndex(const TSharedPtr<FJsonObject>& Params)
{
#if WITH_EDITOR
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("rebuild_pose_search_index is only available in editor builds"));
#endif
}
...
FAxonActionResult FAxonPoseSearchActions::HandleSetDatabaseSearchMode(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (Params->HasField(TEXT("pose_search_mode")))
	{
		...
		{
			GEditor->EndTransaction();
			return FAxonActionResult::Error(FString::Printf(TEXT("Invalid pose_search_mode: '%s'. Use BruteForce, PCAKDTree, VPTree, or EventOnly"), *ModeStr));
		}
	}
...
FAxonActionResult FAxonPoseSearchActions::HandleCreateNormalizationSet(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
	...
	if (!Set) return FAxonActionResult::Error(TEXT("Failed to create UPoseSearchNormalizationSet object"));
...
FAxonActionResult FAxonPoseSearchActions::HandleAddDatabaseToNormalizationSet(const TSharedPtr<FJsonObject>& Params)
{
	FString SetPath = Params->GetStringField(TEXT("set_path"));
	FString DatabasePath = Params->GetStringField(TEXT("database_path"));

	UPoseSearchNormalizationSet* Set = FAxonAssetUtils::LoadAssetByPath<UPoseSearchNormalizationSet>(SetPath);
	if (!Set)
		return FAxonActionResult::Error(FString::Printf(TEXT("PoseSearchNormalizationSet not found: %s"), *SetPath));

	UPoseSearchDatabase* Database = FAxonAssetUtils::LoadAssetByPath<UPoseSearchDatabase>(DatabasePath);
	if (!Database)
		return FAxonActionResult::Error(FString::Printf(TEXT("PoseSearchDatabase not found: %s"), *DatabasePath));
...
FAxonActionResult FAxonPoseSearchActions::HandleSetDatabaseEntryTags(const TSharedPtr<FJsonObject>& Params)
{
	FString DatabasePath = Params->GetStringField(TEXT("database_path"));
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("set_database_entry_tags requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}
...
static FAxonActionResult HandleSetDatabaseNormalizationSet(const TSharedPtr<FJsonObject>& Params)
{
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("set_database_normalization_set requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}
...
static FAxonActionResult HandleConfigureSchemaChannel(const TSharedPtr<FJsonObject>& Params)
{
	...
	UPoseSearchSchema* Schema = FAxonAssetUtils::LoadAssetByPath<UPoseSearchSchema>(SchemaPath);
	if (!Schema)
		return FAxonActionResult::Error(FString::Printf(TEXT("PoseSearchSchema not found: %s"), *SchemaPath));
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("configure_schema_channel requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}
...
static FAxonActionResult HandleAddPoseSearchNotify(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (StartTime < 0.f || StartTime > Seq->GetPlayLength())
		return FAxonActionResult::Error(FString::Printf(TEXT("start_time %.3f out of range [0, %.3f]"), StartTime, Seq->GetPlayLength()));
	if (Duration <= 0.f)
		return FAxonActionResult::Error(TEXT("duration must be > 0"));
	if (StartTime + Duration > Seq->GetPlayLength())
		return FAxonActionResult::Error(FString::Printf(TEXT("start_time + duration (%.3f) exceeds play length (%.3f)"), StartTime + Duration, Seq->GetPlayLength()));
	...
	if (!NewNotify)
		return FAxonActionResult::Error(TEXT("Failed to create PoseSearch notify-state instance"));
...
static FAxonActionResult HandleDeriveSchemaChannelsFromSkeleton(const TSharedPtr<FJsonObject>& Params)
{
	...
	USkeleton* Skeleton = FAxonAssetUtils::LoadAssetByPath<USkeleton>(SkeletonPath);
	if (!Skeleton)
		return FAxonActionResult::Error(FString::Printf(TEXT("Skeleton not found: %s"), *SkeletonPath));
	...
	return FAxonActionResult::Success(Root);
#else
	return FAxonActionResult::Error(TEXT("derive_schema_channels_from_skeleton requires editor-only data (WITH_EDITORONLY_DATA)"));
#endif
}

 ...
 * proven set_cdo_property scalar path), reads via FAxonReflectionReader.
 *
 ...
 */
class FAxonSkeletonRetargetActions
{
public:
	...
	static FAxonActionResult HandleSetBoneTranslationRetargeting(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetBoneTranslationRetargeting(const TSharedPtr<FJsonObject>& Params);

	// --- T2-1: IK-Rig per-solver per-bone settings ---
	static FAxonActionResult HandleSetIkRigBoneSettings(const TSharedPtr<FJsonObject>& Params);
	static FAxonActionResult HandleGetIkRigBoneSettings(const TSharedPtr<FJsonObject>& Params);

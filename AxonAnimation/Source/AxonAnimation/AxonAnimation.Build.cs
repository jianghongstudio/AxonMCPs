...
public class AxonAnimation : ModuleRules
{
	...
	public AxonAnimation(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		//
		// Release builds: AXON_RELEASE_BUILD=1 still forces this OFF so binary releases

...
// LogAxonGAS defined in AxonGASModule.cpp
...
/** Load a GE Blueprint from Params (wraps AxonGAS::LoadGameplayEffectBP). */
bool LoadGEFromParams(
	const TSharedPtr<FJsonObject>& Params,
	UBlueprint*& OutBP,
	UGameplayEffect*& OutGE,
	FString& OutAssetPath,
	FAxonActionResult& OutError)
{
	FString Error;
	OutAssetPath = Params->GetStringField(TEXT("asset_path"));
	if (OutAssetPath.IsEmpty())
	{
		OutError = FAxonActionResult::Error(TEXT("Missing required parameter: asset_path"));
		return false;
	}
	if (!AxonGAS::LoadGameplayEffectBP(OutAssetPath, OutBP, OutGE, Error))
	{
		OutError = FAxonActionResult::Error(Error);
		return false;
	}
	return true;
}
...
TSharedPtr<FJsonObject> GEComponentToJson(const UGameplayEffectComponent* Comp)
{
	...
	if (const UAssetTagsGameplayEffectComponent* AssetTags = Cast<UAssetTagsGameplayEffectComponent>(Comp))
	{
		...
		Obj->SetField(TEXT("tags"), AxonGAS::TagContainerToJson(AssetTags->GetConfiguredAssetTagChanges().Added));
	}
	else if (const UTargetTagsGameplayEffectComponent* TargetTags = Cast<UTargetTagsGameplayEffectComponent>(Comp))
	{
		...
		Obj->SetField(TEXT("tags"), AxonGAS::TagContainerToJson(TargetTags->GetConfiguredTargetTagChanges().Added));
	}
	else if (const UBlockAbilityTagsGameplayEffectComponent* BlockTags = Cast<UBlockAbilityTagsGameplayEffectComponent>(Comp))
	{
		...
		Obj->SetField(TEXT("tags"), AxonGAS::TagContainerToJson(BlockTags->GetConfiguredBlockedAbilityTagChanges().Added));
	}
	else if (const UTargetTagRequirementsGameplayEffectComponent* TagReqs = Cast<UTargetTagRequirementsGameplayEffectComponent>(Comp))
	{
		...
		Config->SetField(TEXT("application_require_tags"), AxonGAS::TagContainerToJson(TagReqs->ApplicationTagRequirements.RequireTags));
		Config->SetField(TEXT("application_ignore_tags"), AxonGAS::TagContainerToJson(TagReqs->ApplicationTagRequirements.IgnoreTags));
		Config->SetField(TEXT("ongoing_require_tags"), AxonGAS::TagContainerToJson(TagReqs->OngoingTagRequirements.RequireTags));
		Config->SetField(TEXT("ongoing_ignore_tags"), AxonGAS::TagContainerToJson(TagReqs->OngoingTagRequirements.IgnoreTags));
		Config->SetField(TEXT("removal_require_tags"), AxonGAS::TagContainerToJson(TagReqs->RemovalTagRequirements.RequireTags));
		Config->SetField(TEXT("removal_ignore_tags"), AxonGAS::TagContainerToJson(TagReqs->RemovalTagRequirements.IgnoreTags));
...
void FAxonGASEffectActions::RegisterActions(FAxonToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_gameplay_effect"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_gameplay_effect"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_gameplay_effects"),
		...
		FAxonActionHandler::CreateStatic(&HandleListGameplayEffects),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_modifier"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_modifier"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_modifier"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveModifier),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_modifiers"),
		...
		FAxonActionHandler::CreateStatic(&HandleListModifiers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_ge_component"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddGEComponent),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ge_component"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetGEComponent),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_effect_stacking"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetEffectStacking),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_duration"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDuration),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_period"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetPeriod),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_effect_from_template"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateEffectFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("build_effect_from_spec"),
		...
		FAxonActionHandler::CreateStatic(&HandleBuildEffectFromSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset path for the new GE Blueprint"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("batch_create_effects"),
		...
		FAxonActionHandler::CreateStatic(&HandleBatchCreateEffects),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_execution"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddExecution),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("duplicate_gameplay_effect"),
		...
		FAxonActionHandler::CreateStatic(&HandleDuplicateGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("delete_gameplay_effect"),
		...
		FAxonActionHandler::CreateStatic(&HandleDeleteGameplayEffect),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_effect"),
		...
		FAxonActionHandler::CreateStatic(&HandleValidateEffect),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_effect_interaction_matrix"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetEffectInteractionMatrix),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_ge_component"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveGEComponent),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayEffect Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_active_effects"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetActiveEffects),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_effect_modifiers_breakdown"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetEffectModifiersBreakdown),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
			.Required(TEXT("attribute"), TEXT("string"), TEXT("Attribute as ClassName.PropertyName"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("apply_effect"),
		...
		FAxonActionHandler::CreateStatic(&HandleApplyEffect),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_effect"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveEffect),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("simulate_effect_stack"),
		...
		FAxonActionHandler::CreateStatic(&HandleSimulateEffectStack),
		FParamSchemaBuilder()
...
FAxonActionResult FAxonGASEffectActions::HandleCreateGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;

	FString DurationStr;
	if (!AxonGAS::RequireStringParam(Params, TEXT("duration_policy"), DurationStr, Err)) return Err;

	EGameplayEffectDurationType DurationPolicy;
	FString ParseError;
	if (!ParseDurationPolicy(DurationStr, DurationPolicy, ParseError))
	{
		return FAxonActionResult::Error(ParseError);
	}
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Invalid save_path: %s"), *SavePath));
	}
	FString AssetName = SavePath.Mid(LastSlash + 1);
	if (AssetName.IsEmpty())
	{
		return FAxonActionResult::Error(TEXT("save_path must not end with '/'"));
	}

	// Check for existing asset (AssetRegistry + in-memory multi-tier check)
	FString ExistError;
	if (!AxonGAS::EnsureAssetPathFree(SavePath, AssetName, ExistError))
	{
		return FAxonActionResult::Error(ExistError);
	}
	...
	if (!Package)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create package: %s"), *SavePath));
	}
	Package->FullyLoad();
	...
	if (!NewBP)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create GE Blueprint at: %s"), *SavePath));
	}

	// Set DurationPolicy on CDO
	UGameplayEffect* GE_CDO = AxonGAS::GetBlueprintCDO<UGameplayEffect>(NewBP);
	if (GE_CDO)
	{
...
FAxonActionResult FAxonGASEffectActions::HandleGetGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	...
	// Gameplay Cues
	{
		...
		for (const FGameplayEffectCue& Cue : GE->GameplayCues)
		{
			...
			CueObj->SetField(TEXT("tags"), AxonGAS::TagContainerToJson(Cue.GameplayCueTags));
...
FAxonActionResult FAxonGASEffectActions::HandleListGameplayEffects(const TSharedPtr<FJsonObject>& Params)
{
	...
	for (const FAssetData& Asset : Assets)
	{
		...
		if (!BP || !AxonGAS::IsGameplayEffectBlueprint(BP))
		{
			continue;
		}

		UGameplayEffect* GE = AxonGAS::GetBlueprintCDO<UGameplayEffect>(BP);
		if (!GE)
		{
			continue;
		}
...
FAxonActionResult FAxonGASEffectActions::HandleAddModifier(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	// Parse attribute
	FString AttrStr;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute"), AttrStr, Err)) return Err;

	FString AttrError;
	FGameplayAttribute Attr = ParseAttribute(AttrStr, AttrError);
	if (!AttrError.IsEmpty())
	{
		return FAxonActionResult::Error(AttrError);
	}

	// Parse operation
	FString OpStr;
	if (!AxonGAS::RequireStringParam(Params, TEXT("operation"), OpStr, Err)) return Err;

	EGameplayModOp::Type Op;
	FString OpError;
	if (!ParseModifierOp(OpStr, Op, OpError))
	{
		return FAxonActionResult::Error(OpError);
	}
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: magnitude (object)"));
	}
	...
	{
		return FAxonActionResult::Error(MagError);
	}
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(AssetPath,
...
FAxonActionResult FAxonGASEffectActions::HandleSetModifier(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: modifier_index"));
	}
...
FAxonActionResult FAxonGASEffectActions::HandleRemoveModifier(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	{
		return FAxonActionResult::Error(TEXT("Either modifier_index or attribute must be specified"));
	}
...
FAxonActionResult FAxonGASEffectActions::HandleListModifiers(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
...
FAxonActionResult FAxonGASEffectActions::HandleAddGEComponent(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("component_type"), ComponentType, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: config (object)"));
	}
	...
	if (!NewComp)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to create component of type: %s"), *ComponentType));
	}
	...
	else if (ComponentType == TEXT("target_tag_requirements"))
	{
		...
		Comp->ApplicationTagRequirements.RequireTags = AxonGAS::ParseTagContainer(Config, TEXT("application_require_tags"), SkippedAppRequire);
		Comp->ApplicationTagRequirements.IgnoreTags  = AxonGAS::ParseTagContainer(Config, TEXT("application_ignore_tags"),  SkippedAppIgnore);

		// Ongoing requirements
		Comp->OngoingTagRequirements.RequireTags     = AxonGAS::ParseTagContainer(Config, TEXT("ongoing_require_tags"),     SkippedOngoingRequire);
		Comp->OngoingTagRequirements.IgnoreTags      = AxonGAS::ParseTagContainer(Config, TEXT("ongoing_ignore_tags"),      SkippedOngoingIgnore);

		// Removal requirements
		Comp->RemovalTagRequirements.RequireTags     = AxonGAS::ParseTagContainer(Config, TEXT("removal_require_tags"),     SkippedRemovalRequire);
		Comp->RemovalTagRequirements.IgnoreTags      = AxonGAS::ParseTagContainer(Config, TEXT("removal_ignore_tags"),      SkippedRemovalIgnore);
	}
...
FAxonActionResult FAxonGASEffectActions::HandleSetGEComponent(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
...
FAxonActionResult FAxonGASEffectActions::HandleSetEffectStacking(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("stacking_type"), StackTypeStr, Err)) return Err;
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(AssetPath, TEXT("Stacking configuration updated"));
...
FAxonActionResult FAxonGASEffectActions::HandleSetDuration(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(AssetPath, TEXT("Duration updated"));
	Result->SetStringField(TEXT("duration_policy"), DurationPolicyToString(DurationPolicy));
	if (DurationPolicy == EGameplayEffectDurationType::HasDuration && Params->HasField(TEXT("duration_magnitude")))
	{
...
FAxonActionResult FAxonGASEffectActions::HandleSetPeriod(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: period"));
	}
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(AssetPath, TEXT("Period updated"));
...
namespace
{
	...
	UBlueprint* CreateGEBlueprint(const FString& SavePath, EGameplayEffectDurationType DurationPolicy,
		UGameplayEffect*& OutGE, FAxonActionResult& OutError)
	{
		int32 LastSlash;
		if (!SavePath.FindLastChar(TEXT('/'), LastSlash))
		{
			OutError = FAxonActionResult::Error(FString::Printf(TEXT("Invalid save_path: %s"), *SavePath));
			return nullptr;
		}
		FString AssetName = SavePath.Mid(LastSlash + 1);
		if (AssetName.IsEmpty())
		{
			OutError = FAxonActionResult::Error(TEXT("save_path must not end with '/'"));
			return nullptr;
		}
		...
		if (!AxonGAS::EnsureAssetPathFree(SavePath, AssetName, ExistError))
		{
			OutError = FAxonActionResult::Error(ExistError);
			return nullptr;
		}
		...
		if (!Package)
		{
			OutError = FAxonActionResult::Error(FString::Printf(TEXT("Failed to create package: %s"), *SavePath));
			return nullptr;
		}
		Package->FullyLoad();
		...
		if (!NewBP)
		{
			OutError = FAxonActionResult::Error(FString::Printf(TEXT("Failed to create GE Blueprint at: %s"), *SavePath));
			return nullptr;
		}

		OutGE = AxonGAS::GetBlueprintCDO<UGameplayEffect>(NewBP);
		if (OutGE)
		{
...
FAxonActionResult FAxonGASEffectActions::HandleCreateEffectFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath, TemplateName;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("template"), TemplateName, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TemplateError);
	}
	...
	if (Params->TryGetObjectField(TEXT("overrides"), OverridesPtr) && OverridesPtr && (*OverridesPtr).IsValid())
	{
		...
		{
			TArray<FString> ExtraAssetTags = AxonGAS::ParseStringArray(*TagsPtr, TEXT("asset_tags"));
			Def.AssetTags.Append(ExtraAssetTags);
			TArray<FString> ExtraTargetTags = AxonGAS::ParseStringArray(*TagsPtr, TEXT("target_tags"));
...
FAxonActionResult FAxonGASEffectActions::HandleBuildEffectFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: spec (object)"));
	}
	...
	{
		return FAxonActionResult::Error(TEXT("spec.duration_policy is required"));
	}
	...
	TArray<FString> AssetTags = AxonGAS::ParseStringArray(Spec, TEXT("asset_tags"));
	if (AssetTags.Num() > 0) AddAssetTagsComponent(GE, AssetTags);

	TArray<FString> TargetTags = AxonGAS::ParseStringArray(Spec, TEXT("target_tags"));
...
FAxonActionResult FAxonGASEffectActions::HandleBatchCreateEffects(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required parameter: effects (array)"));
	}
...
FAxonActionResult FAxonGASEffectActions::HandleAddExecution(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("calculation_class"), CalcClassPath, Err)) return Err;
...
FAxonActionResult FAxonGASEffectActions::HandleDuplicateGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString SourcePath, DestPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("source_path"), SourcePath, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("dest_path"), DestPath, Err)) return Err;
...
FAxonActionResult FAxonGASEffectActions::HandleDeleteGameplayEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("asset_path"), AssetPath, Err)) return Err;
...
FAxonActionResult FAxonGASEffectActions::HandleValidateEffect(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
...
FAxonActionResult FAxonGASEffectActions::HandleGetEffectInteractionMatrix(const TSharedPtr<FJsonObject>& Params)
{
	...
	else
	{
		...
		for (const FAssetData& Asset : AllBlueprints)
		{
			...
			UBlueprint* BP = Cast<UBlueprint>(Asset.GetAsset());
			if (!BP || !AxonGAS::IsGameplayEffectBlueprint(BP)) continue;
		...
		for (const UGameplayEffectComponent* Comp : Components)
		{
			...
			if (const UBlockAbilityTagsGameplayEffectComponent* BlockComp = Cast<UBlockAbilityTagsGameplayEffectComponent>(Comp))
			{
				...
				if (BlockTags.Added.Num() > 0)
				{
					...
					Interaction->SetField(TEXT("blocked_tags"), AxonGAS::TagContainerToJson(BlockTags.Added));
					Interactions.Add(MakeShared<FJsonValueObject>(Interaction));
				}
			}
		}
...
FAxonActionResult FAxonGASEffectActions::HandleRemoveGEComponent(const TSharedPtr<FJsonObject>& Params)
{
	UBlueprint* BP = nullptr;
	UGameplayEffect* GE = nullptr;
	FString AssetPath;
	...
	FString TypeStr;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("component_type"), TypeStr, Err)) return Err;
	...
	if (!GEComponentsProp)
	{
		return FAxonActionResult::Error(TEXT("Failed to find GEComponents property via reflection"));
	}

	FArrayProperty* ArrayProp = CastField<FArrayProperty>(GEComponentsProp);
	if (!ArrayProp)
	{
		return FAxonActionResult::Error(TEXT("GEComponents is not an array property"));
	}
	...
	if (!bRemoved)
	{
		return FAxonActionResult::Error(TEXT("Failed to remove component from GEComponents array"));
	}
...
FAxonActionResult FAxonGASEffectActions::HandleGetActiveEffects(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	...
	UWorld* PIEWorld = AxonGAS::GetPIEWorld();
	if (!PIEWorld)
	{
		return FAxonActionResult::Error(TEXT("No PIE world found. Start Play In Editor first."));
	}

	AActor* Actor = AxonGAS::FindActorInPIE(ActorId);
	if (!Actor)
	{
		return FAxonActionResult::Error(
	...
	UAbilitySystemComponent* ASC = AxonGAS::GetASCFromActor(Actor);
	if (!ASC)
	{
		return FAxonActionResult::Error(
...
FAxonActionResult FAxonGASEffectActions::HandleGetEffectModifiersBreakdown(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonGASEffectActions::HandleApplyEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId, EffectClassId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("effect_class"), EffectClassId, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Failed to create GameplayEffect spec"));
	}
	...
	{
		return FAxonActionResult::Error(TEXT("Failed to apply GameplayEffect (may have been blocked by tag requirements or immunity)"));
	}
...
FAxonActionResult FAxonGASEffectActions::HandleRemoveEffect(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Must provide either 'effect_handle' (int) or 'effect_class' (string)"));
	}
...
FAxonActionResult FAxonGASEffectActions::HandleSimulateEffectStack(const TSharedPtr<FJsonObject>& Params)
{
	const TSharedPtr<FJsonObject>* StateObj;
	if (!Params->TryGetObjectField(TEXT("attribute_state"), StateObj) || !StateObj || !(*StateObj).IsValid())
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: attribute_state (object with base_value)"));
	}

	double BaseValue = 0.0;
	if (!(*StateObj)->TryGetNumberField(TEXT("base_value"), BaseValue))
	{
		return FAxonActionResult::Error(TEXT("attribute_state must contain 'base_value' (number)"));
	}

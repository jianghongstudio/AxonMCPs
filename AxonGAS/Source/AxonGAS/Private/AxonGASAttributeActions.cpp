...
void FAxonGASAttributeActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("gas"), TEXT("create_attribute_set"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateAttributeSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_attribute"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddAttribute),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_attribute_set"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAttributeSet),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_attribute_defaults"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAttributeDefaults),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_attribute_sets"),
		...
		FAxonActionHandler::CreateStatic(&HandleListAttributeSets),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("configure_attribute_clamping"),
		...
		FAxonActionHandler::CreateStatic(&HandleConfigureAttributeClamping),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("configure_meta_attributes"),
		...
		FAxonActionHandler::CreateStatic(&HandleConfigureMetaAttributes),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_attribute_set_from_template"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateAttributeSetFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_attribute_init_datatable"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateAttributeInitDataTable),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("duplicate_attribute_set"),
		...
		FAxonActionHandler::CreateStatic(&HandleDuplicateAttributeSet),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("configure_attribute_replication"),
		...
		FAxonActionHandler::CreateStatic(&HandleConfigureAttributeReplication),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("link_datatable_to_asc"),
		...
		FAxonActionHandler::CreateStatic(&HandleLinkDataTableToASC),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("bulk_edit_attributes"),
		...
		FAxonActionHandler::CreateStatic(&HandleBulkEditAttributes),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_attribute_set"),
		...
		FAxonActionHandler::CreateStatic(&HandleValidateAttributeSet),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("find_attribute_modifiers"),
		...
		FAxonActionHandler::CreateStatic(&HandleFindAttributeModifiers),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("diff_attribute_sets"),
		...
		FAxonActionHandler::CreateStatic(&HandleDiffAttributeSets),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_attribute_dependency_graph"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAttributeDependencyGraph),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("remove_attribute"),
		...
		FAxonActionHandler::CreateStatic(&HandleRemoveAttribute),
		FParamSchemaBuilder()
			.Required(TEXT("attribute_set"), TEXT("string"), TEXT("Asset path for Blueprint sets, or class name for C++ sets"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_attribute_value"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAttributeValue),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_attribute_value"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAttributeValue),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in the PIE world"))
			.Required(TEXT("attribute"), TEXT("string"), TEXT("Attribute as ClassName.PropertyName"))
...
namespace
{
	...
	// GetProjectSourceDir() moved to AxonGAS::GetProjectSourceDir() in AxonGASInternal.cpp
		...
		const TArray<TSharedPtr<FJsonValue>>& Attributes)
	{
		...
		FString Header;
		Header += TEXT("// Auto-generated by Axon GAS tools\n");
	...
	{
		FString Source;
		Source += TEXT("// Auto-generated by Axon GAS tools\n");
	...
	UBlueprint* LoadAttributeSetBlueprint(const FString& AssetPath, FString& OutError)
	{
		...
		BP = AxonGAS::LoadBlueprintFromParams(TempParams, Unused, OutError);
		if (!BP)
		{
			return nullptr;
		}
		if (!AxonGAS::IsAttributeSetBlueprint(BP))
		{
...
FAxonActionResult FAxonGASAttributeActions::HandleCreateAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FAxonActionResult::Error(TEXT("mode must be 'cpp' or 'blueprint'"));
	}
	...
	if (Mode == TEXT("blueprint"))
	{
		...
		FString Error;
		UPackage* Package = AxonGAS::GetOrCreatePackage(SavePath, Error);
		if (!Package)
		{
		...
		if (!Blueprint)
		{
			return FAxonActionResult::Error(TEXT("Failed to create GBA AttributeSet Blueprint"));
		}
	...
	FString SourceDir = AxonGAS::GetProjectSourceDir();
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to write header: %s"), *HeaderPath));
	}

	if (!FFileHelper::SaveStringToFile(SourceContent, *SourcePath, FFileHelper::EEncodingOptions::ForceUTF8WithoutBOM))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to write source: %s"), *SourcePath));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleAddAttribute(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet, AttrName;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("name"), AttrName, Err)) return Err;
	...
	if (LooksLikeBlueprintPath(AttrSet))
	{
		...
		TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(AttrSet,
	...
	{
		return FAxonActionResult::Error(TEXT("Could not find class closing brace in header file"));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleGetAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	if (!SetClass)
	{
		return FAxonActionResult::Error(TEXT("Could not resolve AttributeSet class"));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleSetAttributeDefaults(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: defaults (object mapping attribute_name to value)"));
	}
	...
	if (LooksLikeBlueprintPath(AttrSet))
	{
		...
		if (!SetClass)
		{
			return FAxonActionResult::Error(TEXT("Blueprint has no generated class — compile it first"));
		}

		UAttributeSet* CDO = Cast<UAttributeSet>(SetClass->GetDefaultObject());
		if (!CDO)
		{
			return FAxonActionResult::Error(TEXT("Could not get CDO for AttributeSet"));
		}
		...
		for (const auto& Pair : (*DefaultsObj)->Values)
		{
			...
			// Find the property
			FProperty* Prop = FindAttributeProperty(SetClass, AxonKeyToString(Pair.Key));
			FStructProperty* StructProp = CastField<FStructProperty>(Prop);
			if (!StructProp || !StructProp->Struct || !StructProp->Struct->IsChildOf(AttrDataStruct))
			{
				NotFound.Add(AxonKeyToString(Pair.Key));
				continue;
			}
	...
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to write source: %s"), *SourceFilePath));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleListAttributeSets(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonGASAttributeActions::HandleConfigureAttributeClamping(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: clamp_rules (array)"));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleConfigureMetaAttributes(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: meta_attributes (array)"));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleCreateAttributeSetFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (Params->TryGetObjectField(TEXT("overrides"), OverridesPtr) && OverridesPtr && (*OverridesPtr).IsValid())
	{
		...
		// Remove attributes
		TArray<FString> RemoveList = AxonGAS::ParseStringArray(Overrides, TEXT("remove_attributes"));
		if (RemoveList.Num() > 0)
		{
	...
	FAxonActionResult Result = HandleCreateAttributeSet(CreateParams);
...
FAxonActionResult FAxonGASAttributeActions::HandleCreateAttributeInitDataTable(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!SetClass)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("AttributeSet not found: %s"), *AttrSet));
	}
	...
	if (AttrProps.Num() == 0)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("No FGameplayAttributeData properties found on %s"), *SetClassName));
	}
	...
	if (!RowStruct)
	{
		return FAxonActionResult::Error(TEXT("Could not find FAttributeMetaData struct — ensure GameplayAbilities module is loaded"));
	}
	...
	if (!DataTable)
	{
		return FAxonActionResult::Error(TEXT("Failed to create DataTable"));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleDuplicateAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	FString Source, SavePath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("source"), Source, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err)) return Err;
	...
	if (bSourceIsBP)
	{
		...
		if (!BP) return FAxonActionResult::Error(Error);
	...
	if (!SourceClass)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Source AttributeSet not found: %s"), *Source));
	}
	...
	TArray<FString> RemoveList = AxonGAS::ParseStringArray(Params, TEXT("remove_attributes"));
	if (RemoveList.Num() > 0)
	{
...
FAxonActionResult FAxonGASAttributeActions::HandleConfigureAttributeReplication(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSet;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSet, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required parameter: replication (array)"));
	}
	...
	if (!FFileHelper::LoadFileToString(HeaderContent, *HeaderPath))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Could not find header: %s"), *HeaderPath));
	}

	FString SourceContent;
	if (!FFileHelper::LoadFileToString(SourceContent, *SourceFilePath))
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Could not find source: %s"), *SourceFilePath));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleLinkDataTableToASC(const TSharedPtr<FJsonObject>& Params)
{
	FString ASCBlueprintPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("asc_blueprint"), ASCBlueprintPath, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required parameter: entries (array of {attribute_set_class, datatable_path})"));
	}
	...
	if (!ASCNode)
	{
		return FAxonActionResult::Error(TEXT("No AbilitySystemComponent found on this Blueprint"));
	}

	UAbilitySystemComponent* ASCTemplate = Cast<UAbilitySystemComponent>(ASCNode->ComponentTemplate);
	if (!ASCTemplate)
	{
		return FAxonActionResult::Error(TEXT("ASC node has no valid ComponentTemplate"));
	}
	...
	if (!DefaultDataProp)
	{
		return FAxonActionResult::Error(TEXT("Could not find DefaultStartingData property on ASC"));
	}
	...
	for (const auto& EntryVal : *EntriesArray)
	{
		...
		// Validate DataTable
		UDataTable* DT = Cast<UDataTable>(FAxonAssetUtils::LoadAssetByPath(UDataTable::StaticClass(), DTPath));
		if (!DT)
		{
			Warnings.Add(MakeShared<FJsonValueString>(
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(ASCBlueprintPath,
...
FAxonActionResult FAxonGASAttributeActions::HandleBulkEditAttributes(const TSharedPtr<FJsonObject>& Params)
{
	const TArray<TSharedPtr<FJsonValue>>* OpsArray;
	if (!Params->TryGetArrayField(TEXT("operations"), OpsArray) || !OpsArray || OpsArray->Num() == 0)
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required parameter: operations (array)"));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleValidateAttributeSet(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrSetId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("attribute_set"), AttrSetId, Err)) return Err;
...
FAxonActionResult FAxonGASAttributeActions::HandleFindAttributeModifiers(const TSharedPtr<FJsonObject>& Params)
{
	FString AttrStr;
	FAxonActionResult Err;
	...
	for (const FAssetData& Asset : AllBlueprints)
	{
		...
		// Check GE Blueprints
		if (AxonGAS::IsGameplayEffectBlueprint(BP))
		{
...
FAxonActionResult FAxonGASAttributeActions::HandleDiffAttributeSets(const TSharedPtr<FJsonObject>& Params)
{
	FString SetAId, SetBId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("set_a"), SetAId, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("set_b"), SetBId, Err)) return Err;
	...
	if (!ResolveSet(SetAId, ClassA, NameA, ErrorMsg)) return FAxonActionResult::Error(ErrorMsg);
	if (!ResolveSet(SetBId, ClassB, NameB, ErrorMsg)) return FAxonActionResult::Error(ErrorMsg);
...
FAxonActionResult FAxonGASAttributeActions::HandleGetAttributeDependencyGraph(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required parameter: attribute_sets (array)"));
	}
...
FAxonActionResult FAxonGASAttributeActions::HandleRemoveAttribute(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (bCheckRefs)
	{
		...
		for (const FAssetData& Asset : AllBlueprints)
		{
			...
			if (!RefBP || RefBP == BP || !AxonGAS::IsGameplayEffectBlueprint(RefBP)) continue;

			UGameplayEffect* GE = AxonGAS::GetBlueprintCDO<UGameplayEffect>(RefBP);
			if (!GE) continue;
...
// PIE helpers moved to AxonGAS::GetPIEWorld/FindActorInPIE/GetASCFromActor in AxonGASInternal.cpp

// ============================================================
//  Phase 4: get_attribute_value
// ============================================================

FAxonActionResult FAxonGASAttributeActions::HandleGetAttributeValue(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonGASAttributeActions::HandleSetAttributeValue(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId, AttrStr;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: value (number)"));
	}

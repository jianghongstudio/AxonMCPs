...
// LogAxonGAS declared in AxonGASInternal.h, defined in AxonGASModule.cpp

// ---------------------------------------------------------------------------
// Registration
// ---------------------------------------------------------------------------

void FAxonGASASCActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("gas"), TEXT("add_asc_to_actor"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddASCToActor),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("configure_asc"),
		...
		FAxonActionHandler::CreateStatic(&HandleConfigureASC),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("setup_asc_init"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetupASCInit),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("setup_ability_system_interface"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetupAbilitySystemInterface),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("apply_asc_template"),
		...
		FAxonActionHandler::CreateStatic(&HandleApplyASCTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_default_abilities"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDefaultAbilities),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_default_effects"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDefaultEffects),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("actor_path"), TEXT("Blueprint asset path containing the ASC"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_default_attribute_sets"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetDefaultAttributeSets),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("actor_path"), TEXT("Blueprint asset path containing the ASC"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_asc_replication_mode"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetASCReplicationMode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("actor_path"), TEXT("Blueprint asset path containing the ASC"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_asc_setup"),
		...
		FAxonActionHandler::CreateStatic(&HandleValidateASCSetup),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("actor_path"), TEXT("Blueprint asset path for the actor"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("grant_ability"),
		...
		FAxonActionHandler::CreateStatic(&HandleGrantAbility),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("revoke_ability"),
		...
		FAxonActionHandler::CreateStatic(&HandleRevokeAbility),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
			.Required(TEXT("ability_class"), TEXT("string"), TEXT("GameplayAbility class name or asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_asc_snapshot"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetASCSnapshot),
		FParamSchemaBuilder()
			.Required(TEXT("actor"), TEXT("string"), TEXT("Actor label, name, or path in PIE"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_all_ascs"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAllASCs),
		FParamSchemaBuilder()
...
FAxonActionResult FAxonGASASCActions::HandleAddASCToActor(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath, Error;
	UBlueprint* BP = AxonGAS::LoadBlueprintFromParams(Params, ActorPath, Error);
	if (!BP)
	{
	...
	{
		return FAxonActionResult::Error(TEXT("Blueprint has no SimpleConstructionScript — is it an Actor Blueprint?"));
	}
	...
	if (!NewNode)
	{
		...
		return FAxonActionResult::Error(TEXT("Failed to create ASC SCS node"));
	}
...
FAxonActionResult FAxonGASASCActions::HandleConfigureASC(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath, Error;
	UBlueprint* BP = AxonGAS::LoadBlueprintFromParams(Params, ActorPath, Error);
	if (!BP)
	...
	// --- Default abilities ---
	TArray<FString> AbilityPaths = AxonGAS::ParseStringArray(Params, TEXT("default_abilities"));
	...
	// --- Default effects ---
	TArray<FString> EffectPaths = AxonGAS::ParseStringArray(Params, TEXT("default_effects"));
...
FAxonActionResult FAxonGASASCActions::HandleSetupASCInit(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath, Error;
	UBlueprint* BP = AxonGAS::LoadBlueprintFromParams(Params, ActorPath, Error);
	if (!BP)
	...
	FString Location;
	FAxonActionResult ParamError;
	if (!AxonGAS::RequireStringParam(Params, TEXT("location"), Location, ParamError))
	{
		return ParamError;
	}
...
FAxonActionResult FAxonGASASCActions::HandleSetupAbilitySystemInterface(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath, Error;
	UBlueprint* BP = AxonGAS::LoadBlueprintFromParams(Params, ActorPath, Error);
	if (!BP)
	...
	FString ASCLocation;
	FAxonActionResult ParamError;
	if (!AxonGAS::RequireStringParam(Params, TEXT("asc_location"), ASCLocation, ParamError))
	{
		return ParamError;
	}
...
FAxonActionResult FAxonGASASCActions::HandleApplyASCTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath, TemplateName;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor_path"), ActorPath, Err)) return Err;
	...
	if (Params->TryGetObjectField(TEXT("overrides"), OverridesPtr) && OverridesPtr && (*OverridesPtr).IsValid())
	{
		...
		TArray<FString> OvAttrSets = AxonGAS::ParseStringArray(Ov, TEXT("attribute_sets"));
		if (OvAttrSets.Num() > 0) Def.AttributeSets = OvAttrSets;

		TArray<FString> OvAbilities = AxonGAS::ParseStringArray(Ov, TEXT("abilities"));
		if (OvAbilities.Num() > 0) Def.Abilities = OvAbilities;

		TArray<FString> OvEffects = AxonGAS::ParseStringArray(Ov, TEXT("effects"));
...
FAxonActionResult FAxonGASASCActions::HandleSetDefaultAbilities(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor_path"), ActorPath, Err)) return Err;

	TArray<FString> AbilityPaths = AxonGAS::ParseStringArray(Params, TEXT("abilities"));
	if (AbilityPaths.Num() == 0)
	{
...
FAxonActionResult FAxonGASASCActions::HandleSetDefaultEffects(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor_path"), ActorPath, Err)) return Err;

	TArray<FString> EffectPaths = AxonGAS::ParseStringArray(Params, TEXT("effects"));
	if (EffectPaths.Num() == 0)
	{
...
FAxonActionResult FAxonGASASCActions::HandleSetDefaultAttributeSets(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor_path"), ActorPath, Err)) return Err;
...
FAxonActionResult FAxonGASASCActions::HandleSetASCReplicationMode(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath, ModeStr;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor_path"), ActorPath, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("mode"), ModeStr, Err)) return Err;
	...
	if (!ASCNode)
	{
		return FAxonActionResult::Error(TEXT("No AbilitySystemComponent found on this Blueprint. Call add_asc_to_actor first."));
	}
...
FAxonActionResult FAxonGASASCActions::HandleValidateASCSetup(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor_path"), ActorPath, Err)) return Err;
...
FAxonActionResult FAxonGASASCActions::HandleGrantAbility(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId, AbilityClassId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("ability_class"), AbilityClassId, Err)) return Err;
...
FAxonActionResult FAxonGASASCActions::HandleRevokeAbility(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId, AbilityClassId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
...
FAxonActionResult FAxonGASASCActions::HandleGetASCSnapshot(const TSharedPtr<FJsonObject>& Params)
{
	FString ActorId;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("actor"), ActorId, Err)) return Err;
	...
	if (bIncludeAbilities)
	{
		...
		for (const FGameplayAbilitySpec& Spec : ASC->GetActivatableAbilities())
		{
			...
			{
				AbilObj->SetField(TEXT("ability_tags"), AxonGAS::TagContainerToJson(AbilityTags));
			}
	...
	if (bIncludeTags)
	{
		...
		Result->SetField(TEXT("owned_tags"), AxonGAS::TagContainerToJson(OwnedTags));
...
FAxonActionResult FAxonGASASCActions::HandleGetAllASCs(const TSharedPtr<FJsonObject>& Params)
{

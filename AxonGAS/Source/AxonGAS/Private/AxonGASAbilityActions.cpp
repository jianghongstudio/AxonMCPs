...
namespace
{
	...
	struct FAbilityCDOContext
	{
		...
		bool Load(const TSharedPtr<FJsonObject>& Params, FAxonActionResult& OutError)
		{
			FString Error;
			BP = AxonGAS::LoadBlueprintFromParams(Params, AssetPath, Error);
			if (!BP)
			{
				OutError = FAxonActionResult::Error(Error);
				return false;
			}
			if (!AxonGAS::IsAbilityBlueprint(BP))
			{
				OutError = FAxonActionResult::Error(
					FString::Printf(TEXT("'%s' is not a GameplayAbility Blueprint"), *AssetPath));
				return false;
			}
			CDO = AxonGAS::GetBlueprintCDO<UGameplayAbility>(BP);
			if (!CDO)
			{
				OutError = FAxonActionResult::Error(
	...
	{
		return AxonGAS::TagContainerToJson(Container);
	}
...
void FAxonGASAbilityActions::RegisterActions(FAxonToolRegistry& Registry)
{
	Registry.RegisterAction(TEXT("gas"), TEXT("create_ability"),
		TEXT("Create a new GameplayAbility Blueprint asset"),
		FAxonActionHandler::CreateStatic(&HandleCreateAbility),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_info"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbilityInfo),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_abilities"),
		...
		FAxonActionHandler::CreateStatic(&HandleListAbilities),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("compile_ability"),
		...
		FAxonActionHandler::CreateStatic(&HandleCompileAbility),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_tags"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAbilityTags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_tags"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbilityTags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_policy"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAbilityPolicy),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_cost"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAbilityCost),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_cooldown"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAbilityCooldown),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_triggers"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAbilityTriggers),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("set_ability_flags"),
		...
		FAxonActionHandler::CreateStatic(&HandleSetAbilityFlags),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_ability_task_node"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddAbilityTaskNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_commit_and_end_flow"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddCommitAndEndFlow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_effect_application"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddEffectApplication),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("add_gameplay_cue_node"),
		...
		FAxonActionHandler::CreateStatic(&HandleAddGameplayCueNode),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("create_ability_from_template"),
		...
		FAxonActionHandler::CreateStatic(&HandleCreateAbilityFromTemplate),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("build_ability_from_spec"),
		...
		FAxonActionHandler::CreateStatic(&HandleBuildAbilityFromSpec),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("save_path"), TEXT("Asset path to save the new ability"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("batch_create_abilities"),
		...
		FAxonActionHandler::CreateStatic(&HandleBatchCreateAbilities),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("duplicate_ability"),
		...
		FAxonActionHandler::CreateStatic(&HandleDuplicateAbility),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("list_ability_tasks"),
		...
		FAxonActionHandler::CreateStatic(&HandleListAbilityTasks),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_task_pins"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbilityTaskPins),
		FParamSchemaBuilder()
			.Required(TEXT("task_class"), TEXT("string"), TEXT("UAbilityTask subclass name (e.g. UAbilityTask_WaitGameplayEvent)"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("wire_ability_task_delegate"),
		...
		FAxonActionHandler::CreateStatic(&HandleWireAbilityTaskDelegate),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_graph_flow"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbilityGraphFlow),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_ability"),
		...
		FAxonActionHandler::CreateStatic(&HandleValidateAbility),
		FParamSchemaBuilder()
			.RequiredAssetPath(TEXT("asset_path"), TEXT("GameplayAbility Blueprint asset path"))
			.Build());
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("find_abilities_by_tag"),
		...
		FAxonActionHandler::CreateStatic(&HandleFindAbilitiesByTag),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("get_ability_tag_matrix"),
		...
		FAxonActionHandler::CreateStatic(&HandleGetAbilityTagMatrix),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("validate_ability_blueprint"),
		...
		FAxonActionHandler::CreateStatic(&HandleValidateAbilityBlueprint),
		FParamSchemaBuilder()
	...
	Registry.RegisterAction(TEXT("gas"), TEXT("scaffold_custom_ability_task"),
		...
		FAxonActionHandler::CreateStatic(&HandleScaffoldCustomAbilityTask),
		FParamSchemaBuilder()
...
FAxonActionResult FAxonGASAbilityActions::HandleCreateAbility(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err))
	{
		return Err;
	}
	...
	if (ParentClassName.StartsWith(TEXT("/")))
	{
		...
		UObject* Obj = FAxonAssetUtils::LoadAssetByPath(UBlueprint::StaticClass(), ParentClassName);
...
FAxonActionResult FAxonGASAbilityActions::HandleGetAbilityInfo(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonGASAbilityActions::HandleListAbilities(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		FilterTag = AxonGAS::StringToTag(TagFilter);
	}
	...
	for (const FAssetData& AssetData : Assets)
	{
		...
		{
			UGameplayAbility* CDO = AxonGAS::GetBlueprintCDO<UGameplayAbility>(BP);
...
FAxonActionResult FAxonGASAbilityActions::HandleCompileAbility(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
...
FAxonActionResult FAxonGASAbilityActions::HandleSetAbilityTags(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("container"), ContainerName, Err))
	{
		return Err;
	}
	...
	FGameplayTagContainer InputTags = AxonGAS::ParseTagContainer(Params, TEXT("tags"), SkippedTags);
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(Ctx.AssetPath,
...
FAxonActionResult FAxonGASAbilityActions::HandleGetAbilityTags(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
...
FAxonActionResult FAxonGASAbilityActions::HandleSetAbilityPolicy(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!bChanged)
	{
		return FAxonActionResult::Error(TEXT("No policy fields provided. Set at least one of: instancing_policy, net_execution_policy, net_security_policy"));
	}

	Ctx.MarkModified();

	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Policies updated"));
	TSharedPtr<FJsonObject> Policies = MakeShared<FJsonObject>();
...
FAxonActionResult FAxonGASAbilityActions::HandleSetAbilityCost(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("cost_effect_class"), CostClassPath, Err))
	{
		return Err;
	}
	...
	if (CostClassPath.IsEmpty())
	{
		...
		TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Cost effect cleared"));
		return FAxonActionResult::Success(Result);
	}
	...
	{
		UObject* Obj = FAxonAssetUtils::LoadAssetByPath(UBlueprint::StaticClass(), CostClassPath);
...
FAxonActionResult FAxonGASAbilityActions::HandleSetAbilityCooldown(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("cooldown_effect_class"), CooldownClassPath, Err))
	{
		return Err;
	}
	...
	if (CooldownClassPath.IsEmpty())
	{
		...
		TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Cooldown effect cleared"));
		return FAxonActionResult::Success(Result);
	}
	...
	{
		UObject* Obj = FAxonAssetUtils::LoadAssetByPath(UBlueprint::StaticClass(), CooldownClassPath);
		UBlueprint* GEBP = Cast<UBlueprint>(Obj);
		if (GEBP && GEBP->GeneratedClass)
		{
			GEClass = GEBP->GeneratedClass;
...
FAxonActionResult FAxonGASAbilityActions::HandleSetAbilityTriggers(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	{
		return FAxonActionResult::Error(TEXT("Missing required parameter: triggers (array of {tag, trigger_source})"));
	}
	...
	for (int32 i = 0; i < TriggersArray->Num(); ++i)
	{
		...
		FGameplayTag Tag = AxonGAS::StringToTag(TagStr);
		if (!Tag.IsValid())
		{
			return FAxonActionResult::Error(
...
FAxonActionResult FAxonGASAbilityActions::HandleSetAbilityFlags(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!bChanged)
	{
		return FAxonActionResult::Error(TEXT("No flag fields provided. Set at least one of: replicate_input_directly, retrigger_instanced_ability, server_respects_remote_ability_cancellation"));
	}

	Ctx.MarkModified();

	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Flags updated"));
	TSharedPtr<FJsonObject> Flags = MakeShared<FJsonObject>();
...
FAxonActionResult FAxonGASAbilityActions::HandleAddAbilityTaskNode(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("task_class"), TaskClassName, Err))
	{
		return Err;
	}
	...
	if (!Graph)
	{
		return FAxonActionResult::Error(TEXT("No event graph found in ability Blueprint"));
	}
...
FAxonActionResult FAxonGASAbilityActions::HandleAddCommitAndEndFlow(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!CommitNode)
	{
		return FAxonActionResult::Error(TEXT("Failed to create CommitAbility node. Function not found on UGameplayAbility."));
	}
...
FAxonActionResult FAxonGASAbilityActions::HandleAddEffectApplication(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("effect_class"), EffectClassPath, Err))
	{
		return Err;
	}
...
FAxonActionResult FAxonGASAbilityActions::HandleAddGameplayCueNode(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	FString CueTag;
	if (!AxonGAS::RequireStringParam(Params, TEXT("cue_tag"), CueTag, Err))
	{
		return Err;
	}

	FString Type;
	if (!AxonGAS::RequireStringParam(Params, TEXT("type"), Type, Err))
	{
		return Err;
	}
...
FAxonActionResult FAxonGASAbilityActions::HandleCreateAbilityFromTemplate(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err))
	...
	if (!AxonGAS::RequireStringParam(Params, TEXT("template"), TemplateName, Err))
	{
		return Err;
	}
	...
	FAxonActionResult CreateResult = HandleCreateAbility(CreateParams);
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(SavePath,
...
FAxonActionResult FAxonGASAbilityActions::HandleBuildAbilityFromSpec(const TSharedPtr<FJsonObject>& Params)
{
	FString SavePath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("save_path"), SavePath, Err))
	...
	// Step 2: Set policies
	{
		...
		if (bHasPolicy)
		{
			...
			FAxonActionResult PolicyResult = HandleSetAbilityPolicy(PolicyParams);
		...
		if (Spec->TryGetObjectField(TEXT("tags"), TagsObj))
		{
			for (const auto& Pair : (*TagsObj)->Values)
			{
				...
				if (Pair.Value->TryGetArray(TagArr) && TagArr->Num() > 0)
				{
					TSharedPtr<FJsonObject> TagParams = MakeShared<FJsonObject>();
					TagParams->SetStringField(TEXT("asset_path"), SavePath);
					TagParams->SetStringField(TEXT("container"), AxonKeyToString(Pair.Key));
	...
	if (Spec->HasField(TEXT("cost_effect_class")))
	{
		...
		FAxonActionResult CostResult = HandleSetAbilityCost(CostParams);
	...
	if (Spec->HasField(TEXT("cooldown_effect_class")))
	{
		...
		FAxonActionResult CDResult = HandleSetAbilityCooldown(CDParams);
	...
	// Step 6: Triggers
	{
		...
		if (Spec->TryGetArrayField(TEXT("triggers"), TriggersArr) && TriggersArr->Num() > 0)
		{
			...
			FAxonActionResult TrigResult = HandleSetAbilityTriggers(TrigParams);
	...
	// Step 7: Flags
	{
		...
		if (Spec->TryGetObjectField(TEXT("flags"), FlagsObj))
		{
			...
			FAxonActionResult FlagResult = HandleSetAbilityFlags(FlagParams);
...
FAxonActionResult FAxonGASAbilityActions::HandleBatchCreateAbilities(const TSharedPtr<FJsonObject>& Params)
{
	const TArray<TSharedPtr<FJsonValue>>* AbilitiesArr;
	if (!Params->TryGetArrayField(TEXT("abilities"), AbilitiesArr) || AbilitiesArr->Num() == 0)
	{
		return FAxonActionResult::Error(TEXT("Missing or empty required parameter: abilities (array)"));
	}
	...
	for (int32 i = 0; i < AbilitiesArr->Num(); ++i)
	{
		...
		FAxonActionResult AbilityResult;
...
FAxonActionResult FAxonGASAbilityActions::HandleDuplicateAbility(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("asset_path"), AssetPath, Err))
	{
		return Err;
	}

	FString NewPath;
	if (!AxonGAS::RequireStringParam(Params, TEXT("new_path"), NewPath, Err))
	{
		return Err;
	}
	...
	{
		FString LoadErr;
		UBlueprint* SourceBP = AxonGAS::LoadBlueprintFromParams(Params, AssetPath, LoadErr);
		if (!SourceBP)
		{
			return FAxonActionResult::Error(LoadErr);
		}
		if (!AxonGAS::IsAbilityBlueprint(SourceBP))
		{
			return FAxonActionResult::Error(
				FString::Printf(TEXT("'%s' is not a GameplayAbility Blueprint"), *AssetPath));
		}
	...
	{
		UGameplayAbility* DupCDO = AxonGAS::GetBlueprintCDO<UGameplayAbility>(DupBP);
		if (DupCDO)
		{
			// Build rename map
			...
			{
				RenameMap.Add(AxonKeyToString(Pair.Key), Pair.Value->AsString());
			}
			...
			for (const FString& ContainerName : AllContainerNames)
			{
				...
				for (auto It = Container->CreateConstIterator(); It; ++It)
				{
					...
					{
						FGameplayTag NewTag = AxonGAS::StringToTag(*Replacement);
						if (NewTag.IsValid())
						{
	...
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(NewPath,
...
FAxonActionResult FAxonGASAbilityActions::HandleListAbilityTasks(const TSharedPtr<FJsonObject>& Params)
{
...
FAxonActionResult FAxonGASAbilityActions::HandleGetAbilityTaskPins(const TSharedPtr<FJsonObject>& Params)
{
	FString TaskClassName;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("task_class"), TaskClassName, Err))
...
FAxonActionResult FAxonGASAbilityActions::HandleWireAbilityTaskDelegate(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	FString NodeId;
	if (!AxonGAS::RequireStringParam(Params, TEXT("node_id"), NodeId, Err))
	{
		return Err;
	}

	FString DelegateName;
	if (!AxonGAS::RequireStringParam(Params, TEXT("delegate_name"), DelegateName, Err))
	{
		return Err;
	}

	FString TargetNodeId;
	if (!AxonGAS::RequireStringParam(Params, TEXT("target_node_id"), TargetNodeId, Err))
	{
		return Err;
	}
...
FAxonActionResult FAxonGASAbilityActions::HandleGetAbilityGraphFlow(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
	...
	// Build result
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(Ctx.AssetPath, TEXT("Graph flow analysis complete"));
...
FAxonActionResult FAxonGASAbilityActions::HandleValidateAbility(const TSharedPtr<FJsonObject>& Params)
{
	FAbilityCDOContext Ctx;
	FAxonActionResult Err;
	if (!Ctx.Load(Params, Err))
...
FAxonActionResult FAxonGASAbilityActions::HandleFindAbilitiesByTag(const TSharedPtr<FJsonObject>& Params)
{
	FString TagStr;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("tag"), TagStr, Err)) return Err;
	...
	for (const FAssetData& Asset : AllBlueprints)
	{
		...
		if (!BP || !AxonGAS::IsAbilityBlueprint(BP)) continue;
...
FAxonActionResult FAxonGASAbilityActions::HandleGetAbilityTagMatrix(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (Params->TryGetArrayField(TEXT("asset_paths"), PathsArray) && PathsArray && PathsArray->Num() > 0)
	{
		for (const auto& Val : *PathsArray)
		{
			...
			UBlueprint* BP = AxonGAS::LoadBlueprintFromParams(TempParams, OutPath, Error);
			if (BP && AxonGAS::IsAbilityBlueprint(BP))
			{
				AbilityBPs.Add(BP);
			}
		}
...
FAxonActionResult FAxonGASAbilityActions::HandleValidateAbilityBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	FString AssetPath;
	FAxonActionResult Err;
	...
	bool bIsAbilityBP = AxonGAS::IsAbilityBlueprint(BP);
	...
	if (!CDO)
	{
		return FAxonActionResult::Error(FString::Printf(TEXT("Failed to get CDO for '%s'"), *OutPath));
	}
	...
	bool bValid = (Errors.Num() == 0);
	TSharedPtr<FJsonObject> Result = AxonGAS::MakeAssetResult(OutPath,
...
FAxonActionResult FAxonGASAbilityActions::HandleScaffoldCustomAbilityTask(const TSharedPtr<FJsonObject>& Params)
{
	FString ClassName;
	FAxonActionResult Err;
	if (!AxonGAS::RequireStringParam(Params, TEXT("class_name"), ClassName, Err))
		return Err;
	...
	{
		return FAxonActionResult::Error(TEXT("At least one delegate is required for a custom ability task."));
	}
	...
	Header += TEXT(" * Auto-generated by AxonGAS scaffold_custom_ability_task\n");
	Header += TEXT(" */\n");
	Header += TEXT("UCLASS()\n");
